...
StandardError
  └── CoreLibrary::ApiException
        └── Univa::APIException          ← base for all HTTP errors
              └── Univa::{OperationError}  ← typed, if generated (in exceptions/)
...
with `.local_error('400', '...message...', Univa::{OperationError})`, and any status without a
