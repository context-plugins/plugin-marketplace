...
your SDK source (`tesserapiv1/models/`).
...
`UnionTypeLookUp` registry (in `tesserapiv1/utilities/union_type_lookup.py`) and each candidate model
...
```python
from tesserapiv1.models.animal import Cat, Dog
...
```python
from tesserapiv1.models.animal import Animal, Cat, Dog
