...
- **HTTP**: `DELETE /businessLines/{id}` (Default18 (kyc-test))
...
### GetBusinessLinesId
- **HTTP**: `GET /businessLines/{id}` (Default18 (kyc-test))
...
- **HTTP**: `PATCH /businessLines/{id}` (Default18 (kyc-test))
...
### PostBusinessLines
- **HTTP**: `POST /businessLines` (Default18 (kyc-test))
