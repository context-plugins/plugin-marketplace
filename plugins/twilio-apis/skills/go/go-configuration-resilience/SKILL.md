    ...
    twilioapis.CreateConfiguration(
        twilioapis.WithHttpConfiguration(
            twilioapis.CreateHttpConfiguration(
                twilioapis.WithTimeout(30),
                twilioapis.WithRetryConfiguration(
                    twilioapis.CreateRetryConfiguration(
                        twilioapis.WithMaxRetryAttempts(3),
                        twilioapis.WithBackoffFactor(2),
                    ),
                ),
            ),
        ),
...
```go
rc := twilioapis.CreateRetryConfiguration(
    twilioapis.WithMaxRetryAttempts(5),
    twilioapis.WithRetryInterval(1),
    twilioapis.WithBackoffFactor(2),
    twilioapis.WithHttpStatusCodesToRetry([]int64{429, 500, 503}),
    twilioapis.WithHttpMethodsToRetry([]string{"GET", "PUT"}),
)
```
...
client := twilioapis.NewClient(
    twilioapis.CreateConfiguration(
        twilioapis.WithHttpConfiguration(
            twilioapis.CreateHttpConfiguration(
                twilioapis.WithTransport(&loggingTransport{inner: http.DefaultTransport}),
            ),
        ),
    ),
)
