...
your SDK source (`klarnapaymentsapiv1/models/`).
...
```python
from klarnapaymentsapiv1.api_helper import APIHelper
...
`UnionTypeLookUp` registry (in `klarnapaymentsapiv1/utilities/union_type_lookup.py`) and each candidate model
...
```python
from klarnapaymentsapiv1.models.animal import Cat, Dog
...
```python
from klarnapaymentsapiv1.models.animal import Animal, Cat, Dog
