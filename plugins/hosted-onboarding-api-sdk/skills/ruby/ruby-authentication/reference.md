...
Confirm every name against `lib/hosted_onboarding_api/client.rb`, `lib/hosted_onboarding_api/configuration.rb`, the
`lib/hosted_onboarding_api/http/auth/*.rb` files, and `doc/auth/*.md` in the cloned source.
