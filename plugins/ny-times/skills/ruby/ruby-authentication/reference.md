...
Confirm every name against `lib/ny_times/client.rb`, `lib/ny_times/configuration.rb`, the
`lib/ny_times/http/auth/*.rb` files, and `doc/auth/*.md` in the cloned source.
