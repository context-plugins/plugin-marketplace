...
Confirm every name against `lib/payquicker/client.rb`, `lib/payquicker/configuration.rb`, the
`lib/payquicker/http/auth/*.rb` files, and `doc/auth/*.md` in the cloned source.
