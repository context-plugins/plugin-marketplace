    ...
    1passwordconnect.CreateConfiguration(
        1passwordconnect.WithHttpConfiguration(
            1passwordconnect.CreateHttpConfiguration(
                1passwordconnect.WithTimeout(30),
                1passwordconnect.WithRetryConfiguration(
                    1passwordconnect.CreateRetryConfiguration(
                        1passwordconnect.WithMaxRetryAttempts(3),
                        1passwordconnect.WithBackoffFactor(2),
                    ),
                ),
            ),
        ),
...
```go
rc := 1passwordconnect.CreateRetryConfiguration(
    1passwordconnect.WithMaxRetryAttempts(5),
    1passwordconnect.WithRetryInterval(1),
    1passwordconnect.WithBackoffFactor(2),
    1passwordconnect.WithHttpStatusCodesToRetry([]int64{429, 500, 503}),
    1passwordconnect.WithHttpMethodsToRetry([]string{"GET", "PUT"}),
)
```
...
client := 1passwordconnect.NewClient(
    1passwordconnect.CreateConfiguration(
        1passwordconnect.WithHttpConfiguration(
            1passwordconnect.CreateHttpConfiguration(
                1passwordconnect.WithTransport(&loggingTransport{inner: http.DefaultTransport}),
            ),
        ),
    ),
)
