...
- `github.com/context-plugins/alpaca-go-sdk` — the Go import path for the root package; `github.com/context-plugins/alpaca-go-sdk/models` for request/response types.
...
```go
import "github.com/context-plugins/alpaca-go-sdk"
