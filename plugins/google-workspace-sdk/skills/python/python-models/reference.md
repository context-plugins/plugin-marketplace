...
`googleworkspace/models/` and `googleworkspace/api_helper.py`.
...
```python
from googleworkspace.models.o_auth_token import OAuthToken
...
```python
from googleworkspace.models.animal import Cat
