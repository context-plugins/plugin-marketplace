...
StandardError
  └── CoreLibrary::ApiException
        └── GOE::APIException          ← base for all HTTP errors
              └── GOE::{OperationError}  ← typed, if generated (in exceptions/)
...
with `.local_error('400', '...message...', GOE::{OperationError})`, and any status without a
