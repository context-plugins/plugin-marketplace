...
> Throughout, `discourseapidocumentation` and other `{...}` tokens are placeholders for names you take from your SDK —
...
client := discourseapidocumentation.NewClient(
    discourseapidocumentation.CreateConfiguration(
        discourseapidocumentation.WithBasicAuthCredentials(
            discourseapidocumentation.NewBasicAuthCredentials(
...
discourseapidocumentation.WithApiKeyCredentials(discourseapidocumentation.NewApiKeyCredentials("token", "api-key"))

// custom header scheme (often surfaced as ApiHeaderCredentials):
discourseapidocumentation.WithApiHeaderCredentials(discourseapidocumentation.NewApiHeaderCredentials("token", "api-key"))
```
...
```go
discourseapidocumentation.WithOAuthBearerTokenCredentials(
    discourseapidocumentation.NewOAuthBearerTokenCredentials(os.Getenv("{ACCESS_TOKEN_ENV}")),
)
```
...
client := discourseapidocumentation.NewClient(
    discourseapidocumentation.CreateConfiguration(
        discourseapidocumentation.WithOAuthCCGCredentials(
            discourseapidocumentation.NewOAuthCCGCredentials(
