...
```csharp
using TraderApi;
using TraderApi.Servers; // ServerEnvironment lives here

var options = new TraderApiClientOptions
{
...
var client = new TraderApiClient(httpClient, options); // httpClient: System.Net.Http.HttpClient
```

DI alternative (`ServiceCollectionExtensions.cs`):

```csharp
services.AddTraderApiClient(o =>
{
...
All `TraderApiClientOptions` properties (source: `TraderApiClientOptions.cs`):
...
- `TraderApiClient(HttpClient httpClient, TraderApiClientOptions options)`
<!-- /crawler:client-options -->
...
|---|---|---|
| `ApiError` — abstract base of all 4 typed error classes in `Errors/` | `TryGetRawError(out RawError error): bool` | `Core/ErrorResponse/ApiError.cs` |
...
Of **29 operations**, **4 are Case A (typed)** and **25 are Case B (raw)**.
<!-- /crawler:op-stats -->

---

## Operations — by controller (9 groups, 29 operations)
...
|---|---:|---|
| `AccountActivities` | 2 | [map/operations/AccountActivities.md](map/operations/AccountActivities.md) |
| `AccountConfigurationsApi` | 2 | [map/operations/AccountConfigurationsApi.md](map/operations/AccountConfigurationsApi.md) |
| `Accounts` | 1 | [map/operations/Accounts.md](map/operations/Accounts.md) |
| `CalendarApi` | 1 | [map/operations/CalendarApi.md](map/operations/CalendarApi.md) |
| `ClockApi` | 1 | [map/operations/ClockApi.md](map/operations/ClockApi.md) |
| `Orders` | 6 | [map/operations/Orders.md](map/operations/Orders.md) |
| `PortfolioHistoryApi` | 1 | [map/operations/PortfolioHistoryApi.md](map/operations/PortfolioHistoryApi.md) |
| `Positions` | 4 | [map/operations/Positions.md](map/operations/Positions.md) |
| `Watchlists` | 11 | [map/operations/Watchlists.md](map/operations/Watchlists.md) |
<!-- /crawler:ops-table -->
...
| Group | Count | Page |
|---|---:|---|
| Records (plain `record` data models) | 16 | [`Account` … `Watchlist`](map/models/records-1-Ac-Wa.md) |
| Unions (`OneOf` / `AnyOf`) — variant factories + `TryGet…` | 0 + 2 | [map/models/unions.md](map/models/unions.md) |
| Enums (`StringEnum<T>` / `IntEnum<T>`) — literal C# member names + wire values | 14 | [map/models/enums.md](map/models/enums.md) |
<!-- /gen:models-table -->
...
|---|---|
| Client & options (root) | `TraderApi` |
| Operation controllers (`Api/`) | `TraderApi.Api` |
| Records (`Models/`) | `TraderApi.Models` |
| Enums (`Models/Enums/`) | `TraderApi.Models.Enums` |
| Unions (`Models/AnyOf/`, `Models/OneOf/`) | `TraderApi.Models.AnyOf` |
| Error classes (`Errors/`) | `TraderApi.Errors` |
<!-- /gen:namespaces -->
...
**Auth.** The scheme(s) this API uses surface as credentials properties on `TraderApiClientOptions` (source: `TraderApiClientOptions.cs`) — set them before constructing the client; load `dotnet-authentication` for the wiring:
