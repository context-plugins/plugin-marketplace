...
Integrate and consume the **APIMatic-generated mist SDK** (the "APIMATIC v3.0" generic
...
(`dotnet-mist-getting-started/sdk-map.md` + `map/`) indexing every operation signature,
model, enum, union, and error type. The **`dotnet-integrate-mist`** router skill routes all
C#/.NET SDK work to the single **`dotnet-mist-sdk`** agent (.NET-only), which answers
