...
- `SpotifyWebAPIClient` — the generated client class (e.g. `MultiauthsampleClient`, `BatesterClient`).
...
`Environment` is an `Enum` subclass in `spotifywebapi/configuration.py`. Use the constant for the desired
