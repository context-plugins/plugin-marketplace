...
StandardError
  └── CoreLibrary::ApiException
        └── CoinGeckoDemoAPI::APIException          ← base for all HTTP errors
              └── CoinGeckoDemoAPI::{OperationError}  ← typed, if generated (in exceptions/)
...
with `.local_error('400', '...message...', CoinGeckoDemoAPI::{OperationError})`, and any status without a
