...
Confirm every name against `lib/adobe_experience_manager_aem_api/client.rb`, `lib/adobe_experience_manager_aem_api/configuration.rb`, the
`lib/adobe_experience_manager_aem_api/http/auth/*.rb` files, and `doc/auth/*.md` in the cloned source.
