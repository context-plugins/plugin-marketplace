...
StandardError
  └── CoreLibrary::ApiException
        └── Square::APIException          ← base for all HTTP errors
              └── Square::{OperationError}  ← typed, if generated (in exceptions/)
...
with `.local_error('400', '...message...', Square::{OperationError})`, and any status without a
