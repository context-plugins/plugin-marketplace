...
`testing` + `testify/require` for reference; substitute the real `ebayfinancesapi` and names.
...
import (
    ...
    "github.com/context-plugins/ebay-finances-api-go"   // root package ebayfinancesapi
)
...
func clientReturning(status int, body string) (ebayfinancesapi.ClientInterface, *stubTransport) {
    ...
    client := ebayfinancesapi.NewClient(
        ebayfinancesapi.CreateConfiguration(
            ebayfinancesapi.WithHttpConfiguration(
                ebayfinancesapi.CreateHttpConfiguration(ebayfinancesapi.WithTransport(stub)),
            ),
...
```go
import sdkerrors "github.com/context-plugins/ebay-finances-api-go/errors"
...
client := ebayfinancesapi.NewClient(
    ebayfinancesapi.CreateConfiguration(
        ebayfinancesapi.WithHttpConfiguration(
            ebayfinancesapi.CreateHttpConfiguration(ebayfinancesapi.WithTransport(redirectTransport{host: target.Host})),
        ),
    ),
)
```
