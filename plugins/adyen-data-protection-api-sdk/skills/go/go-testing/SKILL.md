...
`testing` + `testify/require` for reference; substitute the real `adyendataprotectionapi` and names.
...
import (
    ...
    "github.com/context-plugins/adyen-data-protection-api-go"   // root package adyendataprotectionapi
)
...
func clientReturning(status int, body string) (adyendataprotectionapi.ClientInterface, *stubTransport) {
    ...
    client := adyendataprotectionapi.NewClient(
        adyendataprotectionapi.CreateConfiguration(
            adyendataprotectionapi.WithHttpConfiguration(
                adyendataprotectionapi.CreateHttpConfiguration(adyendataprotectionapi.WithTransport(stub)),
            ),
...
```go
import sdkerrors "github.com/context-plugins/adyen-data-protection-api-go/errors"
...
client := adyendataprotectionapi.NewClient(
    adyendataprotectionapi.CreateConfiguration(
        adyendataprotectionapi.WithHttpConfiguration(
            adyendataprotectionapi.CreateHttpConfiguration(adyendataprotectionapi.WithTransport(redirectTransport{host: target.Host})),
        ),
    ),
)
```
