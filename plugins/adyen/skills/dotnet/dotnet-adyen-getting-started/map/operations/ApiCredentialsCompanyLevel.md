...
- **HTTP**: `GET /companies/{companyId}/apiCredentials` (Default (balanceplatform-api-test))
...
- **HTTP**: `GET /companies/{companyId}/apiCredentials/{apiCredentialId}` (Default (balanceplatform-api-test))
...
- **HTTP**: `PATCH /companies/{companyId}/apiCredentials/{apiCredentialId}` (Default (balanceplatform-api-test))
...
- **HTTP**: `POST /companies/{companyId}/apiCredentials` (Default (balanceplatform-api-test))
