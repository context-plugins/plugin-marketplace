...
your SDK source (`thirdwebengine/models/`).
...
```python
from thirdwebengine.api_helper import APIHelper
...
`UnionTypeLookUp` registry (in `thirdwebengine/utilities/union_type_lookup.py`) and each candidate model
...
```python
from thirdwebengine.models.animal import Cat, Dog
...
```python
from thirdwebengine.models.animal import Animal, Cat, Dog
