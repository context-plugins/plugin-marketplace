...
All config below is passed at construction time via the `ApiManagementClientClientConfig` object.

## Base URL / environment override

```typescript
import { ApiManagementClientClient, Environment } from 'apimanagementclientlib';
