...
Confirm every name against `lib/api_apis_guru/client.rb`, `lib/api_apis_guru/configuration.rb`, the
`lib/api_apis_guru/http/auth/*.rb` files, and `doc/auth/*.md` in the cloned source.
