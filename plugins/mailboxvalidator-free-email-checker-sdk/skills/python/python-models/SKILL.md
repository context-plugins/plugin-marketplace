...
your SDK source (`mailboxvalidatorfreeemailchecker/models/`).
...
```python
from mailboxvalidatorfreeemailchecker.api_helper import APIHelper
...
`UnionTypeLookUp` registry (in `mailboxvalidatorfreeemailchecker/utilities/union_type_lookup.py`) and each candidate model
...
```python
from mailboxvalidatorfreeemailchecker.models.animal import Cat, Dog
...
```python
from mailboxvalidatorfreeemailchecker.models.animal import Animal, Cat, Dog
