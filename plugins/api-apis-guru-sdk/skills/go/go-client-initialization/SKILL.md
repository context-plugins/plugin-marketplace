...
- `github.com/context-plugins/api-apis-guru-go` — the Go import path for the root package; `github.com/context-plugins/api-apis-guru-go/models` for request/response types.
...
```go
import "github.com/context-plugins/api-apis-guru-go"
