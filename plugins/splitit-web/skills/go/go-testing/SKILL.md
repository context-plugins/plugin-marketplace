...
`testing` + `testify/require` for reference; substitute the real `splititwebapiv3` and names.
...
import (
    ...
    "github.com/context-plugins/splitit-web-api-v3-go"   // root package splititwebapiv3
)
...
func clientReturning(status int, body string) (splititwebapiv3.ClientInterface, *stubTransport) {
    ...
    client := splititwebapiv3.NewClient(
        splititwebapiv3.CreateConfiguration(
            splititwebapiv3.WithHttpConfiguration(
                splititwebapiv3.CreateHttpConfiguration(splititwebapiv3.WithTransport(stub)),
            ),
...
```go
import sdkerrors "github.com/context-plugins/splitit-web-api-v3-go/errors"
...
client := splititwebapiv3.NewClient(
    splititwebapiv3.CreateConfiguration(
        splititwebapiv3.WithHttpConfiguration(
            splititwebapiv3.CreateHttpConfiguration(splititwebapiv3.WithTransport(redirectTransport{host: target.Host})),
        ),
    ),
)
```
