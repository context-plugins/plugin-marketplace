...
All config below is passed at construction time via the `DiscourseAPIDocumentationClientConfig` object.

## Base URL / environment override

```typescript
import { DiscourseAPIDocumentationClient, Environment } from 'discourse-api-documentationlib';
