...
Once your team publishes it to a plugin marketplace, install it from there by name instead — `/plugin install paypal@<marketplace>` — and drop the local `marketplace add` step.
