...
### CreateWorkflow
- **HTTP**: `POST /v1/Workspaces/{WorkspaceSid}/Workflows` (Default (accounts))
- **Signature**: `CreateWorkflow(string workspaceSid, ContentType contentType, string friendlyName, string configuration, string? assignmentCallbackUrl, string? fallbackAssignmentCallbackUrl, int? taskReservationTimeout, RequestOptions? requestOptions = null, CancellationToken ct = default)`
...
### DeleteWorkflow
- **HTTP**: `DELETE /v1/Workspaces/{WorkspaceSid}/Workflows/{Sid}` (Default (accounts))
...
### FetchWorkflow
- **HTTP**: `GET /v1/Workspaces/{WorkspaceSid}/Workflows/{Sid}` (Default (accounts))
...
### ListWorkflow
- **HTTP**: `GET /v1/Workspaces/{WorkspaceSid}/Workflows` (Default (accounts))
...
### UpdateWorkflow
- **HTTP**: `POST /v1/Workspaces/{WorkspaceSid}/Workflows/{Sid}` (Default (accounts))
- **Signature**: `UpdateWorkflow(string workspaceSid, string sid, ContentType contentType, string? friendlyName, string? assignmentCallbackUrl, string? fallbackAssignmentCallbackUrl, string? configuration, int? taskReservationTimeout, string? reEvaluateTasks, RequestOptions? requestOptions = null, CancellationToken ct = default)`
