    ...
    spotifywebapi.CreateConfiguration(
        spotifywebapi.WithHttpConfiguration(
            spotifywebapi.CreateHttpConfiguration(
                spotifywebapi.WithTimeout(30),
                spotifywebapi.WithRetryConfiguration(
                    spotifywebapi.CreateRetryConfiguration(
                        spotifywebapi.WithMaxRetryAttempts(3),
                        spotifywebapi.WithBackoffFactor(2),
                    ),
                ),
            ),
        ),
...
```go
rc := spotifywebapi.CreateRetryConfiguration(
    spotifywebapi.WithMaxRetryAttempts(5),
    spotifywebapi.WithRetryInterval(1),
    spotifywebapi.WithBackoffFactor(2),
    spotifywebapi.WithHttpStatusCodesToRetry([]int64{429, 500, 503}),
    spotifywebapi.WithHttpMethodsToRetry([]string{"GET", "PUT"}),
)
```
...
client := spotifywebapi.NewClient(
    spotifywebapi.CreateConfiguration(
        spotifywebapi.WithHttpConfiguration(
            spotifywebapi.CreateHttpConfiguration(
                spotifywebapi.WithTransport(&loggingTransport{inner: http.DefaultTransport}),
            ),
        ),
    ),
)
