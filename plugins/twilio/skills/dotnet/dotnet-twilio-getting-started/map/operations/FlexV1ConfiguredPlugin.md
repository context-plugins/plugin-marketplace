...
- **HTTP**: `GET /v1/PluginService/Configurations/{ConfigurationSid}/Plugins/{PluginSid}` (Default13 (flex-api))
...
- **HTTP**: `GET /v1/PluginService/Configurations/{ConfigurationSid}/Plugins` (Default13 (flex-api))
