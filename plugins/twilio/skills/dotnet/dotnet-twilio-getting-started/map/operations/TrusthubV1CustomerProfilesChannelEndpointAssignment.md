...
- **HTTP**: `POST /v1/CustomerProfiles/{CustomerProfileSid}/ChannelEndpointAssignments` (Default9 (trusthub))
...
- **HTTP**: `DELETE /v1/CustomerProfiles/{CustomerProfileSid}/ChannelEndpointAssignments/{Sid}` (Default9 (trusthub))
...
- **HTTP**: `GET /v1/CustomerProfiles/{CustomerProfileSid}/ChannelEndpointAssignments/{Sid}` (Default9 (trusthub))
...
- **HTTP**: `GET /v1/CustomerProfiles/{CustomerProfileSid}/ChannelEndpointAssignments` (Default9 (trusthub))
