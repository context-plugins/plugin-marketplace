...
StandardError
  └── CoreLibrary::ApiException
        └── ShutterstockAPIExplorer::APIException          ← base for all HTTP errors
              └── ShutterstockAPIExplorer::{OperationError}  ← typed, if generated (in exceptions/)
...
with `.local_error('400', '...message...', ShutterstockAPIExplorer::{OperationError})`, and any status without a
