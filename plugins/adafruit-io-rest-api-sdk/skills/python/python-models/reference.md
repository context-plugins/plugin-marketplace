...
`adafruitiorestapi/models/` and `adafruitiorestapi/api_helper.py`.
...
```python
from adafruitiorestapi.models.o_auth_token import OAuthToken
...
```python
from adafruitiorestapi.models.animal import Cat
