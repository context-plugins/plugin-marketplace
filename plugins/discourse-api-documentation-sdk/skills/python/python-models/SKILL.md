...
your SDK source (`discourseapidocumentation/models/`).
...
```python
from discourseapidocumentation.api_helper import APIHelper
...
`UnionTypeLookUp` registry (in `discourseapidocumentation/utilities/union_type_lookup.py`) and each candidate model
...
```python
from discourseapidocumentation.models.animal import Cat, Dog
...
```python
from discourseapidocumentation.models.animal import Animal, Cat, Dog
