...
StandardError
  └── CoreLibrary::ApiException
        └── AdyenBinLookupAPI::APIException          ← base for all HTTP errors
              └── AdyenBinLookupAPI::{OperationError}  ← typed, if generated (in exceptions/)
...
with `.local_error('400', '...message...', AdyenBinLookupAPI::{OperationError})`, and any status without a
