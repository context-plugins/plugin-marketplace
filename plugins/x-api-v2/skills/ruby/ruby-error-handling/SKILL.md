...
StandardError
  └── CoreLibrary::ApiException
        └── XAPIV2::APIException          ← base for all HTTP errors
              └── XAPIV2::{OperationError}  ← typed, if generated (in exceptions/)
...
with `.local_error('400', '...message...', XAPIV2::{OperationError})`, and any status without a
