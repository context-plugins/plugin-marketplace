...
### CreateSyncStream
- **HTTP**: `POST /v1/Services/{ServiceSid}/Streams` (Default10 (sync))
...
### DeleteSyncStream
- **HTTP**: `DELETE /v1/Services/{ServiceSid}/Streams/{Sid}` (Default10 (sync))
...
### FetchSyncStream
- **HTTP**: `GET /v1/Services/{ServiceSid}/Streams/{Sid}` (Default10 (sync))
...
### ListSyncStream
- **HTTP**: `GET /v1/Services/{ServiceSid}/Streams` (Default10 (sync))
...
### UpdateSyncStream
- **HTTP**: `POST /v1/Services/{ServiceSid}/Streams/{Sid}` (Default10 (sync))
