...
│   └── app.zuplo.tesserplatformv1pull51me98e48a7.exceptions.ApiException          ← base for all non-2xx API responses
│       └── app.zuplo.tesserplatformv1pull51me98e48a7.exceptions.{Name}Exception   ← typed subclass with payload fields
...
`getHttpContext()` returns the SDK's `app.zuplo.tesserplatformv1pull51me98e48a7.http.client.HttpContext`, which carries:
