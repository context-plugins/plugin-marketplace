...
StandardError
  └── CoreLibrary::ApiException
        └── AdobeExperienceManagerAEMAPI::APIException          ← base for all HTTP errors
              └── AdobeExperienceManagerAEMAPI::{OperationError}  ← typed, if generated (in exceptions/)
...
with `.local_error('400', '...message...', AdobeExperienceManagerAEMAPI::{OperationError})`, and any status without a
