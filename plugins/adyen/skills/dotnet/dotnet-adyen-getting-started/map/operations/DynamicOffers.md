...
### GetDynamicOffers
- **HTTP**: `GET /dynamicOffers` (Default (balanceplatform-api-test))
- **Notes**: Returns a list of all dynamic offers available for `accountHolderId` specified as a query parameter.
- **Signature**: `GetDynamicOffers(string accountHolderId, FinancingType1? financingType, RequestOptions? requestOptions = null, CancellationToken ct = default)`
...
- **Error accessors**: `TryGetDynamicOffers422Error1(out DynamicOffers422Error1)` [422] · `TryGetRawError(out RawError)` [fallback]
- **No-throw variant**: absent
- **Pagination**: none

### PostDynamicOffersIdCalculate
- **HTTP**: `POST /dynamicOffers/{id}/calculate` (Default (balanceplatform-api-test))
...
- **Error accessors**: `TryGetDynamicOffersCalculate422Error1(out DynamicOffersCalculate422Error1)` [422] · `TryGetRawError(out RawError)` [fallback]
- **No-throw variant**: absent
- **Pagination**: none

### PostDynamicOffersIdGrantOffer
- **HTTP**: `POST /dynamicOffers/{id}/grantOffer` (Default (balanceplatform-api-test))
...
- **Error accessors**: `TryGetDynamicOffersGrantOffer422Error1(out DynamicOffersGrantOffer422Error1)` [422] · `TryGetRawError(out RawError)` [fallback]
- **No-throw variant**: absent
- **Pagination**: none
