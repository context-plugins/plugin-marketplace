...
All config below is passed at construction time via the `AdyenDataProtectionAPIClientConfig` object.

## Base URL / environment override

```typescript
import { AdyenDataProtectionAPIClient, Environment } from 'adyen-data-protection-apilib';
