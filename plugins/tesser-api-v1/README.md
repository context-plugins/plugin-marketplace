# Tesser API (v1) SDK Plugin

Integrate and consume the **APIMatic-generated Tesser API (v1) SDK** (the "APIMATIC v3.0" generic
...
(`dotnet-tesser-api-v1-getting-started/sdk-map.md` + `map/`) indexing every operation signature,
model, enum, union, and error type. The **`dotnet-integrate-tesser-api-v1`** router skill routes all
C#/.NET SDK work to the single **`dotnet-tesser-api-v1-sdk`** agent (.NET-only), which answers
