...
All config below is passed at construction time via the `HotelSearchAPIClientConfig` object.

## Base URL / environment override

```typescript
import { HotelSearchAPIClient, Environment } from 'hotel-search-apilib';
