...
| Install | `gem 'maxio_advanced_billing', git: 'https://github.com/context-plugins/maxio-advanced-billing-ruby', branch: 'main'` in a Gemfile |
...
```ruby
# In your Gemfile:
gem 'maxio_advanced_billing', git: 'https://github.com/context-plugins/maxio-advanced-billing-ruby', branch: 'main'
```
...
```bash
# Linux / macOS:
git clone --depth 1 --branch main https://github.com/context-plugins/maxio-advanced-billing-ruby /tmp/maxio-advanced-billing-ruby-src
```

```powershell
# Windows (PowerShell):
git clone --depth 1 --branch main https://github.com/context-plugins/maxio-advanced-billing-ruby "$env:TEMP\maxio-advanced-billing-ruby-src"
```
