...
> setting, so **confirm it** from the class names under `tesserapiv1/apis/`.
...
| Install | `pip install "git+https://github.com/context-plugins/tesser-api-v1-python-sdk@main"` |
...
- `tesserapiv1/controllers/` — one `{Resource}Api` per API resource group, all inheriting from
...
```bash
pip install "git+https://github.com/context-plugins/tesser-api-v1-python-sdk@main"
```
...
```bash
# Linux / macOS:
git clone --depth 1 --branch main https://github.com/context-plugins/tesser-api-v1-python-sdk /tmp/tesser-api-v1-python-src
```

```powershell
# Windows (PowerShell):
git clone --depth 1 --branch main https://github.com/context-plugins/tesser-api-v1-python-sdk "$env:TEMP\tesser-api-v1-python-src"
```
