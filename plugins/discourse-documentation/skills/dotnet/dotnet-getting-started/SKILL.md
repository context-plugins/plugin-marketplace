...
git clone --branch main https://github.com/context-plugins/discourse-api-documentation-csharp
dotnet add reference discourse-api-documentation-csharp/DiscourseApiDocumentation.csproj
```
...
```bash
# Linux / macOS:
git clone --depth 1 --branch main https://github.com/context-plugins/discourse-api-documentation-csharp /tmp/discourse-api-documentation-dotnet-src
```

```powershell
# Windows (PowerShell):
git clone --depth 1 --branch main https://github.com/context-plugins/discourse-api-documentation-csharp "$env:TEMP\discourse-api-documentation-dotnet-src"
```
