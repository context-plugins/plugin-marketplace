...
Accessor: `client.General` · Source: `Api/General.cs` · 40 operations

**Parameter names are literal.** Signatures are generated code verbatim — in named arguments use the exact parameter names shown (the cancellation-token parameter is named `ct`).

### PostAcceptDispute
- **HTTP**: `POST /acceptDispute` (Default (balanceplatform-api-test))
...
- **HTTP**: `POST /accountHolderBalance` (Default (balanceplatform-api-test))
...
- **HTTP**: `POST /accountHolderTransactionList` (Default (balanceplatform-api-test))
...
### PostAssignTerminals
- **HTTP**: `POST /assignTerminals` (Default (balanceplatform-api-test))
...
### PostChangeStatus
- **HTTP**: `POST /changeStatus` (Default (balanceplatform-api-test))
...
- **Error accessors**: `TryGetServiceError1(out ServiceError1)` [400, 401, 403, 500] · `TryGetRawError(out RawError)` [fallback]
- **No-throw variant**: absent
- **Pagination**: none

### PostCheckBalance
- **HTTP**: `POST /checkBalance` (Default (balanceplatform-api-test))
...
- **HTTP**: `POST /createNotificationConfiguration` (Default (balanceplatform-api-test))
...
### PostCreatePermit
- **HTTP**: `POST /createPermit` (Default (balanceplatform-api-test))
...
- **HTTP**: `POST /createTestCardRanges` (Default (balanceplatform-api-test))
...
- **HTTP**: `POST /debitAccountHolder` (Default (balanceplatform-api-test))
...
### PostDefendDispute
- **HTTP**: `POST /defendDispute` (Default (balanceplatform-api-test))
...
- **HTTP**: `POST /deleteDisputeDefenseDocument` (Default (balanceplatform-api-test))
...
- **HTTP**: `POST /deleteNotificationConfigurations` (Default (balanceplatform-api-test))
...
### PostDisable
- **HTTP**: `POST /disable` (Default (balanceplatform-api-test))
...
### PostDisablePermit
- **HTTP**: `POST /disablePermit` (Default (balanceplatform-api-test))
...
### PostFindTerminal
- **HTTP**: `POST /findTerminal` (Default (balanceplatform-api-test))
...
- **HTTP**: `POST /get3dsAvailability` (Default (balanceplatform-api-test))
...
### PostGetCostEstimate
- **HTTP**: `POST /getCostEstimate` (Default (balanceplatform-api-test))
...
- **HTTP**: `POST /getNotificationConfiguration` (Default (balanceplatform-api-test))
...
- **HTTP**: `POST /getNotificationConfigurationList` (Default (balanceplatform-api-test))
...
- **HTTP**: `POST /getStoresUnderAccount` (Default (balanceplatform-api-test))
...
- **HTTP**: `POST /getTerminalDetails` (Default (balanceplatform-api-test))
...
- **Signature**: `PostGetTerminalDetails(FindTerminalRequest? body, RequestOptions? requestOptions = null, CancellationToken ct = default)`
  - `body` — nullable, no default → **must pass explicitly**
  - defaults: `requestOptions` = null
...
- **HTTP**: `POST /getTerminalsUnderAccount` (Default (balanceplatform-api-test))
...
### PostIssue
- **HTTP**: `POST /issue` (Default (balanceplatform-api-test))
...
- **HTTP**: `POST /listRecurringDetails` (Default (balanceplatform-api-test))
...
### PostLoad
- **HTTP**: `POST /load` (Default (balanceplatform-api-test))
...
### PostMergeBalance
- **HTTP**: `POST /mergeBalance` (Default (balanceplatform-api-test))
...
### PostNotifyShopper
- **HTTP**: `POST /notifyShopper` (Default (balanceplatform-api-test))
...
- **HTTP**: `POST /payoutAccountHolder` (Default (balanceplatform-api-test))
...
- **HTTP**: `POST /refundFundsTransfer` (Default (balanceplatform-api-test))
...
- **HTTP**: `POST /refundNotPaidOutTransfers` (Default (balanceplatform-api-test))
...
- **HTTP**: `POST /requestSubjectErasure` (Default (balanceplatform-api-test))
...
- **HTTP**: `POST /retrieveApplicableDefenseReasons` (Default (balanceplatform-api-test))
- **Notes**: Returns a list of all applicable defense reasons to defend a specific dispute.
- **Signature**: `PostRetrieveApplicableDefenseReasons(AcceptDisputeRequest? body, RequestOptions? requestOptions = null, CancellationToken ct = default)`
  - `body` — nullable, no default → **must pass explicitly**
  - defaults: `requestOptions` = null
...
- **HTTP**: `POST /scheduleAccountUpdater` (Default (balanceplatform-api-test))
...
- **HTTP**: `POST /setupBeneficiary` (Default (balanceplatform-api-test))
...
- **HTTP**: `POST /supplyDefenseDocument` (Default (balanceplatform-api-test))
...
- **HTTP**: `POST /testNotificationConfiguration` (Default (balanceplatform-api-test))
...
### PostTransferFunds
- **HTTP**: `POST /transferFunds` (Default (balanceplatform-api-test))
...
- **HTTP**: `POST /updateNotificationConfiguration` (Default (balanceplatform-api-test))
...
### PostVoidTransaction
- **HTTP**: `POST /voidTransaction` (Default (balanceplatform-api-test))
