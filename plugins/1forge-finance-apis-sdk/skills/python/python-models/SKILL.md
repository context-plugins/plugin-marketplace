...
your SDK source (`1forgefinanceapis/models/`).
...
```python
from 1forgefinanceapis.api_helper import APIHelper
...
`UnionTypeLookUp` registry (in `1forgefinanceapis/utilities/union_type_lookup.py`) and each candidate model
...
```python
from 1forgefinanceapis.models.animal import Cat, Dog
...
```python
from 1forgefinanceapis.models.animal import Animal, Cat, Dog
