    ...
    sportsdata.CreateConfiguration(
        sportsdata.WithHttpConfiguration(
            sportsdata.CreateHttpConfiguration(
                sportsdata.WithTimeout(30),
                sportsdata.WithRetryConfiguration(
                    sportsdata.CreateRetryConfiguration(
                        sportsdata.WithMaxRetryAttempts(3),
                        sportsdata.WithBackoffFactor(2),
                    ),
                ),
            ),
        ),
...
```go
rc := sportsdata.CreateRetryConfiguration(
    sportsdata.WithMaxRetryAttempts(5),
    sportsdata.WithRetryInterval(1),
    sportsdata.WithBackoffFactor(2),
    sportsdata.WithHttpStatusCodesToRetry([]int64{429, 500, 503}),
    sportsdata.WithHttpMethodsToRetry([]string{"GET", "PUT"}),
)
```
...
client := sportsdata.NewClient(
    sportsdata.CreateConfiguration(
        sportsdata.WithHttpConfiguration(
            sportsdata.CreateHttpConfiguration(
                sportsdata.WithTransport(&loggingTransport{inner: http.DefaultTransport}),
            ),
        ),
    ),
)
