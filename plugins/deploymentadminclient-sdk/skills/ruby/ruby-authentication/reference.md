...
Confirm every name against `lib/deploymentadminclient/client.rb`, `lib/deploymentadminclient/configuration.rb`, the
`lib/deploymentadminclient/http/auth/*.rb` files, and `doc/auth/*.md` in the cloned source.
