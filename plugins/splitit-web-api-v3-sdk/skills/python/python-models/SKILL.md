...
your SDK source (`splititwebapiv3/models/`).
...
```python
from splititwebapiv3.api_helper import APIHelper
...
`UnionTypeLookUp` registry (in `splititwebapiv3/utilities/union_type_lookup.py`) and each candidate model
...
```python
from splititwebapiv3.models.animal import Cat, Dog
...
```python
from splititwebapiv3.models.animal import Animal, Cat, Dog
