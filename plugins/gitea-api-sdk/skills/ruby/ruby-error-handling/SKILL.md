...
StandardError
  └── CoreLibrary::ApiException
        └── GiteaAPI::APIException          ← base for all HTTP errors
              └── GiteaAPI::{OperationError}  ← typed, if generated (in exceptions/)
...
with `.local_error('400', '...message...', GiteaAPI::{OperationError})`, and any status without a
