...
StandardError
  └── CoreLibrary::ApiException
        └── SqlManagementClient::APIException          ← base for all HTTP errors
              └── SqlManagementClient::{OperationError}  ← typed, if generated (in exceptions/)
...
with `.local_error('400', '...message...', SqlManagementClient::{OperationError})`, and any status without a
