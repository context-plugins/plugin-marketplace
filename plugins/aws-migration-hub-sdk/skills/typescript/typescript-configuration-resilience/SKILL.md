...
All config below is passed at construction time via the `AWSMigrationHubClientConfig` object.

## Base URL / environment override

```typescript
import { AWSMigrationHubClient, Environment } from 'aws-migration-hublib';
