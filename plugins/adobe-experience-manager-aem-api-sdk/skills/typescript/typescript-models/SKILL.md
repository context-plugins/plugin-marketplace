...
```typescript
import { {Union}, {Variant} } from 'adobe-experience-manager-aem-apilib';
...
```typescript
import { is{Variant} } from 'adobe-experience-manager-aem-apilib';
...
```typescript
import { {EnumType} } from 'adobe-experience-manager-aem-apilib';
