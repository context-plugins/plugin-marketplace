...
### GetTransfers
- **HTTP**: `GET /transfers` (Default (balanceplatform-api-test))
...
### GetTransfersId
- **HTTP**: `GET /transfers/{id}` (Default (balanceplatform-api-test))
...
### PostTransfers
- **HTTP**: `POST /transfers` (Default (balanceplatform-api-test))
...
- **Error accessors**: `TryGetServiceError(out ServiceError)` [401] · `TryGetTransferServiceRestServiceError(out TransferServiceRestServiceError)` [403, 422, 500] · `TryGetRawError(out RawError)` [fallback]
- **No-throw variant**: absent
- **Pagination**: none

### PostTransfersApprove
- **HTTP**: `POST /transfers/approve` (Default (balanceplatform-api-test))
...
### PostTransfersCancel
- **HTTP**: `POST /transfers/cancel` (Default (balanceplatform-api-test))
...
- **HTTP**: `POST /transfers/{transferId}/returns` (Default (balanceplatform-api-test))
