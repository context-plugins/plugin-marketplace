...
> Throughout, `1forgefinanceapis` and other `{...}` tokens are placeholders for names you take from your SDK —
...
client := 1forgefinanceapis.NewClient(
    1forgefinanceapis.CreateConfiguration(
        1forgefinanceapis.WithBasicAuthCredentials(
            1forgefinanceapis.NewBasicAuthCredentials(
...
1forgefinanceapis.WithApiKeyCredentials(1forgefinanceapis.NewApiKeyCredentials("token", "api-key"))

// custom header scheme (often surfaced as ApiHeaderCredentials):
1forgefinanceapis.WithApiHeaderCredentials(1forgefinanceapis.NewApiHeaderCredentials("token", "api-key"))
```
...
```go
1forgefinanceapis.WithOAuthBearerTokenCredentials(
    1forgefinanceapis.NewOAuthBearerTokenCredentials(os.Getenv("{ACCESS_TOKEN_ENV}")),
)
```
...
client := 1forgefinanceapis.NewClient(
    1forgefinanceapis.CreateConfiguration(
        1forgefinanceapis.WithOAuthCCGCredentials(
            1forgefinanceapis.NewOAuthCCGCredentials(
