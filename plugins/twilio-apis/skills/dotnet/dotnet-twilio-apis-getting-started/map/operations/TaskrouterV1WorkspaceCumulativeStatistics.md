...
Accessor: `client.TaskrouterV1WorkspaceCumulativeStatistics` · Source: `Api/TaskrouterV1WorkspaceCumulativeStatistics.cs` · 1 operations

**Parameter names are literal.** Signatures are generated code verbatim — in named arguments use the exact parameter names shown (the cancellation-token parameter is named `ct`).

### FetchWorkspaceCumulativeStatistics
- **HTTP**: `GET /v1/Workspaces/{WorkspaceSid}/CumulativeStatistics` (Default (accounts))
...
- **Returns**: `WorkspaceCumulativeStatistics`
