...
`staxfattmerchantapi/models/` and `staxfattmerchantapi/api_helper.py`.
...
```python
from staxfattmerchantapi.models.o_auth_token import OAuthToken
...
```python
from staxfattmerchantapi.models.animal import Cat
