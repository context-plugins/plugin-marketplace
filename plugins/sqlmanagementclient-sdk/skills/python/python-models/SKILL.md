...
your SDK source (`sqlmanagementclient/models/`).
...
```python
from sqlmanagementclient.api_helper import APIHelper
...
`UnionTypeLookUp` registry (in `sqlmanagementclient/utilities/union_type_lookup.py`) and each candidate model
...
```python
from sqlmanagementclient.models.animal import Cat, Dog
...
```python
from sqlmanagementclient.models.animal import Animal, Cat, Dog
