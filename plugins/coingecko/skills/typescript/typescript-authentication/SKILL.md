...
> Throughout this skill, `{...}` is a placeholder for a name you take from your SDK (e.g. `coingecko-demo-apilib`, `Configuration`, `{basicAuthProperty}`) — replace it with the concrete identifier from the source.
