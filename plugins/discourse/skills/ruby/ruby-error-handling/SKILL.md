...
StandardError
  └── CoreLibrary::ApiException
        └── Discourse::APIException          ← base for all HTTP errors
              └── Discourse::{OperationError}  ← typed, if generated (in exceptions/)
...
with `.local_error('400', '...message...', Discourse::{OperationError})`, and any status without a
