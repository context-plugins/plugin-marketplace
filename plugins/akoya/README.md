...
Integrate and consume the **APIMatic-generated akoya SDK** (the "APIMATIC v3.0" generic
...
(`dotnet-akoya-getting-started/sdk-map.md` + `map/`) indexing every operation signature,
model, enum, union, and error type. The **`dotnet-integrate-akoya`** router skill routes all
C#/.NET SDK work to the single **`dotnet-akoya-sdk`** agent (.NET-only), which answers
