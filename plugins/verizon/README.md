...
Integrate and consume the **APIMatic-generated verizon SDK** (the "APIMATIC v3.0" generic
...
(`dotnet-verizon-getting-started/sdk-map.md` + `map/`) indexing every operation signature,
model, enum, union, and error type. The **`dotnet-integrate-verizon`** router skill routes all
C#/.NET SDK work to the single **`dotnet-verizon-sdk`** agent (.NET-only), which answers
