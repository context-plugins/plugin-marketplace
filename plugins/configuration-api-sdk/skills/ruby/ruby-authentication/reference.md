...
Confirm every name against `lib/configuration_api/client.rb`, `lib/configuration_api/configuration.rb`, the
`lib/configuration_api/http/auth/*.rb` files, and `doc/auth/*.md` in the cloned source.
