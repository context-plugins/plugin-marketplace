    ...
    hotelnameautocomplete.CreateConfiguration(
        hotelnameautocomplete.WithHttpConfiguration(
            hotelnameautocomplete.CreateHttpConfiguration(
                hotelnameautocomplete.WithTimeout(30),
                hotelnameautocomplete.WithRetryConfiguration(
                    hotelnameautocomplete.CreateRetryConfiguration(
                        hotelnameautocomplete.WithMaxRetryAttempts(3),
                        hotelnameautocomplete.WithBackoffFactor(2),
                    ),
                ),
            ),
        ),
...
```go
rc := hotelnameautocomplete.CreateRetryConfiguration(
    hotelnameautocomplete.WithMaxRetryAttempts(5),
    hotelnameautocomplete.WithRetryInterval(1),
    hotelnameautocomplete.WithBackoffFactor(2),
    hotelnameautocomplete.WithHttpStatusCodesToRetry([]int64{429, 500, 503}),
    hotelnameautocomplete.WithHttpMethodsToRetry([]string{"GET", "PUT"}),
)
```
...
client := hotelnameautocomplete.NewClient(
    hotelnameautocomplete.CreateConfiguration(
        hotelnameautocomplete.WithHttpConfiguration(
            hotelnameautocomplete.CreateHttpConfiguration(
                hotelnameautocomplete.WithTransport(&loggingTransport{inner: http.DefaultTransport}),
            ),
        ),
    ),
)
