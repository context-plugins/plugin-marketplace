...
```typescript
import { {Union}, {Variant} } from 'klarna-payments-api-v-1-lib';
...
```typescript
import { is{Variant} } from 'klarna-payments-api-v-1-lib';
...
```typescript
import { {EnumType} } from 'klarna-payments-api-v-1-lib';
