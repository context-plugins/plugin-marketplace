...
- **HTTP**: `GET /terminals/{terminalId}/terminalLogos` (Default9 (management-test))
...
- **HTTP**: `GET /terminals/{terminalId}/terminalSettings` (Default9 (management-test))
...
- **HTTP**: `PATCH /terminals/{terminalId}/terminalLogos` (Default9 (management-test))
...
- **HTTP**: `PATCH /terminals/{terminalId}/terminalSettings` (Default9 (management-test))
