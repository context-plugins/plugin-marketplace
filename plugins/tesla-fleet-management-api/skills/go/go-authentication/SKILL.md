...
> Throughout, `teslafleetmanagementapi` and other `{...}` tokens are placeholders for names you take from your SDK —
...
client := teslafleetmanagementapi.NewClient(
    teslafleetmanagementapi.CreateConfiguration(
        teslafleetmanagementapi.WithBasicAuthCredentials(
            teslafleetmanagementapi.NewBasicAuthCredentials(
...
teslafleetmanagementapi.WithApiKeyCredentials(teslafleetmanagementapi.NewApiKeyCredentials("token", "api-key"))

// custom header scheme (often surfaced as ApiHeaderCredentials):
teslafleetmanagementapi.WithApiHeaderCredentials(teslafleetmanagementapi.NewApiHeaderCredentials("token", "api-key"))
```
...
```go
teslafleetmanagementapi.WithOAuthBearerTokenCredentials(
    teslafleetmanagementapi.NewOAuthBearerTokenCredentials(os.Getenv("{ACCESS_TOKEN_ENV}")),
)
```
...
client := teslafleetmanagementapi.NewClient(
    teslafleetmanagementapi.CreateConfiguration(
        teslafleetmanagementapi.WithOAuthCCGCredentials(
            teslafleetmanagementapi.NewOAuthCCGCredentials(
