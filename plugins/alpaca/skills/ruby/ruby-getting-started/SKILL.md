...
| Install | `gem 'trader_api', git: 'https://github.com/context-plugins/alpaca-ruby-sdk', branch: 'main'` in a Gemfile |
...
```ruby
# In your Gemfile:
gem 'trader_api', git: 'https://github.com/context-plugins/alpaca-ruby-sdk', branch: 'main'
```
...
```bash
# Linux / macOS:
git clone --depth 1 --branch main https://github.com/context-plugins/alpaca-ruby-sdk /tmp/alpaca-ruby-src
```

```powershell
# Windows (PowerShell):
git clone --depth 1 --branch main https://github.com/context-plugins/alpaca-ruby-sdk "$env:TEMP\alpaca-ruby-src"
```
...
```bash
rm -rf /tmp/alpaca-ruby-src                               # Linux / macOS
```
```powershell
Remove-Item -Recurse -Force "$env:TEMP\alpaca-ruby-src"   # Windows
```
