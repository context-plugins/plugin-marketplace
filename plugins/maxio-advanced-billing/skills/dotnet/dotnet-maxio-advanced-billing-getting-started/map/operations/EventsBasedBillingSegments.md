...
- **Error accessors**: `TryGetNoContent(out RawError)` [404] · `TryGetEventBasedBillingSegment(out EventBasedBillingSegment)` [422] · `TryGetRawError(out RawError)` [fallback]
...
- **Error accessors**: `TryGetNoContent(out RawError)` [404] · `TryGetEventBasedBillingSegmentErrors(out EventBasedBillingSegmentErrors)` [422] · `TryGetRawError(out RawError)` [fallback]
- **No-throw variant**: absent
- **Pagination**: none
...
- **Error accessors**: `TryGetNoContent(out RawError)` [404] · `TryGetEventBasedBillingListSegmentsErrors(out EventBasedBillingListSegmentsErrors)` [422] · `TryGetRawError(out RawError)` [fallback]
- **No-throw variant**: absent
