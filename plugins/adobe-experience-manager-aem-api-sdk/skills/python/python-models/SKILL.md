...
your SDK source (`adobeexperiencemanageraemapi/models/`).
...
```python
from adobeexperiencemanageraemapi.api_helper import APIHelper
...
`UnionTypeLookUp` registry (in `adobeexperiencemanageraemapi/utilities/union_type_lookup.py`) and each candidate model
...
```python
from adobeexperiencemanageraemapi.models.animal import Cat, Dog
...
```python
from adobeexperiencemanageraemapi.models.animal import Animal, Cat, Dog
