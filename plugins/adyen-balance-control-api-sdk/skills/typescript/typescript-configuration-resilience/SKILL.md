...
All config below is passed at construction time via the `AdyenBalanceControlAPIClientConfig` object.

## Base URL / environment override

```typescript
import { AdyenBalanceControlAPIClient, Environment } from 'adyen-balance-control-apilib';
