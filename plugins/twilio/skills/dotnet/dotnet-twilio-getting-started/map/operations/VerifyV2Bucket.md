...
### CreateBucket
- **HTTP**: `POST /v2/Services/{ServiceSid}/RateLimits/{RateLimitSid}/Buckets` (Default13 (verify))
...
### DeleteBucket
- **HTTP**: `DELETE /v2/Services/{ServiceSid}/RateLimits/{RateLimitSid}/Buckets/{Sid}` (Default13 (verify))
...
### FetchBucket
- **HTTP**: `GET /v2/Services/{ServiceSid}/RateLimits/{RateLimitSid}/Buckets/{Sid}` (Default13 (verify))
...
### ListBucket
- **HTTP**: `GET /v2/Services/{ServiceSid}/RateLimits/{RateLimitSid}/Buckets` (Default13 (verify))
...
### UpdateBucket
- **HTTP**: `POST /v2/Services/{ServiceSid}/RateLimits/{RateLimitSid}/Buckets/{Sid}` (Default13 (verify))
