...
your SDK source (`telegrambotapi/models/`).
...
```python
from telegrambotapi.api_helper import APIHelper
...
`UnionTypeLookUp` registry (in `telegrambotapi/utilities/union_type_lookup.py`) and each candidate model
...
```python
from telegrambotapi.models.animal import Cat, Dog
...
```python
from telegrambotapi.models.animal import Animal, Cat, Dog
