...
All config below is passed at construction time via the `AdafruitIORESTAPIClientConfig` object.

## Base URL / environment override

```typescript
import { AdafruitIORESTAPIClient, Environment } from 'adafruit-io-rest-apilib';
