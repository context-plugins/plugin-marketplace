...
Integrate and consume the **APIMatic-generated alpaca SDK** (the "APIMATIC v3.0" generic
...
(`dotnet-alpaca-getting-started/sdk-map.md` + `map/`) indexing every operation signature,
model, enum, union, and error type. The **`dotnet-integrate-alpaca`** router skill routes all
C#/.NET SDK work to the single **`dotnet-alpaca-sdk`** agent (.NET-only), which answers
