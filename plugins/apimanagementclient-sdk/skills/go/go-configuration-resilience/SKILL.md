    ...
    apimanagementclient.CreateConfiguration(
        apimanagementclient.WithHttpConfiguration(
            apimanagementclient.CreateHttpConfiguration(
                apimanagementclient.WithTimeout(30),
                apimanagementclient.WithRetryConfiguration(
                    apimanagementclient.CreateRetryConfiguration(
                        apimanagementclient.WithMaxRetryAttempts(3),
                        apimanagementclient.WithBackoffFactor(2),
                    ),
                ),
            ),
        ),
...
```go
rc := apimanagementclient.CreateRetryConfiguration(
    apimanagementclient.WithMaxRetryAttempts(5),
    apimanagementclient.WithRetryInterval(1),
    apimanagementclient.WithBackoffFactor(2),
    apimanagementclient.WithHttpStatusCodesToRetry([]int64{429, 500, 503}),
    apimanagementclient.WithHttpMethodsToRetry([]string{"GET", "PUT"}),
)
```
...
client := apimanagementclient.NewClient(
    apimanagementclient.CreateConfiguration(
        apimanagementclient.WithHttpConfiguration(
            apimanagementclient.CreateHttpConfiguration(
                apimanagementclient.WithTransport(&loggingTransport{inner: http.DefaultTransport}),
            ),
        ),
    ),
)
