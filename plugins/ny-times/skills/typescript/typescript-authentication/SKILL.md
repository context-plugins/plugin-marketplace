...
> Throughout this skill, `{...}` is a placeholder for a name you take from your SDK (e.g. `ny-timeslib`, `Configuration`, `{basicAuthProperty}`) — replace it with the concrete identifier from the source.
