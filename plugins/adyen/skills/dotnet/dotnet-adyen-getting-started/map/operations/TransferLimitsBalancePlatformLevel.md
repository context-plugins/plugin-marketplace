...
- **HTTP**: `DELETE /balancePlatforms/{id}/transferLimits/{transferLimitId}` (Default13 (balanceplatform-api-test))
...
- **HTTP**: `GET /balancePlatforms/{id}/transferLimits` (Default13 (balanceplatform-api-test))
...
- **HTTP**: `GET /balancePlatforms/{id}/transferLimits/{transferLimitId}` (Default13 (balanceplatform-api-test))
...
- **HTTP**: `POST /balancePlatforms/{id}/transferLimits` (Default13 (balanceplatform-api-test))
