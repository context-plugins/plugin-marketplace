...
- **Signature**: `AttachGraphicItemToScene(double liveEventId, string sceneId, RequestOptions? requestOptions = null, CancellationToken ct = default)`
...
- **Signature**: `CreateComposerScene(double liveEventId, RequestOptions? requestOptions = null, CancellationToken ct = default)`
  - defaults: `requestOptions` = null
- **Returns**: `void` (Task)
