...
StandardError
  └── CoreLibrary::ApiException
        └── AdyenDataProtectionAPI::APIException          ← base for all HTTP errors
              └── AdyenDataProtectionAPI::{OperationError}  ← typed, if generated (in exceptions/)
...
with `.local_error('400', '...message...', AdyenDataProtectionAPI::{OperationError})`, and any status without a
