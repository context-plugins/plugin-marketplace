    ...
    mailboxvalidatorfreeemailchecker.CreateConfiguration(
        mailboxvalidatorfreeemailchecker.WithHttpConfiguration(
            mailboxvalidatorfreeemailchecker.CreateHttpConfiguration(
                mailboxvalidatorfreeemailchecker.WithTimeout(30),
                mailboxvalidatorfreeemailchecker.WithRetryConfiguration(
                    mailboxvalidatorfreeemailchecker.CreateRetryConfiguration(
                        mailboxvalidatorfreeemailchecker.WithMaxRetryAttempts(3),
                        mailboxvalidatorfreeemailchecker.WithBackoffFactor(2),
                    ),
                ),
            ),
        ),
...
```go
rc := mailboxvalidatorfreeemailchecker.CreateRetryConfiguration(
    mailboxvalidatorfreeemailchecker.WithMaxRetryAttempts(5),
    mailboxvalidatorfreeemailchecker.WithRetryInterval(1),
    mailboxvalidatorfreeemailchecker.WithBackoffFactor(2),
    mailboxvalidatorfreeemailchecker.WithHttpStatusCodesToRetry([]int64{429, 500, 503}),
    mailboxvalidatorfreeemailchecker.WithHttpMethodsToRetry([]string{"GET", "PUT"}),
)
```
...
client := mailboxvalidatorfreeemailchecker.NewClient(
    mailboxvalidatorfreeemailchecker.CreateConfiguration(
        mailboxvalidatorfreeemailchecker.WithHttpConfiguration(
            mailboxvalidatorfreeemailchecker.CreateHttpConfiguration(
                mailboxvalidatorfreeemailchecker.WithTransport(&loggingTransport{inner: http.DefaultTransport}),
            ),
        ),
    ),
)
