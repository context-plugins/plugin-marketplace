...
```php
$client = new ShellCardManagementAPIsClient([
    'environment' => ShellCardManagementAPIsClient::ENVIRONMENT_PRODUCTION,  // picks server template
...
$client = new ShellCardManagementAPIsClient(['httpClient' => $httpClient, /* ...auth */]);
