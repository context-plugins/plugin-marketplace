    ...
    pqapiv2.CreateConfiguration(
        pqapiv2.WithHttpConfiguration(
            pqapiv2.CreateHttpConfiguration(
                pqapiv2.WithTimeout(30),
                pqapiv2.WithRetryConfiguration(
                    pqapiv2.CreateRetryConfiguration(
                        pqapiv2.WithMaxRetryAttempts(3),
                        pqapiv2.WithBackoffFactor(2),
                    ),
                ),
            ),
        ),
...
```go
rc := pqapiv2.CreateRetryConfiguration(
    pqapiv2.WithMaxRetryAttempts(5),
    pqapiv2.WithRetryInterval(1),
    pqapiv2.WithBackoffFactor(2),
    pqapiv2.WithHttpStatusCodesToRetry([]int64{429, 500, 503}),
    pqapiv2.WithHttpMethodsToRetry([]string{"GET", "PUT"}),
)
```
...
client := pqapiv2.NewClient(
    pqapiv2.CreateConfiguration(
        pqapiv2.WithHttpConfiguration(
            pqapiv2.CreateHttpConfiguration(
                pqapiv2.WithTransport(&loggingTransport{inner: http.DefaultTransport}),
            ),
        ),
    ),
)
