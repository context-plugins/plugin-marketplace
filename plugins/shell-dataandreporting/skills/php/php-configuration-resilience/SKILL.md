...
```php
$client = new ShellDataReportingAPIsClient([
    'environment' => ShellDataReportingAPIsClient::ENVIRONMENT_PRODUCTION,  // picks server template
...
$client = new ShellDataReportingAPIsClient(['httpClient' => $httpClient, /* ...auth */]);
