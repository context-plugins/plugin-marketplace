...
StandardError
  └── CoreLibrary::ApiException
        └── Slack::APIException          ← base for all HTTP errors
              └── Slack::{OperationError}  ← typed, if generated (in exceptions/)
...
with `.local_error('400', '...message...', Slack::{OperationError})`, and any status without a
