...
```php
$client = new SpotifyWebAPIWithFixesAndImprovementsFromSonalluxClient([
    'environment' => SpotifyWebAPIWithFixesAndImprovementsFromSonalluxClient::ENVIRONMENT_PRODUCTION,  // picks server template
...
$client = new SpotifyWebAPIWithFixesAndImprovementsFromSonalluxClient(['httpClient' => $httpClient, /* ...auth */]);
