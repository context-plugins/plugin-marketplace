...
your SDK source (`locationscore/models/`).
...
```python
from locationscore.api_helper import APIHelper
...
`UnionTypeLookUp` registry (in `locationscore/utilities/union_type_lookup.py`) and each candidate model
...
```python
from locationscore.models.animal import Cat, Dog
...
```python
from locationscore.models.animal import Animal, Cat, Dog
