...
> Throughout this skill, `{...}` is a placeholder for a name you take from your SDK (e.g. `payquickersdk`, `PQAPIV2ClientConfig`, `{basicAuthProperty}`) — replace it with the concrete identifier from the source.
