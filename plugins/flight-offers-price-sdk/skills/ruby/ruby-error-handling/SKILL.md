...
StandardError
  └── CoreLibrary::ApiException
        └── FlightOffersPrice::APIException          ← base for all HTTP errors
              └── FlightOffersPrice::{OperationError}  ← typed, if generated (in exceptions/)
...
with `.local_error('400', '...message...', FlightOffersPrice::{OperationError})`, and any status without a
