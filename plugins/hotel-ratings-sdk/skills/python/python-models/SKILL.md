...
your SDK source (`hotelratings/models/`).
...
```python
from hotelratings.api_helper import APIHelper
...
`UnionTypeLookUp` registry (in `hotelratings/utilities/union_type_lookup.py`) and each candidate model
...
```python
from hotelratings.models.animal import Cat, Dog
...
```python
from hotelratings.models.animal import Animal, Cat, Dog
