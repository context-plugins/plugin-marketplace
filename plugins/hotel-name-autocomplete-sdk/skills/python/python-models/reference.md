...
`hotelnameautocomplete/models/` and `hotelnameautocomplete/api_helper.py`.
...
```python
from hotelnameautocomplete.models.o_auth_token import OAuthToken
...
```python
from hotelnameautocomplete.models.animal import Cat
