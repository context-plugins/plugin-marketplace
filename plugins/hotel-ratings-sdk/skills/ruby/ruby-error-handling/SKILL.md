...
StandardError
  └── CoreLibrary::ApiException
        └── HotelRatings::APIException          ← base for all HTTP errors
              └── HotelRatings::{OperationError}  ← typed, if generated (in exceptions/)
...
with `.local_error('400', '...message...', HotelRatings::{OperationError})`, and any status without a
