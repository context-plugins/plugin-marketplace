...
| Install | `pip install "git+https://github.com/context-plugins/api-apis-guru-python-ab984a@main"` |
...
```bash
pip install "git+https://github.com/context-plugins/api-apis-guru-python-ab984a@main"
```
...
```bash
# Linux / macOS:
git clone --depth 1 --branch main https://github.com/context-plugins/api-apis-guru-python-ab984a /tmp/api-apis-guru-python-src
```

```powershell
# Windows (PowerShell):
git clone --depth 1 --branch main https://github.com/context-plugins/api-apis-guru-python-ab984a "$env:TEMP\api-apis-guru-python-src"
```
