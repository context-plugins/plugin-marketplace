    ...
    shutterstockapiexplorer.CreateConfiguration(
        shutterstockapiexplorer.WithHttpConfiguration(
            shutterstockapiexplorer.CreateHttpConfiguration(
                shutterstockapiexplorer.WithTimeout(30),
                shutterstockapiexplorer.WithRetryConfiguration(
                    shutterstockapiexplorer.CreateRetryConfiguration(
                        shutterstockapiexplorer.WithMaxRetryAttempts(3),
...
```go
rc := shutterstockapiexplorer.CreateRetryConfiguration(
    shutterstockapiexplorer.WithMaxRetryAttempts(5),
    shutterstockapiexplorer.WithRetryInterval(1),
    shutterstockapiexplorer.WithBackoffFactor(2),
    shutterstockapiexplorer.WithHttpStatusCodesToRetry([]int64{429, 500, 503}),
    shutterstockapiexplorer.WithHttpMethodsToRetry([]string{"GET", "PUT"}),
)
```
...
client := shutterstockapiexplorer.NewClient(
    shutterstockapiexplorer.CreateConfiguration(
        shutterstockapiexplorer.WithHttpConfiguration(
            shutterstockapiexplorer.CreateHttpConfiguration(
                shutterstockapiexplorer.WithTransport(&loggingTransport{inner: http.DefaultTransport}),
            ),
        ),
    ),
)
