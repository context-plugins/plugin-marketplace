...
All config below is passed at construction time via the `SplititWebApiV3ClientConfig` object.

## Base URL / environment override

```typescript
import { SplititWebApiV3Client, Environment } from 'splitit-web-api-v-3-lib';
