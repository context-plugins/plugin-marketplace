...
- **Signature**: `Delete7(string projectId, string distributionCredentialsId, string authorization, RequestOptions? requestOptions = null, CancellationToken ct = default)`
  - defaults: `requestOptions` = null
...
- **Signature**: `Get11(string projectId, string distributionCredentialsId, string authorization, RequestOptions? requestOptions = null, CancellationToken ct = default)`
  - defaults: `requestOptions` = null
- **Returns**: `GetProjectDistributionCredentialsV1Response`
...
- **Signature**: `List17(string projectId, string authorization, RequestOptions? requestOptions = null, CancellationToken ct = default)`
  - defaults: `requestOptions` = null
