...
Confirm every name against `lib/openuv_global_real_time_uv_index_forecast_api/client.rb`, `lib/openuv_global_real_time_uv_index_forecast_api/configuration.rb`, the
`lib/openuv_global_real_time_uv_index_forecast_api/http/auth/*.rb` files, and `doc/auth/*.md` in the cloned source.
