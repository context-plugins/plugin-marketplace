    ...
    verizon.CreateConfiguration(
        verizon.WithHttpConfiguration(
            verizon.CreateHttpConfiguration(
                ...
                verizon.WithRetryConfiguration(
                    verizon.CreateRetryConfiguration(
                        verizon.WithMaxRetryAttempts(3),
...
```go
rc := verizon.CreateRetryConfiguration(
    verizon.WithMaxRetryAttempts(5),
    verizon.WithRetryInterval(1),
    verizon.WithBackoffFactor(2),
    verizon.WithHttpStatusCodesToRetry([]int64{429, 500, 503}),
...
client := verizon.NewClient(
    verizon.CreateConfiguration(
        verizon.WithHttpConfiguration(
            verizon.CreateHttpConfiguration(
                verizon.WithTransport(&loggingTransport{inner: http.DefaultTransport}),
            ),
        ),
    ),
)
