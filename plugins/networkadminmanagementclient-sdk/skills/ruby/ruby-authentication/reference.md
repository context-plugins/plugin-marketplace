...
Confirm every name against `lib/networkadminmanagementclient/client.rb`, `lib/networkadminmanagementclient/configuration.rb`, the
`lib/networkadminmanagementclient/http/auth/*.rb` files, and `doc/auth/*.md` in the cloned source.
