...
Confirm every name against `lib/1forge_finance_apis/client.rb`, `lib/1forge_finance_apis/configuration.rb`, the
`lib/1forge_finance_apis/http/auth/*.rb` files, and `doc/auth/*.md` in the cloned source.
