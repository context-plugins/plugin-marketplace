    ...
    klarnapaymentsapiv1.CreateConfiguration(
        klarnapaymentsapiv1.WithHttpConfiguration(
            klarnapaymentsapiv1.CreateHttpConfiguration(
                klarnapaymentsapiv1.WithTimeout(30),
                klarnapaymentsapiv1.WithRetryConfiguration(
                    klarnapaymentsapiv1.CreateRetryConfiguration(
                        klarnapaymentsapiv1.WithMaxRetryAttempts(3),
                        klarnapaymentsapiv1.WithBackoffFactor(2),
                    ),
                ),
            ),
        ),
...
```go
rc := klarnapaymentsapiv1.CreateRetryConfiguration(
    klarnapaymentsapiv1.WithMaxRetryAttempts(5),
    klarnapaymentsapiv1.WithRetryInterval(1),
    klarnapaymentsapiv1.WithBackoffFactor(2),
    klarnapaymentsapiv1.WithHttpStatusCodesToRetry([]int64{429, 500, 503}),
    klarnapaymentsapiv1.WithHttpMethodsToRetry([]string{"GET", "PUT"}),
)
```
...
client := klarnapaymentsapiv1.NewClient(
    klarnapaymentsapiv1.CreateConfiguration(
        klarnapaymentsapiv1.WithHttpConfiguration(
            klarnapaymentsapiv1.CreateHttpConfiguration(
                klarnapaymentsapiv1.WithTransport(&loggingTransport{inner: http.DefaultTransport}),
            ),
        ),
    ),
)
