...
StandardError
  └── CoreLibrary::ApiException
        └── LocationScore::APIException          ← base for all HTTP errors
              └── LocationScore::{OperationError}  ← typed, if generated (in exceptions/)
...
with `.local_error('400', '...message...', LocationScore::{OperationError})`, and any status without a
