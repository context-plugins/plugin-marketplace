...
your SDK source (`restapi/models/`).
...
`UnionTypeLookUp` registry (in `restapi/utilities/union_type_lookup.py`) and each candidate model
...
```python
from restapi.models.animal import Cat, Dog
