    ...
    slackwebapi.CreateConfiguration(
        slackwebapi.WithHttpConfiguration(
            slackwebapi.CreateHttpConfiguration(
                slackwebapi.WithTimeout(30),
                slackwebapi.WithRetryConfiguration(
                    slackwebapi.CreateRetryConfiguration(
                        slackwebapi.WithMaxRetryAttempts(3),
                        slackwebapi.WithBackoffFactor(2),
                    ),
                ),
            ),
        ),
...
```go
rc := slackwebapi.CreateRetryConfiguration(
    slackwebapi.WithMaxRetryAttempts(5),
    slackwebapi.WithRetryInterval(1),
    slackwebapi.WithBackoffFactor(2),
    slackwebapi.WithHttpStatusCodesToRetry([]int64{429, 500, 503}),
    slackwebapi.WithHttpMethodsToRetry([]string{"GET", "PUT"}),
)
```
...
client := slackwebapi.NewClient(
    slackwebapi.CreateConfiguration(
        slackwebapi.WithHttpConfiguration(
            slackwebapi.CreateHttpConfiguration(
                slackwebapi.WithTransport(&loggingTransport{inner: http.DefaultTransport}),
            ),
        ),
    ),
)
