# shell-digitalpayments SDK Plugin

Integrate and consume the **APIMatic-generated shell-digitalpayments SDK** (the "APIMATIC v3.0" generic
...
(`dotnet-shell-digitalpayments-getting-started/sdk-map.md` + `map/`) indexing every operation signature,
model, enum, union, and error type. The **`dotnet-integrate-shell-digitalpayments`** router skill routes all
C#/.NET SDK work to the single **`dotnet-shell-digitalpayments-sdk`** agent (.NET-only), which answers
