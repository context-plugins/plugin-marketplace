...
StandardError
  └── CoreLibrary::ApiException
        └── MediumAPI::APIException          ← base for all HTTP errors
              └── MediumAPI::{OperationError}  ← typed, if generated (in exceptions/)
...
with `.local_error('400', '...message...', MediumAPI::{OperationError})`, and any status without a
