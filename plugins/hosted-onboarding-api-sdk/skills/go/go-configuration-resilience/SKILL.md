    ...
    hostedonboardingapi.CreateConfiguration(
        hostedonboardingapi.WithHttpConfiguration(
            hostedonboardingapi.CreateHttpConfiguration(
                hostedonboardingapi.WithTimeout(30),
                hostedonboardingapi.WithRetryConfiguration(
                    hostedonboardingapi.CreateRetryConfiguration(
                        hostedonboardingapi.WithMaxRetryAttempts(3),
                        hostedonboardingapi.WithBackoffFactor(2),
                    ),
                ),
            ),
        ),
...
```go
rc := hostedonboardingapi.CreateRetryConfiguration(
    hostedonboardingapi.WithMaxRetryAttempts(5),
    hostedonboardingapi.WithRetryInterval(1),
    hostedonboardingapi.WithBackoffFactor(2),
    hostedonboardingapi.WithHttpStatusCodesToRetry([]int64{429, 500, 503}),
    hostedonboardingapi.WithHttpMethodsToRetry([]string{"GET", "PUT"}),
)
```
...
client := hostedonboardingapi.NewClient(
    hostedonboardingapi.CreateConfiguration(
        hostedonboardingapi.WithHttpConfiguration(
            hostedonboardingapi.CreateHttpConfiguration(
                hostedonboardingapi.WithTransport(&loggingTransport{inner: http.DefaultTransport}),
            ),
        ),
    ),
)
