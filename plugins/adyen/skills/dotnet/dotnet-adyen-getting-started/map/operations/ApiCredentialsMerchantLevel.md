...
- **HTTP**: `GET /merchants/{merchantId}/apiCredentials` (Default9 (management-test))
...
- **HTTP**: `GET /merchants/{merchantId}/apiCredentials/{apiCredentialId}` (Default9 (management-test))
...
- **HTTP**: `PATCH /merchants/{merchantId}/apiCredentials/{apiCredentialId}` (Default9 (management-test))
...
- **HTTP**: `POST /merchants/{merchantId}/apiCredentials` (Default9 (management-test))
