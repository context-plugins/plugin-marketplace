...
StandardError
  └── CoreLibrary::ApiException
        └── Firecrawl::APIException          ← base for all HTTP errors
              └── Firecrawl::{OperationError}  ← typed, if generated (in exceptions/)
...
with `.local_error('400', '...message...', Firecrawl::{OperationError})`, and any status without a
