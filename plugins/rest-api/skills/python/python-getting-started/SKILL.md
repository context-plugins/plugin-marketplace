...
| Install | `pip install "git+https://github.com/context-plugins/rest-api-python-sdk@main"` |
...
```bash
pip install "git+https://github.com/context-plugins/rest-api-python-sdk@main"
```
...
```bash
# Linux / macOS:
git clone --depth 1 --branch main https://github.com/context-plugins/rest-api-python-sdk /tmp/rest-api-python-src
```

```powershell
# Windows (PowerShell):
git clone --depth 1 --branch main https://github.com/context-plugins/rest-api-python-sdk "$env:TEMP\rest-api-python-src"
```
...
```bash
rm -rf /tmp/rest-api-python-src                               # Linux / macOS
```
```powershell
Remove-Item -Recurse -Force "$env:TEMP\rest-api-python-src"   # Windows
```
