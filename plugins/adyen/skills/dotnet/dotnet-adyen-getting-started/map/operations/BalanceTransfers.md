...
- **HTTP**: `POST /balanceTransfers` (Default (balanceplatform-api-test))
...
- **Error accessors**: `TryGetBalanceTransfers401Error1(out BalanceTransfers401Error1)` [401] · `TryGetBalanceTransfers422Error1(out BalanceTransfers422Error1)` [422] · `TryGetRawError(out RawError)` [fallback]
