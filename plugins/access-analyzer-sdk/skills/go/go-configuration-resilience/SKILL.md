    ...
    accessanalyzer.CreateConfiguration(
        accessanalyzer.WithHttpConfiguration(
            accessanalyzer.CreateHttpConfiguration(
                accessanalyzer.WithTimeout(30),
                accessanalyzer.WithRetryConfiguration(
                    accessanalyzer.CreateRetryConfiguration(
                        accessanalyzer.WithMaxRetryAttempts(3),
                        accessanalyzer.WithBackoffFactor(2),
                    ),
                ),
            ),
        ),
...
```go
rc := accessanalyzer.CreateRetryConfiguration(
    accessanalyzer.WithMaxRetryAttempts(5),
    accessanalyzer.WithRetryInterval(1),
    accessanalyzer.WithBackoffFactor(2),
    accessanalyzer.WithHttpStatusCodesToRetry([]int64{429, 500, 503}),
    accessanalyzer.WithHttpMethodsToRetry([]string{"GET", "PUT"}),
)
```
...
client := accessanalyzer.NewClient(
    accessanalyzer.CreateConfiguration(
        accessanalyzer.WithHttpConfiguration(
            accessanalyzer.CreateHttpConfiguration(
                accessanalyzer.WithTransport(&loggingTransport{inner: http.DefaultTransport}),
            ),
        ),
    ),
)
