...
- **HTTP**: `POST /v2/HostedNumber/Orders` (Default7 (numbers))
...
- **HTTP**: `DELETE /v2/HostedNumber/Orders/{Sid}` (Default7 (numbers))
...
- **HTTP**: `GET /v2/HostedNumber/Orders/{Sid}` (Default7 (numbers))
...
- **HTTP**: `GET /v2/HostedNumber/Orders` (Default7 (numbers))
...
- **HTTP**: `POST /v2/HostedNumber/Orders/{Sid}` (Default7 (numbers))
