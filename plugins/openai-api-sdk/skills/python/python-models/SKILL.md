...
your SDK source (`openaiapi/models/`).
...
`UnionTypeLookUp` registry (in `openaiapi/utilities/union_type_lookup.py`) and each candidate model
...
```python
from openaiapi.models.animal import Cat, Dog
...
```python
from openaiapi.models.animal import Animal, Cat, Dog
