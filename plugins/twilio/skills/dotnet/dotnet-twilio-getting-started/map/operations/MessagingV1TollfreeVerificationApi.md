...
- **HTTP**: `POST /v1/Tollfree/Verifications` (Default1 (messaging))
...
- **HTTP**: `DELETE /v1/Tollfree/Verifications/{Sid}` (Default1 (messaging))
...
- **HTTP**: `GET /v1/Tollfree/Verifications/{Sid}` (Default1 (messaging))
...
- **HTTP**: `GET /v1/Tollfree/Verifications` (Default1 (messaging))
...
- **HTTP**: `POST /v1/Tollfree/Verifications/{Sid}` (Default1 (messaging))
