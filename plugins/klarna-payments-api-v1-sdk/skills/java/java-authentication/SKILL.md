...
To see which schemes a specific SDK accepts, read the credential setter methods on `KlarnaPaymentsAPIV1Client.Builder`
...
- Set credentials **on the `KlarnaPaymentsAPIV1Client.Builder`** before calling `.build()` — the client is immutable
