...
Integrate and consume the **APIMatic-generated Paze SDK** (the "APIMATIC v3.0" generic
...
(`dotnet-paze-getting-started/sdk-map.md` + `map/`) indexing every operation signature,
model, enum, union, and error type. The **`dotnet-integrate-paze`** router skill routes all
C#/.NET SDK work to the single **`dotnet-paze-sdk`** agent (.NET-only), which answers
