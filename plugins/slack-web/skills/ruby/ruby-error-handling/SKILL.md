...
StandardError
  └── CoreLibrary::ApiException
        └── SlackWebAPI::APIException          ← base for all HTTP errors
              └── SlackWebAPI::{OperationError}  ← typed, if generated (in exceptions/)
...
with `.local_error('400', '...message...', SlackWebAPI::{OperationError})`, and any status without a
