...
StandardError
  └── CoreLibrary::ApiException
        └── Finnhub::APIException          ← base for all HTTP errors
              └── Finnhub::{OperationError}  ← typed, if generated (in exceptions/)
...
with `.local_error('400', '...message...', Finnhub::{OperationError})`, and any status without a
