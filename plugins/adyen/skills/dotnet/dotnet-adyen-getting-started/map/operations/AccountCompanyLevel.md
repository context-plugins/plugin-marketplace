...
### GetCompanies
- **HTTP**: `GET /companies` (Default (balanceplatform-api-test))
...
- **HTTP**: `GET /companies/{companyId}` (Default (balanceplatform-api-test))
...
- **HTTP**: `GET /companies/{companyId}/merchants` (Default (balanceplatform-api-test))
