...
```php
$client = new DiscourseApiDocumentationClient([
    'environment' => DiscourseApiDocumentationClient::ENVIRONMENT_PRODUCTION,  // picks server template
...
$client = new DiscourseApiDocumentationClient(['httpClient' => $httpClient, /* ...auth */]);
