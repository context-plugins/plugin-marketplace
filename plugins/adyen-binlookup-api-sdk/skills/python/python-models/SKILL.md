...
your SDK source (`adyenbinlookupapi/models/`).
...
```python
from adyenbinlookupapi.api_helper import APIHelper
...
`UnionTypeLookUp` registry (in `adyenbinlookupapi/utilities/union_type_lookup.py`) and each candidate model
...
```python
from adyenbinlookupapi.models.animal import Cat, Dog
...
```python
from adyenbinlookupapi.models.animal import Animal, Cat, Dog
