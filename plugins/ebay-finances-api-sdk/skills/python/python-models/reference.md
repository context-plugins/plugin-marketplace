...
`ebayfinancesapi/models/` and `ebayfinancesapi/api_helper.py`.
...
```python
from ebayfinancesapi.models.o_auth_token import OAuthToken
...
```python
from ebayfinancesapi.models.animal import Cat
