    ...
    pazecheckoutapi.CreateConfiguration(
        pazecheckoutapi.WithHttpConfiguration(
            pazecheckoutapi.CreateHttpConfiguration(
                pazecheckoutapi.WithTimeout(30),
                pazecheckoutapi.WithRetryConfiguration(
                    pazecheckoutapi.CreateRetryConfiguration(
                        pazecheckoutapi.WithMaxRetryAttempts(3),
                        pazecheckoutapi.WithBackoffFactor(2),
                    ),
                ),
            ),
        ),
...
```go
rc := pazecheckoutapi.CreateRetryConfiguration(
    pazecheckoutapi.WithMaxRetryAttempts(5),
    pazecheckoutapi.WithRetryInterval(1),
    pazecheckoutapi.WithBackoffFactor(2),
    pazecheckoutapi.WithHttpStatusCodesToRetry([]int64{429, 500, 503}),
    pazecheckoutapi.WithHttpMethodsToRetry([]string{"GET", "PUT"}),
)
```
...
client := pazecheckoutapi.NewClient(
    pazecheckoutapi.CreateConfiguration(
        pazecheckoutapi.WithHttpConfiguration(
            pazecheckoutapi.CreateHttpConfiguration(
                pazecheckoutapi.WithTransport(&loggingTransport{inner: http.DefaultTransport}),
            ),
        ),
    ),
)
