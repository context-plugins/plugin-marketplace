...
StandardError
  └── CoreLibrary::ApiException
        └── Boku::APIException          ← base for all HTTP errors
              └── Boku::{OperationError}  ← typed, if generated (in exceptions/)
...
with `.local_error('400', '...message...', Boku::{OperationError})`, and any status without a
