...
Confirm every name against `lib/hotel_name_autocomplete/client.rb`, `lib/hotel_name_autocomplete/configuration.rb`, the
`lib/hotel_name_autocomplete/http/auth/*.rb` files, and `doc/auth/*.md` in the cloned source.
