    ...
    sqlmanagementclient.CreateConfiguration(
        sqlmanagementclient.WithHttpConfiguration(
            sqlmanagementclient.CreateHttpConfiguration(
                sqlmanagementclient.WithTimeout(30),
                sqlmanagementclient.WithRetryConfiguration(
                    sqlmanagementclient.CreateRetryConfiguration(
                        sqlmanagementclient.WithMaxRetryAttempts(3),
                        sqlmanagementclient.WithBackoffFactor(2),
                    ),
                ),
            ),
        ),
...
```go
rc := sqlmanagementclient.CreateRetryConfiguration(
    sqlmanagementclient.WithMaxRetryAttempts(5),
    sqlmanagementclient.WithRetryInterval(1),
    sqlmanagementclient.WithBackoffFactor(2),
    sqlmanagementclient.WithHttpStatusCodesToRetry([]int64{429, 500, 503}),
    sqlmanagementclient.WithHttpMethodsToRetry([]string{"GET", "PUT"}),
)
```
...
client := sqlmanagementclient.NewClient(
    sqlmanagementclient.CreateConfiguration(
        sqlmanagementclient.WithHttpConfiguration(
            sqlmanagementclient.CreateHttpConfiguration(
                sqlmanagementclient.WithTransport(&loggingTransport{inner: http.DefaultTransport}),
            ),
        ),
    ),
)
