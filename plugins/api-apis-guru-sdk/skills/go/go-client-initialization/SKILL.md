...
- `github.com/context-plugins/api-apis-guru-go-64002b` — the Go import path for the root package; `github.com/context-plugins/api-apis-guru-go-64002b/models` for request/response types.
...
```go
import "github.com/context-plugins/api-apis-guru-go-64002b"
