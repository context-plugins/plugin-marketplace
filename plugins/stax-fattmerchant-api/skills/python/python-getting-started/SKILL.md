...
> setting, so **confirm it** from the class names under `staxfattmerchantapi/apis/`.
...
- `staxfattmerchantapi/controllers/` — one `{Resource}Api` per API resource group, all inheriting from
