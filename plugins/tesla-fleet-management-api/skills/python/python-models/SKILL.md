...
your SDK source (`teslafleetmanagementapi/models/`).
...
```python
from teslafleetmanagementapi.api_helper import APIHelper
...
`UnionTypeLookUp` registry (in `teslafleetmanagementapi/utilities/union_type_lookup.py`) and each candidate model
...
```python
from teslafleetmanagementapi.models.animal import Cat, Dog
...
```python
from teslafleetmanagementapi.models.animal import Animal, Cat, Dog
