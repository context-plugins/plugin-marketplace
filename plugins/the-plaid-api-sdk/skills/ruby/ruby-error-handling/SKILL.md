...
StandardError
  └── CoreLibrary::ApiException
        └── ThePlaidAPI::APIException          ← base for all HTTP errors
              └── ThePlaidAPI::{OperationError}  ← typed, if generated (in exceptions/)
...
with `.local_error('400', '...message...', ThePlaidAPI::{OperationError})`, and any status without a
