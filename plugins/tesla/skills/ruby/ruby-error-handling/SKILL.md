...
StandardError
  └── CoreLibrary::ApiException
        └── TeslaAPI::APIException          ← base for all HTTP errors
              └── TeslaAPI::{OperationError}  ← typed, if generated (in exceptions/)
...
with `.local_error('400', '...message...', TeslaAPI::{OperationError})`, and any status without a
