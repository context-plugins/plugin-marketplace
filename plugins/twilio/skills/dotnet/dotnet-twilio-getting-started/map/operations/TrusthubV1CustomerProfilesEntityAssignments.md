...
- **HTTP**: `POST /v1/CustomerProfiles/{CustomerProfileSid}/EntityAssignments` (Default12 (trusthub))
...
- **HTTP**: `DELETE /v1/CustomerProfiles/{CustomerProfileSid}/EntityAssignments/{Sid}` (Default12 (trusthub))
...
- **HTTP**: `GET /v1/CustomerProfiles/{CustomerProfileSid}/EntityAssignments/{Sid}` (Default12 (trusthub))
...
- **HTTP**: `GET /v1/CustomerProfiles/{CustomerProfileSid}/EntityAssignments` (Default12 (trusthub))
