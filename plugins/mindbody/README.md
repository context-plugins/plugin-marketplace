...
Integrate and consume the **APIMatic-generated mindbody SDK** (the "APIMATIC v3.0" generic
...
(`dotnet-mindbody-getting-started/sdk-map.md` + `map/`) indexing every operation signature,
model, enum, union, and error type. The **`dotnet-integrate-mindbody`** router skill routes all
C#/.NET SDK work to the single **`dotnet-mindbody-sdk`** agent (.NET-only), which answers
