...
(`dotnet-google-maps-platform-getting-started/sdk-map.md` + `map/`) indexing every operation signature,
model, enum, union, and error type. The **`dotnet-integrate-google-maps-platform`** router skill routes all
C#/.NET SDK work to the single **`dotnet-google-maps-platform-sdk`** agent (.NET-only), which answers
