...
- **HTTP**: `DELETE /merchants/{merchantId}/payoutSettings/{payoutSettingsId}` (Default (balanceplatform-api-test))
...
- **HTTP**: `GET /merchants/{merchantId}/payoutSettings` (Default (balanceplatform-api-test))
...
- **HTTP**: `GET /merchants/{merchantId}/payoutSettings/{payoutSettingsId}` (Default (balanceplatform-api-test))
...
- **HTTP**: `PATCH /merchants/{merchantId}/payoutSettings/{payoutSettingsId}` (Default (balanceplatform-api-test))
...
- **HTTP**: `POST /merchants/{merchantId}/payoutSettings` (Default (balanceplatform-api-test))
