...
> Throughout, `hotelsearchapi` and other `{...}` tokens are placeholders for names you take from your SDK —
...
client := hotelsearchapi.NewClient(
    hotelsearchapi.CreateConfiguration(
        hotelsearchapi.WithBasicAuthCredentials(
            hotelsearchapi.NewBasicAuthCredentials(
...
hotelsearchapi.WithApiKeyCredentials(hotelsearchapi.NewApiKeyCredentials("token", "api-key"))

// custom header scheme (often surfaced as ApiHeaderCredentials):
hotelsearchapi.WithApiHeaderCredentials(hotelsearchapi.NewApiHeaderCredentials("token", "api-key"))
```
...
```go
hotelsearchapi.WithOAuthBearerTokenCredentials(
    hotelsearchapi.NewOAuthBearerTokenCredentials(os.Getenv("{ACCESS_TOKEN_ENV}")),
)
```
...
client := hotelsearchapi.NewClient(
    hotelsearchapi.CreateConfiguration(
        hotelsearchapi.WithOAuthCCGCredentials(
            hotelsearchapi.NewOAuthCCGCredentials(
