...
This repository is the **`context-plugins` marketplace**: a collection of **<!-- BEGIN:PLUGIN_COUNT -->52<!-- END:PLUGIN_COUNT --> plugins**, one per
...
<!-- BEGIN:PLUGIN_COUNT -->52<!-- END:PLUGIN_COUNT --> plugins, listed in [`.claude-plugin/marketplace.json`](.claude-plugin/marketplace.json).
...
| [`postnl`](plugins/postnl/) | Postnl | .NET, TS, Java, PHP, Python, Ruby |
| [`shell-cardmanagement`](plugins/shell-cardmanagement/) | Shell-cardmanagement | .NET, TS, Java, PHP, Python, Ruby |
...
Across the marketplace that's **<!-- BEGIN:LANGUAGE_PACK_COUNT -->261<!-- END:LANGUAGE_PACK_COUNT --> language packs and <!-- BEGIN:SKILL_COUNT -->2,138<!-- END:SKILL_COUNT --> skills**. See
