...
- **HTTP**: `DELETE /companies/{companyId}/webhooks/{webhookId}` (Default (balanceplatform-api-test))
...
- **HTTP**: `GET /companies/{companyId}/webhooks` (Default (balanceplatform-api-test))
...
- **HTTP**: `GET /companies/{companyId}/webhooks/{webhookId}` (Default (balanceplatform-api-test))
...
- **HTTP**: `PATCH /companies/{companyId}/webhooks/{webhookId}` (Default (balanceplatform-api-test))
...
- **HTTP**: `POST /companies/{companyId}/webhooks` (Default (balanceplatform-api-test))
...
- **HTTP**: `POST /companies/{companyId}/webhooks/{webhookId}/generateHmac` (Default (balanceplatform-api-test))
...
- **HTTP**: `POST /companies/{companyId}/webhooks/{webhookId}/test` (Default (balanceplatform-api-test))
