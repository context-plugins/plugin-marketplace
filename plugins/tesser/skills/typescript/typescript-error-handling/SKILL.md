...
> Throughout this skill, `{...}` is a placeholder for a name you take from your SDK (e.g. `{operation}`, `{apiGroup}`, `tesser-api-v-1-lib`) — replace it with the concrete identifier from the source.
