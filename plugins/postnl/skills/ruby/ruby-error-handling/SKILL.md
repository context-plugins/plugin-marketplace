...
StandardError
  └── CoreLibrary::ApiException
        └── Postnl::APIException          ← base for all HTTP errors
              └── Postnl::{OperationError}  ← typed, if generated (in exceptions/)
...
with `.local_error('400', '...message...', Postnl::{OperationError})`, and any status without a
