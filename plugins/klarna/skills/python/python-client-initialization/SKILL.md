...
- `KlarnaClient` — the generated client class (e.g. `MultiauthsampleClient`, `BatesterClient`).
...
`Environment` is an `Enum` subclass in `klarna/configuration.py`. Use the constant for the desired
