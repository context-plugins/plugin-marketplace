...
StandardError
  └── CoreLibrary::ApiException
        └── OpenUVGlobalRealTimeUVIndexForecastAPI::APIException          ← base for all HTTP errors
              └── OpenUVGlobalRealTimeUVIndexForecastAPI::{OperationError}  ← typed, if generated (in exceptions/)
...
with `.local_error('400', '...message...', OpenUVGlobalRealTimeUVIndexForecastAPI::{OperationError})`, and any status without a
