    ...
    networkadminmanagementclient.CreateConfiguration(
        networkadminmanagementclient.WithHttpConfiguration(
            networkadminmanagementclient.CreateHttpConfiguration(
                networkadminmanagementclient.WithTimeout(30),
                networkadminmanagementclient.WithRetryConfiguration(
                    networkadminmanagementclient.CreateRetryConfiguration(
                        networkadminmanagementclient.WithMaxRetryAttempts(3),
                        networkadminmanagementclient.WithBackoffFactor(2),
                    ),
                ),
            ),
        ),
...
```go
rc := networkadminmanagementclient.CreateRetryConfiguration(
    networkadminmanagementclient.WithMaxRetryAttempts(5),
    networkadminmanagementclient.WithRetryInterval(1),
    networkadminmanagementclient.WithBackoffFactor(2),
    networkadminmanagementclient.WithHttpStatusCodesToRetry([]int64{429, 500, 503}),
    networkadminmanagementclient.WithHttpMethodsToRetry([]string{"GET", "PUT"}),
)
```
...
client := networkadminmanagementclient.NewClient(
    networkadminmanagementclient.CreateConfiguration(
        networkadminmanagementclient.WithHttpConfiguration(
            networkadminmanagementclient.CreateHttpConfiguration(
                networkadminmanagementclient.WithTransport(&loggingTransport{inner: http.DefaultTransport}),
            ),
        ),
    ),
)
