...
git clone --branch main https://github.com/context-plugins/the-plaid-api-csharp
dotnet add reference the-plaid-api-csharp/ThePlaidApi.csproj
```
...
```bash
# Linux / macOS:
git clone --depth 1 --branch main https://github.com/context-plugins/the-plaid-api-csharp /tmp/the-plaid-api-dotnet-src
```

```powershell
# Windows (PowerShell):
git clone --depth 1 --branch main https://github.com/context-plugins/the-plaid-api-csharp "$env:TEMP\the-plaid-api-dotnet-src"
```
