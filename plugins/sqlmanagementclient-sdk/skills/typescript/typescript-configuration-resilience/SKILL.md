...
All config below is passed at construction time via the `SqlManagementClientClientConfig` object.

## Base URL / environment override

```typescript
import { SqlManagementClientClient, Environment } from 'sqlmanagementclientlib';
