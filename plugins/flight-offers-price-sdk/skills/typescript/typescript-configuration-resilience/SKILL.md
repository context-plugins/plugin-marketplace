...
All config below is passed at construction time via the `FlightOffersPriceClientConfig` object.

## Base URL / environment override

```typescript
import { FlightOffersPriceClient, Environment } from 'flight-offers-pricelib';
