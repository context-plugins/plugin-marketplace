...
StandardError
  └── CoreLibrary::ApiException
        └── AuthentiqAPI::APIException          ← base for all HTTP errors
              └── AuthentiqAPI::{OperationError}  ← typed, if generated (in exceptions/)
...
with `.local_error('400', '...message...', AuthentiqAPI::{OperationError})`, and any status without a
