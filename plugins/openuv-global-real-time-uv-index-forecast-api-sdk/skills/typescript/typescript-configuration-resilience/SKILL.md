...
All config below is passed at construction time via the `OpenUVGlobalRealTimeUVIndexForecastAPIClientConfig` object.

## Base URL / environment override

```typescript
import { OpenUVGlobalRealTimeUVIndexForecastAPIClient, Environment } from 'openuv-global-real-time-uv-index-forecast-apilib';
