...
- **HTTP**: `DELETE /merchants/{merchantId}/apiCredentials/{apiCredentialId}/allowedOrigins/{originId}` (Default9 (management-test))
...
- **HTTP**: `GET /merchants/{merchantId}/apiCredentials/{apiCredentialId}/allowedOrigins` (Default9 (management-test))
...
- **HTTP**: `GET /merchants/{merchantId}/apiCredentials/{apiCredentialId}/allowedOrigins/{originId}` (Default9 (management-test))
...
- **HTTP**: `POST /merchants/{merchantId}/apiCredentials/{apiCredentialId}/allowedOrigins` (Default9 (management-test))
