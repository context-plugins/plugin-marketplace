...
StandardError
  └── CoreLibrary::ApiException
        └── Klarna::APIException          ← base for all HTTP errors
              └── Klarna::{OperationError}  ← typed, if generated (in exceptions/)
...
with `.local_error('400', '...message...', Klarna::{OperationError})`, and any status without a
