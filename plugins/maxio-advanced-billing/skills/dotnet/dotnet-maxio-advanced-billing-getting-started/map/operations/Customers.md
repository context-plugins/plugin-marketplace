...
- **Error accessors**: `TryGetCustomerErrorResponse(out CustomerErrorResponse)` [422] · `TryGetRawError(out RawError)` [fallback]
...
- **Error accessors**: `TryGetNoContent(out RawError)` [404] · `TryGetCustomerErrorResponse(out CustomerErrorResponse)` [422] · `TryGetRawError(out RawError)` [fallback]
- **No-throw variant**: absent
- **Pagination**: none
