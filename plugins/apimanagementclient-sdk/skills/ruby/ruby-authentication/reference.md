...
Confirm every name against `lib/apimanagementclient/client.rb`, `lib/apimanagementclient/configuration.rb`, the
`lib/apimanagementclient/http/auth/*.rb` files, and `doc/auth/*.md` in the cloned source.
