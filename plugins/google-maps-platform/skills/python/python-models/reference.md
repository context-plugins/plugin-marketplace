...
`googlemapsplatform/models/` and `googlemapsplatform/api_helper.py`.
...
```python
from googlemapsplatform.models.o_auth_token import OAuthToken
...
```python
from googlemapsplatform.models.animal import Cat
