...
- **HTTP**: `DELETE /companies/{companyId}/apiCredentials/{apiCredentialId}/allowedOrigins/{originId}` (Default (balanceplatform-api-test))
...
- **HTTP**: `GET /companies/{companyId}/apiCredentials/{apiCredentialId}/allowedOrigins` (Default (balanceplatform-api-test))
...
- **HTTP**: `GET /companies/{companyId}/apiCredentials/{apiCredentialId}/allowedOrigins/{originId}` (Default (balanceplatform-api-test))
...
- **HTTP**: `POST /companies/{companyId}/apiCredentials/{apiCredentialId}/allowedOrigins` (Default (balanceplatform-api-test))
