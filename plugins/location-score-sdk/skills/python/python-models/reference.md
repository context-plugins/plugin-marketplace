...
`locationscore/models/` and `locationscore/api_helper.py`.
...
```python
from locationscore.models.o_auth_token import OAuthToken
...
```python
from locationscore.models.animal import Cat
