...
All config below is passed at construction time via the `SpotifyWebAPIWithFixesAndImprovementsFromSonalluxClientConfig` object.

## Base URL / environment override

```typescript
import { SpotifyWebAPIWithFixesAndImprovementsFromSonalluxClient, Environment } from 'spotify-web-api-with-fixes-and-improvements-from-sonalluxlib';
