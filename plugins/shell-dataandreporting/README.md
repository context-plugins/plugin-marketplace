# shell-dataandreporting SDK Plugin

Integrate and consume the **APIMatic-generated shell-dataandreporting SDK** (the "APIMATIC v3.0" generic
...
(`dotnet-shell-dataandreporting-getting-started/sdk-map.md` + `map/`) indexing every operation signature,
model, enum, union, and error type. The **`dotnet-integrate-shell-dataandreporting`** router skill routes all
C#/.NET SDK work to the single **`dotnet-shell-dataandreporting-sdk`** agent (.NET-only), which answers
