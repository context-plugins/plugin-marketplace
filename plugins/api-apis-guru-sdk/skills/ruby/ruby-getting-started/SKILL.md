...
| Install | `gem 'api_apis_guru', git: 'https://github.com/context-plugins/api-apis-guru-ruby-013bf4', branch: 'main'` in a Gemfile |
...
```ruby
# In your Gemfile:
gem 'api_apis_guru', git: 'https://github.com/context-plugins/api-apis-guru-ruby-013bf4', branch: 'main'
```
...
```bash
# Linux / macOS:
git clone --depth 1 --branch main https://github.com/context-plugins/api-apis-guru-ruby-013bf4 /tmp/api-apis-guru-ruby-src
```

```powershell
# Windows (PowerShell):
git clone --depth 1 --branch main https://github.com/context-plugins/api-apis-guru-ruby-013bf4 "$env:TEMP\api-apis-guru-ruby-src"
```
