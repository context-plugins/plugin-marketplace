...
StandardError
  └── CoreLibrary::ApiException
        └── FlightCreateOrders::APIException          ← base for all HTTP errors
              └── FlightCreateOrders::{OperationError}  ← typed, if generated (in exceptions/)
...
with `.local_error('400', '...message...', FlightCreateOrders::{OperationError})`, and any status without a
