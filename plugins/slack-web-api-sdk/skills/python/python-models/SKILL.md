...
your SDK source (`slackwebapi/models/`).
...
`UnionTypeLookUp` registry (in `slackwebapi/utilities/union_type_lookup.py`) and each candidate model
...
```python
from slackwebapi.models.animal import Cat, Dog
...
```python
from slackwebapi.models.animal import Animal, Cat, Dog
