...
All config below is passed at construction time via the `TravelRecommendationsAPIClientConfig` object.

## Base URL / environment override

```typescript
import { TravelRecommendationsAPIClient, Environment } from 'travel-recommendations-apilib';
