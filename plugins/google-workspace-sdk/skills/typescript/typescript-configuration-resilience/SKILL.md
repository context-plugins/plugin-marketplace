...
All config below is passed at construction time via the `GoogleWorkspaceClientConfig` object.

## Base URL / environment override

```typescript
import { GoogleWorkspaceClient, Environment } from 'google-workspacelib';
