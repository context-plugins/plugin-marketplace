...
> Throughout this skill, `{...}` is a placeholder for a name you take from your SDK (e.g. `{operation}`, `{apiGroup}`, `spotify-web-api-with-fixes-and-improvements-from-sonalluxlib`) — replace it with the concrete identifier from the source.
