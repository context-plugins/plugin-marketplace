    ...
    staxfattmerchantapi.CreateConfiguration(
        staxfattmerchantapi.WithHttpConfiguration(
            staxfattmerchantapi.CreateHttpConfiguration(
                staxfattmerchantapi.WithTimeout(30),
                staxfattmerchantapi.WithRetryConfiguration(
                    staxfattmerchantapi.CreateRetryConfiguration(
                        staxfattmerchantapi.WithMaxRetryAttempts(3),
                        staxfattmerchantapi.WithBackoffFactor(2),
                    ),
                ),
            ),
        ),
...
```go
rc := staxfattmerchantapi.CreateRetryConfiguration(
    staxfattmerchantapi.WithMaxRetryAttempts(5),
    staxfattmerchantapi.WithRetryInterval(1),
    staxfattmerchantapi.WithBackoffFactor(2),
    staxfattmerchantapi.WithHttpStatusCodesToRetry([]int64{429, 500, 503}),
    staxfattmerchantapi.WithHttpMethodsToRetry([]string{"GET", "PUT"}),
)
```
...
client := staxfattmerchantapi.NewClient(
    staxfattmerchantapi.CreateConfiguration(
        staxfattmerchantapi.WithHttpConfiguration(
            staxfattmerchantapi.CreateHttpConfiguration(
                staxfattmerchantapi.WithTransport(&loggingTransport{inner: http.DefaultTransport}),
            ),
        ),
    ),
)
