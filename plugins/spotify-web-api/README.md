...
Integrate and consume the **APIMatic-generated Spotify Web API SDK** (the "APIMATIC v3.0" generic
...
(`dotnet-spotify-web-api-getting-started/sdk-map.md` + `map/`) indexing every operation signature,
model, enum, union, and error type. The **`dotnet-integrate-spotify-web-api`** router skill routes all
C#/.NET SDK work to the single **`dotnet-spotify-web-api-sdk`** agent (.NET-only), which answers
