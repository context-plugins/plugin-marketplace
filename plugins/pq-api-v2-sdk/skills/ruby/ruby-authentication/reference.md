...
Confirm every name against `lib/pq_api_v2/client.rb`, `lib/pq_api_v2/configuration.rb`, the
`lib/pq_api_v2/http/auth/*.rb` files, and `doc/auth/*.md` in the cloned source.
