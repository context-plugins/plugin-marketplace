...
All config below is passed at construction time via the `ConfigurationAPIClientConfig` object.

## Base URL / environment override

```typescript
import { ConfigurationAPIClient, Environment } from 'configuration-apilib';
