...
```typescript
import { {Union}, {Variant} } from 'spotify-web-api-with-fixes-and-improvements-from-sonalluxlib';
...
```typescript
import { is{Variant} } from 'spotify-web-api-with-fixes-and-improvements-from-sonalluxlib';
...
```typescript
import { {EnumType} } from 'spotify-web-api-with-fixes-and-improvements-from-sonalluxlib';
