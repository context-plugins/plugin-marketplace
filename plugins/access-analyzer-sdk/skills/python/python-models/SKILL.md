...
your SDK source (`accessanalyzer/models/`).
...
```python
from accessanalyzer.api_helper import APIHelper
...
`UnionTypeLookUp` registry (in `accessanalyzer/utilities/union_type_lookup.py`) and each candidate model
...
```python
from accessanalyzer.models.animal import Cat, Dog
...
```python
from accessanalyzer.models.animal import Animal, Cat, Dog
