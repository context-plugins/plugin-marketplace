    ...
    telegrambotapi.CreateConfiguration(
        telegrambotapi.WithHttpConfiguration(
            telegrambotapi.CreateHttpConfiguration(
                telegrambotapi.WithTimeout(30),
                telegrambotapi.WithRetryConfiguration(
                    telegrambotapi.CreateRetryConfiguration(
                        telegrambotapi.WithMaxRetryAttempts(3),
                        telegrambotapi.WithBackoffFactor(2),
                    ),
                ),
            ),
        ),
...
```go
rc := telegrambotapi.CreateRetryConfiguration(
    telegrambotapi.WithMaxRetryAttempts(5),
    telegrambotapi.WithRetryInterval(1),
    telegrambotapi.WithBackoffFactor(2),
    telegrambotapi.WithHttpStatusCodesToRetry([]int64{429, 500, 503}),
    telegrambotapi.WithHttpMethodsToRetry([]string{"GET", "PUT"}),
)
```
...
client := telegrambotapi.NewClient(
    telegrambotapi.CreateConfiguration(
        telegrambotapi.WithHttpConfiguration(
            telegrambotapi.CreateHttpConfiguration(
                telegrambotapi.WithTransport(&loggingTransport{inner: http.DefaultTransport}),
            ),
        ),
    ),
)
