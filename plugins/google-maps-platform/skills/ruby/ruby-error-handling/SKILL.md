...
StandardError
  └── CoreLibrary::ApiException
        └── GoogleMapsPlatform::APIException          ← base for all HTTP errors
              └── GoogleMapsPlatform::{OperationError}  ← typed, if generated (in exceptions/)
...
with `.local_error('400', '...message...', GoogleMapsPlatform::{OperationError})`, and any status without a
