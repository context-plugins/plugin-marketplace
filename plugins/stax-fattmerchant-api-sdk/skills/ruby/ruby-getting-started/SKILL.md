...
| Install | `gem 'stax_fattmerchant_api', git: 'https://github.com/context-plugins/stax-fattmerchant-api-ruby', branch: 'main'` in a Gemfile |
...
```ruby
# In your Gemfile:
gem 'stax_fattmerchant_api', git: 'https://github.com/context-plugins/stax-fattmerchant-api-ruby', branch: 'main'
```
...
```bash
# Linux / macOS:
git clone --depth 1 --branch main https://github.com/context-plugins/stax-fattmerchant-api-ruby /tmp/stax-fattmerchant-api-ruby-src
```

```powershell
# Windows (PowerShell):
git clone --depth 1 --branch main https://github.com/context-plugins/stax-fattmerchant-api-ruby "$env:TEMP\stax-fattmerchant-api-ruby-src"
```
