...
```bash
# Linux / macOS:
git clone --depth 1 --branch main https://github.com/context-plugins/nytimes-csharp-sdk /tmp/nytimes-dotnet-src
```

```powershell
# Windows (PowerShell):
git clone --depth 1 --branch main https://github.com/context-plugins/nytimes-csharp-sdk "$env:TEMP\nytimes-dotnet-src"
```
...
```bash
rm -rf /tmp/nytimes-dotnet-src                               # Linux / macOS
```
```powershell
Remove-Item -Recurse -Force "$env:TEMP\nytimes-dotnet-src"   # Windows
```
