# Telegram Bot API SDK Plugin

Integrate and consume the **APIMatic-generated Telegram Bot API SDK** (the "APIMATIC v3.0" generic
libraries, built on `apimatic-*-core` / `apimatic/*-core-runtime` runtimes) across TypeScript, Java, PHP, Python, Go.
