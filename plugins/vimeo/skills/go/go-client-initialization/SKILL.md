...
- `github.com/context-plugins/vimeo-go-sdk` — the Go import path for the root package; `github.com/context-plugins/vimeo-go-sdk/models` for request/response types.
...
```go
import "github.com/context-plugins/vimeo-go-sdk"
