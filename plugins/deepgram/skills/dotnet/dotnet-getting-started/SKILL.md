...
git clone --branch main https://github.com/context-plugins/deepgram-csharp-sdk
dotnet add reference deepgram-csharp-sdk/RestApi.csproj
```
...
```bash
# Linux / macOS:
git clone --depth 1 --branch main https://github.com/context-plugins/deepgram-csharp-sdk /tmp/deepgram-dotnet-src
```

```powershell
# Windows (PowerShell):
git clone --depth 1 --branch main https://github.com/context-plugins/deepgram-csharp-sdk "$env:TEMP\deepgram-dotnet-src"
```
...
```bash
rm -rf /tmp/deepgram-dotnet-src                               # Linux / macOS
```
```powershell
Remove-Item -Recurse -Force "$env:TEMP\deepgram-dotnet-src"   # Windows
```
