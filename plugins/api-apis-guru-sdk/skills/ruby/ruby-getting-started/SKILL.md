...
| Install | `gem 'api_apis_guru', git: 'https://github.com/context-plugins/api-apis-guru-ruby-ab984a', branch: 'main'` in a Gemfile |
...
```ruby
# In your Gemfile:
gem 'api_apis_guru', git: 'https://github.com/context-plugins/api-apis-guru-ruby-ab984a', branch: 'main'
```
...
```bash
# Linux / macOS:
git clone --depth 1 --branch main https://github.com/context-plugins/api-apis-guru-ruby-ab984a /tmp/api-apis-guru-ruby-src
```

```powershell
# Windows (PowerShell):
git clone --depth 1 --branch main https://github.com/context-plugins/api-apis-guru-ruby-ab984a "$env:TEMP\api-apis-guru-ruby-src"
```
