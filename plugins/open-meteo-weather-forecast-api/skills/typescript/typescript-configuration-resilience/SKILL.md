...
All config below is passed at construction time via the `OpenMeteoWeatherForecastAPIClientConfig` object.

## Base URL / environment override

```typescript
import { OpenMeteoWeatherForecastAPIClient, Environment } from 'open-meteo-weather-forecast-apilib';
