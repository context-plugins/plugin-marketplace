...
1. Open `SpotifyWebAPIWithFixesAndImprovementsFromSonalluxClientConfig` and list its optional credentials properties — this is the **source of truth** for what the SDK accepts.
