...
Confirm every name against `lib/geoapify/client.rb`, `lib/geoapify/configuration.rb`, the
`lib/geoapify/http/auth/*.rb` files, and `doc/auth/*.md` in the cloned source.
