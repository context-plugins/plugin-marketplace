...
your SDK source (`openmeteoweatherforecastapi/models/`).
...
```python
from openmeteoweatherforecastapi.api_helper import APIHelper
...
`UnionTypeLookUp` registry (in `openmeteoweatherforecastapi/utilities/union_type_lookup.py`) and each candidate model
...
```python
from openmeteoweatherforecastapi.models.animal import Cat, Dog
...
```python
from openmeteoweatherforecastapi.models.animal import Animal, Cat, Dog
