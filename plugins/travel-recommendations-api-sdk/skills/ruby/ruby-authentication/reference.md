...
Confirm every name against `lib/travel_recommendations_api/client.rb`, `lib/travel_recommendations_api/configuration.rb`, the
`lib/travel_recommendations_api/http/auth/*.rb` files, and `doc/auth/*.md` in the cloned source.
