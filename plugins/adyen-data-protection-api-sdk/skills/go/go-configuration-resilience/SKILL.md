    ...
    adyendataprotectionapi.CreateConfiguration(
        adyendataprotectionapi.WithHttpConfiguration(
            adyendataprotectionapi.CreateHttpConfiguration(
                adyendataprotectionapi.WithTimeout(30),
                adyendataprotectionapi.WithRetryConfiguration(
                    adyendataprotectionapi.CreateRetryConfiguration(
                        adyendataprotectionapi.WithMaxRetryAttempts(3),
                        adyendataprotectionapi.WithBackoffFactor(2),
                    ),
                ),
            ),
        ),
...
```go
rc := adyendataprotectionapi.CreateRetryConfiguration(
    adyendataprotectionapi.WithMaxRetryAttempts(5),
    adyendataprotectionapi.WithRetryInterval(1),
    adyendataprotectionapi.WithBackoffFactor(2),
    adyendataprotectionapi.WithHttpStatusCodesToRetry([]int64{429, 500, 503}),
    adyendataprotectionapi.WithHttpMethodsToRetry([]string{"GET", "PUT"}),
)
```
...
client := adyendataprotectionapi.NewClient(
    adyendataprotectionapi.CreateConfiguration(
        adyendataprotectionapi.WithHttpConfiguration(
            adyendataprotectionapi.CreateHttpConfiguration(
                adyendataprotectionapi.WithTransport(&loggingTransport{inner: http.DefaultTransport}),
            ),
        ),
    ),
)
