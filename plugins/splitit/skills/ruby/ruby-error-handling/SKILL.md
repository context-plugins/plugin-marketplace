...
StandardError
  └── CoreLibrary::ApiException
        └── Splitit::APIException          ← base for all HTTP errors
              └── Splitit::{OperationError}  ← typed, if generated (in exceptions/)
...
with `.local_error('400', '...message...', Splitit::{OperationError})`, and any status without a
