...
- **HTTP**: `POST /2010-04-01/Accounts/{AccountSid}/IncomingPhoneNumbers/Mobile.json` (Default (api))
...
- **HTTP**: `GET /2010-04-01/Accounts/{AccountSid}/IncomingPhoneNumbers/Mobile.json` (Default (api))
