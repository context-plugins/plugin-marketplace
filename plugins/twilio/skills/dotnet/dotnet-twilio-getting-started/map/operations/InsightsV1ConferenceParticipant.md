...
- **HTTP**: `GET /v1/Conferences/{ConferenceSid}/Participants/{ParticipantSid}` (Default4 (insights))
...
- **HTTP**: `GET /v1/Conferences/{ConferenceSid}/Participants` (Default4 (insights))
