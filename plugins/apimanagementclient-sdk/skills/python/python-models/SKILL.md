...
your SDK source (`apimanagementclient/models/`).
...
```python
from apimanagementclient.api_helper import APIHelper
...
`UnionTypeLookUp` registry (in `apimanagementclient/utilities/union_type_lookup.py`) and each candidate model
...
```python
from apimanagementclient.models.animal import Cat, Dog
...
```python
from apimanagementclient.models.animal import Animal, Cat, Dog
