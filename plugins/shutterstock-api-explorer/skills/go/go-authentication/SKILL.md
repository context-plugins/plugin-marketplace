...
> Throughout, `shutterstockapiexplorer` and other `{...}` tokens are placeholders for names you take from your SDK —
...
client := shutterstockapiexplorer.NewClient(
    shutterstockapiexplorer.CreateConfiguration(
        shutterstockapiexplorer.WithBasicAuthCredentials(
            shutterstockapiexplorer.NewBasicAuthCredentials(
...
shutterstockapiexplorer.WithApiKeyCredentials(shutterstockapiexplorer.NewApiKeyCredentials("token", "api-key"))

// custom header scheme (often surfaced as ApiHeaderCredentials):
shutterstockapiexplorer.WithApiHeaderCredentials(shutterstockapiexplorer.NewApiHeaderCredentials("token", "api-key"))
```
...
```go
shutterstockapiexplorer.WithOAuthBearerTokenCredentials(
    shutterstockapiexplorer.NewOAuthBearerTokenCredentials(os.Getenv("{ACCESS_TOKEN_ENV}")),
)
```
...
client := shutterstockapiexplorer.NewClient(
    shutterstockapiexplorer.CreateConfiguration(
        shutterstockapiexplorer.WithOAuthCCGCredentials(
            shutterstockapiexplorer.NewOAuthCCGCredentials(
