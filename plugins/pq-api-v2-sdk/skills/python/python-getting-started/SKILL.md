...
| Install | `pip install "git+https://github.com/context-plugins/pq-api-v2-python@main"` |
...
```bash
pip install "git+https://github.com/context-plugins/pq-api-v2-python@main"
```
...
```bash
# Linux / macOS:
git clone --depth 1 --branch main https://github.com/context-plugins/pq-api-v2-python /tmp/pq-api-v2-python-src
```

```powershell
# Windows (PowerShell):
git clone --depth 1 --branch main https://github.com/context-plugins/pq-api-v2-python "$env:TEMP\pq-api-v2-python-src"
```
