...
Integrate and consume the **APIMatic-generated PokeApi SDK** (the "APIMATIC v3.0" generic
...
(`dotnet-pokeapi-getting-started/sdk-map.md` + `map/`) indexing every operation signature,
model, enum, union, and error type. The **`dotnet-integrate-pokeapi`** router skill routes all
C#/.NET SDK work to the single **`dotnet-pokeapi-sdk`** agent (.NET-only), which answers
