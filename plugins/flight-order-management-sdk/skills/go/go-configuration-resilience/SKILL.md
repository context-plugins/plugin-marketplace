    ...
    flightordermanagement.CreateConfiguration(
        flightordermanagement.WithHttpConfiguration(
            flightordermanagement.CreateHttpConfiguration(
                flightordermanagement.WithTimeout(30),
                flightordermanagement.WithRetryConfiguration(
                    flightordermanagement.CreateRetryConfiguration(
                        flightordermanagement.WithMaxRetryAttempts(3),
                        flightordermanagement.WithBackoffFactor(2),
                    ),
                ),
            ),
        ),
...
```go
rc := flightordermanagement.CreateRetryConfiguration(
    flightordermanagement.WithMaxRetryAttempts(5),
    flightordermanagement.WithRetryInterval(1),
    flightordermanagement.WithBackoffFactor(2),
    flightordermanagement.WithHttpStatusCodesToRetry([]int64{429, 500, 503}),
    flightordermanagement.WithHttpMethodsToRetry([]string{"GET", "PUT"}),
)
```
...
client := flightordermanagement.NewClient(
    flightordermanagement.CreateConfiguration(
        flightordermanagement.WithHttpConfiguration(
            flightordermanagement.CreateHttpConfiguration(
                flightordermanagement.WithTransport(&loggingTransport{inner: http.DefaultTransport}),
            ),
        ),
    ),
)
