...
### CreatePhoneNumber2
- **HTTP**: `POST /v1/Services/{ServiceSid}/PhoneNumbers` (Default10 (proxy))
...
### DeletePhoneNumber2
- **HTTP**: `DELETE /v1/Services/{ServiceSid}/PhoneNumbers/{Sid}` (Default10 (proxy))
...
### FetchPhoneNumber4
- **HTTP**: `GET /v1/Services/{ServiceSid}/PhoneNumbers/{Sid}` (Default10 (proxy))
...
### ListPhoneNumber2
- **HTTP**: `GET /v1/Services/{ServiceSid}/PhoneNumbers` (Default10 (proxy))
...
### UpdatePhoneNumber
- **HTTP**: `POST /v1/Services/{ServiceSid}/PhoneNumbers/{Sid}` (Default10 (proxy))
