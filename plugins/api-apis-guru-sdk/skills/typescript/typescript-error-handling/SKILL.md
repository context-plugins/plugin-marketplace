...
> Throughout this skill, `{...}` is a placeholder for a name you take from your SDK (e.g. `{operation}`, `{apiGroup}`, `tours-and-activitieslib`) — replace it with the concrete identifier from the source.
