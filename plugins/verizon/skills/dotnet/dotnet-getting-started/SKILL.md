...
description: "Verizon .NET SDK identity and lookup layer (.NET/C# only) you load directly — install, root namespace, environments, auth pattern, and the SDK map (shipped inside the SDK source repo): every operation signature and error case by lookup, plus the source file declaring each model, enum and error type. Load it for every contract fact, never memory; dotnet-integrate-verizon is the workflow that uses it."
---

# Getting started with the Verizon .NET SDK

> **Who this skill is for.** This is the **map layer**: load it to ground every Verizon SDK fact. `dotnet-integrate-verizon` is the workflow that drives it — you collect the contracts for the work in scope into `verizon-plan.md`, implement from that sheet, and come back to the one map page a row cites for any fact the sheet is missing. Every contract fact comes from here, never from memory.
...
| Source repo | https://github.com/context-plugins/verizon-csharp-sdk (branch `main` — the ref this map documents) |
| Root namespace | `Verizon` (the `using` namespace) |
| Client class | `VerizonClient` |
| Options class | `VerizonClientOptions` |
| Auth | **OAuth 2.0** client credentials — set `ThingspaceOauth`<br>**API key** in the `VZ-M2M-Token` header — set `VzM2MToken`<br>**API key** in the `SessionToken` header — set `SessionToken`<br>**OAuth 2.0** client credentials — set `ThingspaceOauth1` |
| Environments | `ServerEnvironment.Production` *(default)* → `HyperPreciseCredentials` `https://thingspace.verizon.com/api/auth/v1`, `ImpServer` `https://imp.thingspace.verizon.com`, `Thingspace` `https://thingspace.verizon.com/api`, `OAuthServer` `https://thingspace.verizon.com/api/ts/v1`, `M2M` `https://thingspace.verizon.com/api/m2m`, `DeviceLocation` `https://thingspace.verizon.com/api/loc/v1`, `SubscriptionServer` `https://thingspace.verizon.com/api/subsc/v1`, `SoftwareManagementV1` `https://thingspace.verizon.com/api/fota/v1`, `SoftwareManagementV2` `https://thingspace.verizon.com/api/fota/v2`, `SoftwareManagementV3` `https://thingspace.verizon.com/api/fota/v3`, `DeviceDiagnostics` `https://thingspace.verizon.com/api/diagnostics/v1`, `CloudConnector` `https://thingspace.verizon.com/api/cc/v1`, `HyperPreciseLocation` `https://thingspace.verizon.com/api/hyper-precise/v1`, `Services` `https://5gedge.verizon.com/api/mec/services`, `QualityOfService` `https://thingspace.verizon.com/api/m2m/v1/devices`<br>`ServerEnvironment.Staging` → `HyperPreciseCredentials` `https://staging.thingspace.verizon.com/api/auth/v1`, `ImpServer` `https://imp-staging.thingspace.verizon.com`, `Thingspace` `https://staging.thingspace.verizon.com/api`, `OAuthServer` `https://staging.thingspace.verizon.com/api/ts/v1`, `M2M` `https://staging.thingspace.verizon.com/api/m2m`, `DeviceLocation` `https://staging.thingspace.verizon.com/api/loc/v1`, `SubscriptionServer` `https://staging.thingspace.verizon.com/api/subsc/v1`, `SoftwareManagementV1` `https://staging.thingspace.verizon.com/api/fota/v1`, `SoftwareManagementV2` `https://staging.thingspace.verizon.com/api/fota/v2`, `SoftwareManagementV3` `https://staging.thingspace.verizon.com/api/fota/v3`, `DeviceDiagnostics` `https://staging.thingspace.verizon.com/api/diagnostics/v1`, `CloudConnector` `https://staging.thingspace.verizon.com/api/cc/v1`, `HyperPreciseLocation` `https://staging.thingspace.verizon.com/api/hyper-precise/v1`, `Services` `https://staging.5gedge.verizon.com/api/mec/services`, `QualityOfService` `https://staging.thingspace.verizon.com/api/m2m/v1/devices`<br>`ServerEnvironment.Dev` → `HyperPreciseCredentials` `https://staging.thingspace.verizon.com/api/auth/v1`, `ImpServer` `https://devmanagement-staging.imp.thingspace.verizon.com`, `Thingspace` `https://devmanagement-staging.thingspace.verizon.com/api`, `OAuthServer` `https://devmanagement-staging.thingspace.verizon.com:80/ts/v1`, `M2M` `https://devmanagement-staging.thingspace.verizon.com:80/m2m`, `DeviceLocation` `https://devmanagement-staging.thingspace.verizon.com:80/loc/v1`, `SubscriptionServer` `https://devmanagement-staging.thingspace.verizon.com:80/subsc/v1`, `SoftwareManagementV1` `https://devmanagement-staging.thingspace.verizon.com:80/fota/v1`, `SoftwareManagementV2` `https://devmanagement-staging.thingspace.verizon.com:80/fota/v2`, `SoftwareManagementV3` `https://devmanagement-staging.thingspace.verizon.com:80/fota/v3`, `DeviceDiagnostics` `https://devmanagement-staging.thingspace.verizon.com:80/diagnostics/v1`, `CloudConnector` `https://devmanagement-staging.thingspace.verizon.com:80/cc/v1`, `HyperPreciseLocation` `https://devmanagement-staging.thingspace.verizon.com:80/hyper-precise/v1`, `Services` `https://devmanagement-staging.5gedge.verizon.com:80/mec/services`, `QualityOfService` `https://devmanagement-staging.thingspace.verizon.com/api/m2m/v1/devices`<br>`ServerEnvironment.Qa` → `HyperPreciseCredentials` `https://thingspace.verizon.com/api/auth/v1`, `ImpServer` `https://tsd-nginx-qa-us-east-1.imp.thingspace.verizon.com`, `Thingspace` `https://tsd-nginx-qa-us-east-1.thingspace.verizon.com/api`, `OAuthServer` `https://tsd-nginx-qa-us-east-1.thingspace.verizon.com/api/ts/v1`, `M2M` `https://tsd-nginx-qa-us-east-1.thingspace.verizon.com/api/m2m`, `DeviceLocation` `https://tsd-nginx-qa-us-east-1.thingspace.verizon.com/api/loc/v1`, `SubscriptionServer` `https://tsd-nginx-qa-us-east-1.thingspace.verizon.com/api/subsc/v1`, `SoftwareManagementV1` `https://tsd-nginx-qa-us-east-1.thingspace.verizon.com/api/fota/v1`, `SoftwareManagementV2` `https://tsd-nginx-qa-us-east-1.thingspace.verizon.com/api/fota/v2`, `SoftwareManagementV3` `https://tsd-nginx-qa-us-east-1.thingspace.verizon.com/api/fota/v3`, `DeviceDiagnostics` `https://tsd-nginx-qa-us-east-1.thingspace.verizon.com/api/diagnostics/v1`, `CloudConnector` `https://tsd-nginx-qa-us-east-1.thingspace.verizon.com/api/cc/v1`, `HyperPreciseLocation` `https://tsd-nginx-qa-us-east-1.thingspace.verizon.com/api/hyper-precise/v1`, `Services` `https://tsd-nginx-qa-us-east-1.5gedge.verizon.com/api/mec/services`, `QualityOfService` `https://tsd-nginx-qa-us-east-1.thingspace.verizon.com/api/m2m/v1/devices`<br>`ServerEnvironment.MockServerForLimitedAvailabilitySeeQuickStart` → `HyperPreciseCredentials` `https://staging.thingspace.verizon.com/api/auth/v1`, `ImpServer` `https://mock-staging.thingspace.verizon.com`, `Thingspace` `https://mock-staging.thingspace.verizon.com/api`, `OAuthServer` `https://mock-staging.thingspace.verizon.com/api/ts/v1`, `M2M` `https://mock-staging.thingspace.verizon.com/api/m2m`, `DeviceLocation` `https://mock-staging.thingspace.verizon.com/api/loc/v1`, `SubscriptionServer` `https://mock-staging.thingspace.verizon.com/api/subsc/v1`, `SoftwareManagementV1` `https://mock-staging.thingspace.verizon.com/api/fota/v1`, `SoftwareManagementV2` `https://mock-staging.thingspace.verizon.com/api/fota/v2`, `SoftwareManagementV3` `https://mock-staging.thingspace.verizon.com/api/fota/v3`, `DeviceDiagnostics` `https://mock-staging.thingspace.verizon.com/api/diagnostics/v1`, `CloudConnector` `https://mock-staging.thingspace.verizon.com/api/cc/v1`, `HyperPreciseLocation` `https://mock-staging.thingspace.verizon.com/api/hyper-precise/v1`, `Services` `https://mock-staging.thingspace.verizon.com/api/mec/services`, `QualityOfService` `https://mock-staging.thingspace.verizon.com/api/m2m/v1/devices` |
| Log environment variable | `VERIZONCLIENT_LOG` |
| Target framework | `netstandard2.0` |

The table above is **orientation, not a copy-paste recipe** — it gives you the names and facts (install, namespaces, the auth *pattern*, the environments), while the actual integration code comes from the companion skills. Load every one the contract sheet's REQUIRED READING names before you start implementing (`dotnet-integrate-verizon` makes that binding); the **Integration workflow** below says which governs which step.

## Namespaces (using-directives)

The SDK splits its public types across **separate child namespaces**. C# does **not** import child namespaces transitively, so `using Verizon.Models;` alone does **not** make enums, union types, or error types visible — you get `CS0103`/`CS0246` ("name/type does not exist") on build. Add a separate `using` for each kind of type you reference:

| Type | Namespace |
| --- | --- |
| `VerizonClient` | `Verizon` |
| `VerizonClientOptions` | `Verizon` |
| `ServerEnvironment` | `Verizon.Servers` |
...
- Collect the contracts for **every** in-scope operation in **one** pass — signatures and error accessors from the map pages, then required fields with wire names and enum values from the declaring files those pages name — into the **contract sheet** in `verizon-plan.md`, then implement from the sheet. Do not re-open a map page or source file per field, and never re-look-up a fact the sheet already carries.
...
The clone lives in `<temp>/verizon-sdk-src/`, **never** in the project repo, and its path never goes into `verizon-plan.md` — the plan must stay portable, and the clone is a session-local reference, not part of the project.
...
- `Servers/`, `VerizonClient.cs`, `ServiceCollectionExtensions.cs` — environments, the client, DI.
...
The generator injects an `Idempotency-Key: Guid.NewGuid()` header on **every non-GET operation** — fresh on every call, invisible to you, and **not** an idempotency key in any meaningful sense: a value that changes per call deduplicates nothing, and Verizon may not document reading that header at all. `dotnet-configuration-resilience` explains why a visible header like this is worse than an absent one.
