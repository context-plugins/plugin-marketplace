...
All config below is passed at construction time via the `SeatmapDisplayClientConfig` object.

## Base URL / environment override

```typescript
import { SeatmapDisplayClient, Environment } from 'seatmap-displaylib';
