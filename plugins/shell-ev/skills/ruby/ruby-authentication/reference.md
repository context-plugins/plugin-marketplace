...
Confirm every name against `lib/shell_ev/client.rb`, `lib/shell_ev/configuration.rb`, the
`lib/shell_ev/http/auth/*.rb` files, and `doc/auth/*.md` in the cloned source.
