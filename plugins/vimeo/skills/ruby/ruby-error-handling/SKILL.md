...
StandardError
  └── CoreLibrary::ApiException
        └── Vimeo::APIException          ← base for all HTTP errors
              └── Vimeo::{OperationError}  ← typed, if generated (in exceptions/)
...
with `.local_error('400', '...message...', Vimeo::{OperationError})`, and any status without a
