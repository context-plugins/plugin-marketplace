...
- `m1-forge-finance-apislib` — the npm package name (the `"name"` in `package.json`, e.g. `multiauth-samplelib`).
...
```ts
import { {Resource}Controller } from 'm1-forge-finance-apislib';
