...
Accessor: `client.TaskrouterV1WorkersRealTimeStatistics` · Source: `Api/TaskrouterV1WorkersRealTimeStatistics.cs` · 1 operations

**Parameter names are literal.** Signatures are generated code verbatim — in named arguments use the exact parameter names shown (the cancellation-token parameter is named `ct`).

### FetchWorkersRealTimeStatistics
- **HTTP**: `GET /v1/Workspaces/{WorkspaceSid}/Workers/RealTimeStatistics` (Default (accounts))
...
- **Returns**: `WorkersRealTimeStatistics`
