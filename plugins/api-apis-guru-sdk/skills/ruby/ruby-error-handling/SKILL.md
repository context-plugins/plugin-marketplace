...
StandardError
  └── CoreLibrary::ApiException
        └── ApiApisGuru::APIException          ← base for all HTTP errors
              └── ApiApisGuru::{OperationError}  ← typed, if generated (in exceptions/)
...
with `.local_error('400', '...message...', ApiApisGuru::{OperationError})`, and any status without a
