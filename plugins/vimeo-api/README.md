...
Integrate and consume the **APIMatic-generated Vimeo API SDK** (the "APIMATIC v3.0" generic
...
(`dotnet-vimeo-api-getting-started/sdk-map.md` + `map/`) indexing every operation signature,
model, enum, union, and error type. The **`dotnet-integrate-vimeo-api`** router skill routes all
C#/.NET SDK work to the single **`dotnet-vimeo-api-sdk`** agent (.NET-only), which answers
