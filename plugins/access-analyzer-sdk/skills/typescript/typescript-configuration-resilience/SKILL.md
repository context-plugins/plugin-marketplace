...
All config below is passed at construction time via the `AccessAnalyzerClientConfig` object.

## Base URL / environment override

```typescript
import { AccessAnalyzerClient, Environment } from 'access-analyzerlib';
