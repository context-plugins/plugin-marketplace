...
> Throughout, `flightpriceanalysisapi` and other `{...}` tokens are placeholders for names you take from your SDK —
...
client := flightpriceanalysisapi.NewClient(
    flightpriceanalysisapi.CreateConfiguration(
        flightpriceanalysisapi.WithBasicAuthCredentials(
            flightpriceanalysisapi.NewBasicAuthCredentials(
...
flightpriceanalysisapi.WithApiKeyCredentials(flightpriceanalysisapi.NewApiKeyCredentials("token", "api-key"))

// custom header scheme (often surfaced as ApiHeaderCredentials):
flightpriceanalysisapi.WithApiHeaderCredentials(flightpriceanalysisapi.NewApiHeaderCredentials("token", "api-key"))
```
...
```go
flightpriceanalysisapi.WithOAuthBearerTokenCredentials(
    flightpriceanalysisapi.NewOAuthBearerTokenCredentials(os.Getenv("{ACCESS_TOKEN_ENV}")),
)
```
...
client := flightpriceanalysisapi.NewClient(
    flightpriceanalysisapi.CreateConfiguration(
        flightpriceanalysisapi.WithOAuthCCGCredentials(
            flightpriceanalysisapi.NewOAuthCCGCredentials(
