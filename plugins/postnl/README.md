...
Integrate and consume the **APIMatic-generated postnl SDK** (the "APIMATIC v3.0" generic
...
(`dotnet-postnl-getting-started/sdk-map.md` + `map/`) indexing every operation signature,
model, enum, union, and error type. The **`dotnet-integrate-postnl`** router skill routes all
C#/.NET SDK work to the single **`dotnet-postnl-sdk`** agent (.NET-only), which answers
