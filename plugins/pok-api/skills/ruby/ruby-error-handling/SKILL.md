...
StandardError
  └── CoreLibrary::ApiException
        └── PokAPI::APIException          ← base for all HTTP errors
              └── PokAPI::{OperationError}  ← typed, if generated (in exceptions/)
...
with `.local_error('400', '...message...', PokAPI::{OperationError})`, and any status without a
