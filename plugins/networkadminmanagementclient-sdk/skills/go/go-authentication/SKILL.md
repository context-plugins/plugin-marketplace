...
> Throughout, `networkadminmanagementclient` and other `{...}` tokens are placeholders for names you take from your SDK —
...
client := networkadminmanagementclient.NewClient(
    networkadminmanagementclient.CreateConfiguration(
        networkadminmanagementclient.WithBasicAuthCredentials(
            networkadminmanagementclient.NewBasicAuthCredentials(
...
networkadminmanagementclient.WithApiKeyCredentials(networkadminmanagementclient.NewApiKeyCredentials("token", "api-key"))

// custom header scheme (often surfaced as ApiHeaderCredentials):
networkadminmanagementclient.WithApiHeaderCredentials(networkadminmanagementclient.NewApiHeaderCredentials("token", "api-key"))
```
...
```go
networkadminmanagementclient.WithOAuthBearerTokenCredentials(
    networkadminmanagementclient.NewOAuthBearerTokenCredentials(os.Getenv("{ACCESS_TOKEN_ENV}")),
)
```
...
client := networkadminmanagementclient.NewClient(
    networkadminmanagementclient.CreateConfiguration(
        networkadminmanagementclient.WithOAuthCCGCredentials(
            networkadminmanagementclient.NewOAuthCCGCredentials(
