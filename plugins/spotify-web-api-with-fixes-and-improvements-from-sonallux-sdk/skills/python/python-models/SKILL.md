...
your SDK source (`spotifywebapiwithfixesandimprovementsfromsonallux/models/`).
...
`UnionTypeLookUp` registry (in `spotifywebapiwithfixesandimprovementsfromsonallux/utilities/union_type_lookup.py`) and each candidate model
...
```python
from spotifywebapiwithfixesandimprovementsfromsonallux.models.animal import Cat, Dog
...
```python
from spotifywebapiwithfixesandimprovementsfromsonallux.models.animal import Animal, Cat, Dog
