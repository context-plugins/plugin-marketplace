...
Accessor: `client.InsightsV1CallSummariesApi` · Source: `Api/InsightsV1CallSummariesApi.cs` · 1 operation
...
| Type | Source |
| --- | --- |
| `CallSummariesEnumProcessingStateRequest` | `Models/Enums/CallSummariesEnumProcessingStateRequest.cs` |
| `CallSummariesEnumSortBy` | `Models/Enums/CallSummariesEnumSortBy.cs` |
| `CallSummariesEnumAnsweredBy` | `Models/Enums/CallSummariesEnumAnsweredBy.cs` |
| `ListCallSummariesResponse` | `Models/ListCallSummariesResponse.cs` |
