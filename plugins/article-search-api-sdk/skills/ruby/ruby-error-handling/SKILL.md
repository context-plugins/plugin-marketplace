...
StandardError
  └── CoreLibrary::ApiException
        └── ArticleSearchAPI::APIException          ← base for all HTTP errors
              └── ArticleSearchAPI::{OperationError}  ← typed, if generated (in exceptions/)
...
with `.local_error('400', '...message...', ArticleSearchAPI::{OperationError})`, and any status without a
