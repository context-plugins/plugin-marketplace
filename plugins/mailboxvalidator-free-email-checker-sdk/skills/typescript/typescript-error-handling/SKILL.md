...
> Throughout this skill, `{...}` is a placeholder for a name you take from your SDK (e.g. `{operation}`, `{apiGroup}`, `mailboxvalidator-free-email-checkerlib`) — replace it with the concrete identifier from the source.
