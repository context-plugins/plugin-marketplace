...
This repository is the **`context-plugins` marketplace**: a collection of **<!-- BEGIN:PLUGIN_COUNT -->46<!-- END:PLUGIN_COUNT --> plugins**, one per
...
<!-- BEGIN:PLUGIN_COUNT -->46<!-- END:PLUGIN_COUNT --> plugins, listed in [`.claude-plugin/marketplace.json`](.claude-plugin/marketplace.json).
...
Across the marketplace that's **<!-- BEGIN:LANGUAGE_PACK_COUNT -->243<!-- END:LANGUAGE_PACK_COUNT --> language packs and <!-- BEGIN:SKILL_COUNT -->1,990<!-- END:SKILL_COUNT --> skills**. See
