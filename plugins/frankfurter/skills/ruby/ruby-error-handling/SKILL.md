...
StandardError
  └── CoreLibrary::ApiException
        └── Frankfurter::APIException          ← base for all HTTP errors
              └── Frankfurter::{OperationError}  ← typed, if generated (in exceptions/)
...
with `.local_error('400', '...message...', Frankfurter::{OperationError})`, and any status without a
