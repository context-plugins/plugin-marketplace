...
Across the marketplace that's **<!-- BEGIN:LANGUAGE_PACK_COUNT -->201<!-- END:LANGUAGE_PACK_COUNT --> language packs and <!-- BEGIN:SKILL_COUNT -->1,647<!-- END:SKILL_COUNT --> skills**. See
