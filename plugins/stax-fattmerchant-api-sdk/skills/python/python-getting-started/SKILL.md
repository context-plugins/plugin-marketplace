...
| Install | `pip install "git+https://github.com/context-plugins/stax-fattmerchant-api-python@main"` |
...
```bash
pip install "git+https://github.com/context-plugins/stax-fattmerchant-api-python@main"
```
...
```bash
# Linux / macOS:
git clone --depth 1 --branch main https://github.com/context-plugins/stax-fattmerchant-api-python /tmp/stax-fattmerchant-api-python-src
```

```powershell
# Windows (PowerShell):
git clone --depth 1 --branch main https://github.com/context-plugins/stax-fattmerchant-api-python "$env:TEMP\stax-fattmerchant-api-python-src"
```
