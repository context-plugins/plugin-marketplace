...
- **Error accessors**: `TryGetProformaBadRequestErrorResponse(out ProformaBadRequestErrorResponse)` [400] · `TryGetErrorArrayMapResponse(out ErrorArrayMapResponse)` [422] · `TryGetRawError(out RawError)` [fallback]
- **No-throw variant**: absent
- **Pagination**: none
