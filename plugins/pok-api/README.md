...
Integrate and consume the **APIMatic-generated PokéAPI SDK** (the "APIMATIC v3.0" generic
libraries, built on `apimatic-*-core` / `apimatic/*-core-runtime` runtimes) across C#/.NET, TypeScript, Java, Python, Ruby, Go.
