...
`testing` + `testify/require` for reference; substitute the real `hotelsearchapi` and names.
...
import (
    ...
    "github.com/context-plugins/hotel-search-api-go"   // root package hotelsearchapi
)
...
func clientReturning(status int, body string) (hotelsearchapi.ClientInterface, *stubTransport) {
    ...
    client := hotelsearchapi.NewClient(
        hotelsearchapi.CreateConfiguration(
            hotelsearchapi.WithHttpConfiguration(
                hotelsearchapi.CreateHttpConfiguration(hotelsearchapi.WithTransport(stub)),
            ),
...
```go
import sdkerrors "github.com/context-plugins/hotel-search-api-go/errors"
...
client := hotelsearchapi.NewClient(
    hotelsearchapi.CreateConfiguration(
        hotelsearchapi.WithHttpConfiguration(
            hotelsearchapi.CreateHttpConfiguration(hotelsearchapi.WithTransport(redirectTransport{host: target.Host})),
        ),
    ),
)
```
