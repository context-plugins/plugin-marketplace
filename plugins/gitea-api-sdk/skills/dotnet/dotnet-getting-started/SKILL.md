...
git clone --branch main https://github.com/context-plugins/gitea-api-csharp
dotnet add reference gitea-api-csharp/GiteaApi.csproj
```
...
```bash
# Linux / macOS:
git clone --depth 1 --branch main https://github.com/context-plugins/gitea-api-csharp /tmp/gitea-api-dotnet-src
```

```powershell
# Windows (PowerShell):
git clone --depth 1 --branch main https://github.com/context-plugins/gitea-api-csharp "$env:TEMP\gitea-api-dotnet-src"
```
