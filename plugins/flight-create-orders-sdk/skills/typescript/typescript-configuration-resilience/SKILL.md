...
All config below is passed at construction time via the `FlightCreateOrdersClientConfig` object.

## Base URL / environment override

```typescript
import { FlightCreateOrdersClient, Environment } from 'flight-create-orderslib';
