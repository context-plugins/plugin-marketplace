    ...
    awsmigrationhub.CreateConfiguration(
        awsmigrationhub.WithHttpConfiguration(
            awsmigrationhub.CreateHttpConfiguration(
                awsmigrationhub.WithTimeout(30),
                awsmigrationhub.WithRetryConfiguration(
                    awsmigrationhub.CreateRetryConfiguration(
                        awsmigrationhub.WithMaxRetryAttempts(3),
                        awsmigrationhub.WithBackoffFactor(2),
                    ),
                ),
            ),
        ),
...
```go
rc := awsmigrationhub.CreateRetryConfiguration(
    awsmigrationhub.WithMaxRetryAttempts(5),
    awsmigrationhub.WithRetryInterval(1),
    awsmigrationhub.WithBackoffFactor(2),
    awsmigrationhub.WithHttpStatusCodesToRetry([]int64{429, 500, 503}),
    awsmigrationhub.WithHttpMethodsToRetry([]string{"GET", "PUT"}),
)
```
...
client := awsmigrationhub.NewClient(
    awsmigrationhub.CreateConfiguration(
        awsmigrationhub.WithHttpConfiguration(
            awsmigrationhub.CreateHttpConfiguration(
                awsmigrationhub.WithTransport(&loggingTransport{inner: http.DefaultTransport}),
            ),
        ),
    ),
)
