...
All config below is passed at construction time via the `NetworkAdminManagementClientClientConfig` object.

## Base URL / environment override

```typescript
import { NetworkAdminManagementClientClient, Environment } from 'networkadminmanagementclientlib';
