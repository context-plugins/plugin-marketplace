...
│   └── com.m1forge.exceptions.ApiException          ← base for all non-2xx API responses
│       └── com.m1forge.exceptions.{Name}Exception   ← typed subclass with payload fields
...
`getHttpContext()` returns the SDK's `com.m1forge.http.client.HttpContext`, which carries:
