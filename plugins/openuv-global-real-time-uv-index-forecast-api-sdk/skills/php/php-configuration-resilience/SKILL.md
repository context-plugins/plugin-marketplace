...
```php
$client = new OpenUVGlobalRealTimeUVIndexForecastAPIClient([
    'environment' => OpenUVGlobalRealTimeUVIndexForecastAPIClient::ENVIRONMENT_PRODUCTION,  // picks server template
...
$client = new OpenUVGlobalRealTimeUVIndexForecastAPIClient(['httpClient' => $httpClient, /* ...auth */]);
