    ...
    mediumapi.CreateConfiguration(
        mediumapi.WithHttpConfiguration(
            mediumapi.CreateHttpConfiguration(
                mediumapi.WithTimeout(30),
                mediumapi.WithRetryConfiguration(
                    mediumapi.CreateRetryConfiguration(
                        mediumapi.WithMaxRetryAttempts(3),
                        mediumapi.WithBackoffFactor(2),
                    ),
                ),
            ),
        ),
...
```go
rc := mediumapi.CreateRetryConfiguration(
    mediumapi.WithMaxRetryAttempts(5),
    mediumapi.WithRetryInterval(1),
    mediumapi.WithBackoffFactor(2),
    mediumapi.WithHttpStatusCodesToRetry([]int64{429, 500, 503}),
    mediumapi.WithHttpMethodsToRetry([]string{"GET", "PUT"}),
)
```
...
client := mediumapi.NewClient(
    mediumapi.CreateConfiguration(
        mediumapi.WithHttpConfiguration(
            mediumapi.CreateHttpConfiguration(
                mediumapi.WithTransport(&loggingTransport{inner: http.DefaultTransport}),
            ),
        ),
    ),
)
