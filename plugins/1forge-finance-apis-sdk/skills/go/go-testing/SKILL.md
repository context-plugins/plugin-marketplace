...
`testing` + `testify/require` for reference; substitute the real `1forgefinanceapis` and names.
...
import (
    ...
    "github.com/context-plugins/1forge-finance-apis-go"   // root package 1forgefinanceapis
)
...
func clientReturning(status int, body string) (1forgefinanceapis.ClientInterface, *stubTransport) {
    ...
    client := 1forgefinanceapis.NewClient(
        1forgefinanceapis.CreateConfiguration(
            1forgefinanceapis.WithHttpConfiguration(
                1forgefinanceapis.CreateHttpConfiguration(1forgefinanceapis.WithTransport(stub)),
            ),
...
```go
import sdkerrors "github.com/context-plugins/1forge-finance-apis-go/errors"
...
client := 1forgefinanceapis.NewClient(
    1forgefinanceapis.CreateConfiguration(
        1forgefinanceapis.WithHttpConfiguration(
            1forgefinanceapis.CreateHttpConfiguration(1forgefinanceapis.WithTransport(redirectTransport{host: target.Host})),
        ),
    ),
)
```
