...
your SDK source (`ipgeolocationapi/models/`).
...
```python
from ipgeolocationapi.api_helper import APIHelper
...
`UnionTypeLookUp` registry (in `ipgeolocationapi/utilities/union_type_lookup.py`) and each candidate model
...
```python
from ipgeolocationapi.models.animal import Cat, Dog
...
```python
from ipgeolocationapi.models.animal import Animal, Cat, Dog
