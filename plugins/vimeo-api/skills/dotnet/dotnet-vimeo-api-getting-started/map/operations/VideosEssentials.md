...
- **Signature**: `CopyVideo(double userId, double videoId, RequestOptions? requestOptions = null, CancellationToken ct = default)`
  - defaults: `requestOptions` = null
- **Returns**: `void` (Task)
...
- **Notes**: This method creates a copy of the specified video. Only the source's current version is copied; prior version history is not carried over.
- **Signature**: `CopyVideoAlt2(double videoId, RequestOptions? requestOptions = null, CancellationToken ct = default)`
  - defaults: `requestOptions` = null
- **Returns**: `void` (Task)
...
- **Signature**: `EditVideo(double videoId, RequestOptions? requestOptions = null, CancellationToken ct = default)`
  - defaults: `requestOptions` = null
- **Returns**: `void` (Task)
...
- **Error accessors**: `TryGetNoContent(out RawError)` [400, 404, 503] · `TryGetRawError(out RawError)` [fallback]
- **No-throw variant**: absent
- **Pagination**: manual `page`+`perPage`
