# greenbyte SDK Plugin

Integrate and consume the **APIMatic-generated greenbyte SDK** (the "APIMATIC v3.0" generic
...
(`dotnet-greenbyte-getting-started/sdk-map.md` + `map/`) indexing every operation signature,
model, enum, union, and error type. The **`dotnet-integrate-greenbyte`** router skill routes all
C#/.NET SDK work to the single **`dotnet-greenbyte-sdk`** agent (.NET-only), which answers
