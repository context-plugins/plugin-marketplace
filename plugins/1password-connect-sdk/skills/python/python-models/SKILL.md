...
your SDK source (`1passwordconnect/models/`).
...
```python
from 1passwordconnect.api_helper import APIHelper
...
`UnionTypeLookUp` registry (in `1passwordconnect/utilities/union_type_lookup.py`) and each candidate model
...
```python
from 1passwordconnect.models.animal import Cat, Dog
...
```python
from 1passwordconnect.models.animal import Animal, Cat, Dog
