...
StandardError
  └── CoreLibrary::ApiException
        └── Akoya::APIException          ← base for all HTTP errors
              └── Akoya::{OperationError}  ← typed, if generated (in exceptions/)
...
with `.local_error('400', '...message...', Akoya::{OperationError})`, and any status without a
