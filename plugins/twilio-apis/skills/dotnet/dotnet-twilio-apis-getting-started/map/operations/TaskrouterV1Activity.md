...
### CreateActivity
- **HTTP**: `POST /v1/Workspaces/{WorkspaceSid}/Activities` (Default (accounts))
- **Signature**: `CreateActivity(string workspaceSid, ContentType contentType, string friendlyName, bool? available, RequestOptions? requestOptions = null, CancellationToken ct = default)`
...
### DeleteActivity
- **HTTP**: `DELETE /v1/Workspaces/{WorkspaceSid}/Activities/{Sid}` (Default (accounts))
...
### FetchActivity
- **HTTP**: `GET /v1/Workspaces/{WorkspaceSid}/Activities/{Sid}` (Default (accounts))
...
### ListActivity
- **HTTP**: `GET /v1/Workspaces/{WorkspaceSid}/Activities` (Default (accounts))
...
### UpdateActivity
- **HTTP**: `POST /v1/Workspaces/{WorkspaceSid}/Activities/{Sid}` (Default (accounts))
- **Signature**: `UpdateActivity(string workspaceSid, string sid, ContentType contentType, string? friendlyName, RequestOptions? requestOptions = null, CancellationToken ct = default)`
