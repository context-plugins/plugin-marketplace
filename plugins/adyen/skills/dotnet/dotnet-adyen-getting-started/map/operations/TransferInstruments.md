...
- **HTTP**: `DELETE /transferInstruments/{id}` (Default18 (kyc-test))
...
- **HTTP**: `GET /transferInstruments/{id}` (Default18 (kyc-test))
...
- **HTTP**: `PATCH /transferInstruments/{id}` (Default18 (kyc-test))
...
- **HTTP**: `POST /transferInstruments` (Default18 (kyc-test))
