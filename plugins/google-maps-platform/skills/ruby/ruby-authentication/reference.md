...
Confirm every name against `lib/google_maps_platform/client.rb`, `lib/google_maps_platform/configuration.rb`, the
`lib/google_maps_platform/http/auth/*.rb` files, and `doc/auth/*.md` in the cloned source.
