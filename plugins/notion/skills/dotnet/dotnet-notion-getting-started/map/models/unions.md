...
| Union | Variants | Factories | TryGet accessors | Implicit from | Source |
|---|---|---|---|---|---|
| `Icon` | Emoji, FileModel | `Icon.Emoji(Emoji)`, `Icon.FileModel(FileModel)` | `TryGetEmoji(out …)`, `TryGetFileModel(out …)` | `Emoji`, `FileModel` | `Models/AnyOf/Icon.cs` |
...
| `Icon3` | Emoji, FileModel | `Icon3.Emoji(Emoji)`, `Icon3.FileModel(FileModel)` | `TryGetEmoji(out …)`, `TryGetFileModel(out …)` | `Emoji`, `FileModel` | `Models/AnyOf/Icon3.cs` |
