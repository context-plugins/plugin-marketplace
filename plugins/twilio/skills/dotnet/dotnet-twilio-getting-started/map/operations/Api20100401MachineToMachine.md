...
Accessor: `client.Api20100401MachineToMachine` · Source: `Api/Api20100401MachineToMachine.cs` · 1 operations

**Parameter names are literal.** Signatures are generated code verbatim — in named arguments use the exact parameter names shown (the cancellation-token parameter is named `ct`).

### ListAvailablePhoneNumberMachineToMachine
- **HTTP**: `GET /2010-04-01/Accounts/{AccountSid}/AvailablePhoneNumbers/{CountryCode}/MachineToMachine.json` (Default (api))
