...
Confirm every name against `lib/tesla_fleet_management_api/client.rb`, `lib/tesla_fleet_management_api/configuration.rb`, the
`lib/tesla_fleet_management_api/http/auth/*.rb` files, and `doc/auth/*.md` in the cloned source.
