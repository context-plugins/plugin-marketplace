...
```typescript
import { {Union}, {Variant} } from 'openuv-global-real-time-uv-index-forecast-apilib';
...
```typescript
import { is{Variant} } from 'openuv-global-real-time-uv-index-forecast-apilib';
...
```typescript
import { {EnumType} } from 'openuv-global-real-time-uv-index-forecast-apilib';
