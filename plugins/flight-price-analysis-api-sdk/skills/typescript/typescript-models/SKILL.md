...
```typescript
import { {Union}, {Variant} } from 'flight-price-analysis-apilib';
...
```typescript
import { is{Variant} } from 'flight-price-analysis-apilib';
...
```typescript
import { {EnumType} } from 'flight-price-analysis-apilib';
