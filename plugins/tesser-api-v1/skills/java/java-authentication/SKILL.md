...
To see which schemes a specific SDK accepts, read the credential setter methods on `TesserApiV1Client.Builder`
...
- Set credentials **on the `TesserApiV1Client.Builder`** before calling `.build()` — the client is immutable
