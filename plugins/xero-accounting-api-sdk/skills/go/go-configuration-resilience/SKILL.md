    ...
    xeroaccountingapi.CreateConfiguration(
        xeroaccountingapi.WithHttpConfiguration(
            xeroaccountingapi.CreateHttpConfiguration(
                xeroaccountingapi.WithTimeout(30),
                xeroaccountingapi.WithRetryConfiguration(
                    xeroaccountingapi.CreateRetryConfiguration(
                        xeroaccountingapi.WithMaxRetryAttempts(3),
                        xeroaccountingapi.WithBackoffFactor(2),
                    ),
                ),
            ),
        ),
...
```go
rc := xeroaccountingapi.CreateRetryConfiguration(
    xeroaccountingapi.WithMaxRetryAttempts(5),
    xeroaccountingapi.WithRetryInterval(1),
    xeroaccountingapi.WithBackoffFactor(2),
    xeroaccountingapi.WithHttpStatusCodesToRetry([]int64{429, 500, 503}),
    xeroaccountingapi.WithHttpMethodsToRetry([]string{"GET", "PUT"}),
)
```
...
client := xeroaccountingapi.NewClient(
    xeroaccountingapi.CreateConfiguration(
        xeroaccountingapi.WithHttpConfiguration(
            xeroaccountingapi.CreateHttpConfiguration(
                xeroaccountingapi.WithTransport(&loggingTransport{inner: http.DefaultTransport}),
            ),
        ),
    ),
)
