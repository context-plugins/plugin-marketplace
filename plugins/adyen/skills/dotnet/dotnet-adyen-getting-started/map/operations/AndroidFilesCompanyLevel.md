...
- **HTTP**: `GET /companies/{companyId}/androidApps` (Default9 (management-test))
...
- **HTTP**: `GET /companies/{companyId}/androidApps/{id}` (Default9 (management-test))
...
- **HTTP**: `GET /companies/{companyId}/androidCertificates` (Default9 (management-test))
...
- **HTTP**: `PATCH /companies/{companyId}/androidApps/{id}` (Default9 (management-test))
...
- **HTTP**: `POST /companies/{companyId}/androidApps` (Default9 (management-test))
...
- **HTTP**: `POST /companies/{companyId}/androidCertificates` (Default9 (management-test))
