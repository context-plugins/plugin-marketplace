...
StandardError
  └── CoreLibrary::ApiException
        └── NetworkAdminManagementClient::APIException          ← base for all HTTP errors
              └── NetworkAdminManagementClient::{OperationError}  ← typed, if generated (in exceptions/)
...
with `.local_error('400', '...message...', NetworkAdminManagementClient::{OperationError})`, and any status without a
