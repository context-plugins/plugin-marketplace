...
### CreatePortingPortIn
- **HTTP**: `POST /v1/Porting/PortIn` (Default7 (numbers))
...
### DeletePortingPortIn
- **HTTP**: `DELETE /v1/Porting/PortIn/{PortInRequestSid}` (Default7 (numbers))
...
### FetchPortingPortIn
- **HTTP**: `GET /v1/Porting/PortIn/{PortInRequestSid}` (Default7 (numbers))
...
### ListPortInRequests
- **HTTP**: `GET /v1/Porting/PortIn/PortInRequests` (Default7 (numbers))
