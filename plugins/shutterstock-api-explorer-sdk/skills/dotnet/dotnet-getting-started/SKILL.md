...
git clone --branch main https://github.com/context-plugins/shutterstock-api-explorer-csharp
dotnet add reference shutterstock-api-explorer-csharp/ShutterstockApiExplorer.csproj
```
...
```bash
# Linux / macOS:
git clone --depth 1 --branch main https://github.com/context-plugins/shutterstock-api-explorer-csharp /tmp/shutterstock-api-explorer-dotnet-src
```

```powershell
# Windows (PowerShell):
git clone --depth 1 --branch main https://github.com/context-plugins/shutterstock-api-explorer-csharp "$env:TEMP\shutterstock-api-explorer-dotnet-src"
```
