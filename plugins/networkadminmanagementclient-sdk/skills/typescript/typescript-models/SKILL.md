...
```typescript
import { {Union}, {Variant} } from 'networkadminmanagementclientlib';
...
```typescript
import { is{Variant} } from 'networkadminmanagementclientlib';
...
```typescript
import { {EnumType} } from 'networkadminmanagementclientlib';
