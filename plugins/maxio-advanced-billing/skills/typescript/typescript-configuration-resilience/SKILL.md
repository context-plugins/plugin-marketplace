...
All config below is passed at construction time via the `MaxioAdvancedBillingClientConfig` object.

## Base URL / environment override

```typescript
import { MaxioAdvancedBillingClient, Environment } from 'maxio-advanced-billinglib';
