...
your SDK source (`hotelnameautocomplete/models/`).
...
```python
from hotelnameautocomplete.api_helper import APIHelper
...
`UnionTypeLookUp` registry (in `hotelnameautocomplete/utilities/union_type_lookup.py`) and each candidate model
...
```python
from hotelnameautocomplete.models.animal import Cat, Dog
...
```python
from hotelnameautocomplete.models.animal import Animal, Cat, Dog
