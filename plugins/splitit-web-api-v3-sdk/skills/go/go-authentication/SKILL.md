...
> Throughout, `splititwebapiv3` and other `{...}` tokens are placeholders for names you take from your SDK —
...
client := splititwebapiv3.NewClient(
    splititwebapiv3.CreateConfiguration(
        splititwebapiv3.WithBasicAuthCredentials(
            splititwebapiv3.NewBasicAuthCredentials(
...
splititwebapiv3.WithApiKeyCredentials(splititwebapiv3.NewApiKeyCredentials("token", "api-key"))

// custom header scheme (often surfaced as ApiHeaderCredentials):
splititwebapiv3.WithApiHeaderCredentials(splititwebapiv3.NewApiHeaderCredentials("token", "api-key"))
```
...
```go
splititwebapiv3.WithOAuthBearerTokenCredentials(
    splititwebapiv3.NewOAuthBearerTokenCredentials(os.Getenv("{ACCESS_TOKEN_ENV}")),
)
```
...
client := splititwebapiv3.NewClient(
    splititwebapiv3.CreateConfiguration(
        splititwebapiv3.WithOAuthCCGCredentials(
            splititwebapiv3.NewOAuthCCGCredentials(
