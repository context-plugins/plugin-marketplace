...
StandardError
  └── CoreLibrary::ApiException
        └── Newstore::APIException          ← base for all HTTP errors
              └── Newstore::{OperationError}  ← typed, if generated (in exceptions/)
...
with `.local_error('400', '...message...', Newstore::{OperationError})`, and any status without a
