# shell-cardmanagement SDK Plugin

Integrate and consume the **APIMatic-generated shell-cardmanagement SDK** (the "APIMATIC v3.0" generic
...
(`dotnet-shell-cardmanagement-getting-started/sdk-map.md` + `map/`) indexing every operation signature,
model, enum, union, and error type. The **`dotnet-integrate-shell-cardmanagement`** router skill routes all
C#/.NET SDK work to the single **`dotnet-shell-cardmanagement-sdk`** agent (.NET-only), which answers
