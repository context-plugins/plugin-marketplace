...
Integrate and consume the **APIMatic-generated GOE SDK** (the "APIMATIC v3.0" generic
...
(`dotnet-goe-getting-started/sdk-map.md` + `map/`) indexing every operation signature,
model, enum, union, and error type. The **`dotnet-integrate-goe`** router skill routes all
C#/.NET SDK work to the single **`dotnet-goe-sdk`** agent (.NET-only), which answers
