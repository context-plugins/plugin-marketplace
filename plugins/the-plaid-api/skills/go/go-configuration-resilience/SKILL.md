    ...
    theplaidapi.CreateConfiguration(
        theplaidapi.WithHttpConfiguration(
            theplaidapi.CreateHttpConfiguration(
                theplaidapi.WithTimeout(30),
                theplaidapi.WithRetryConfiguration(
                    theplaidapi.CreateRetryConfiguration(
                        theplaidapi.WithMaxRetryAttempts(3),
                        theplaidapi.WithBackoffFactor(2),
                    ),
                ),
            ),
        ),
...
```go
rc := theplaidapi.CreateRetryConfiguration(
    theplaidapi.WithMaxRetryAttempts(5),
    theplaidapi.WithRetryInterval(1),
    theplaidapi.WithBackoffFactor(2),
    theplaidapi.WithHttpStatusCodesToRetry([]int64{429, 500, 503}),
    theplaidapi.WithHttpMethodsToRetry([]string{"GET", "PUT"}),
)
```
...
client := theplaidapi.NewClient(
    theplaidapi.CreateConfiguration(
        theplaidapi.WithHttpConfiguration(
            theplaidapi.CreateHttpConfiguration(
                theplaidapi.WithTransport(&loggingTransport{inner: http.DefaultTransport}),
            ),
        ),
    ),
)
