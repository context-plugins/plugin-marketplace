...
All config below is passed at construction time via the `StaxFattMerchantAPIClientConfig` object.

## Base URL / environment override

```typescript
import { StaxFattMerchantAPIClient, Environment } from 'stax-fattmerchant-apilib';
