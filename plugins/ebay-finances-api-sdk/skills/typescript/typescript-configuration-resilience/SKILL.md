...
All config below is passed at construction time via the `EBayFinancesAPIClientConfig` object.

## Base URL / environment override

```typescript
import { EBayFinancesAPIClient, Environment } from 'ebay-finances-apilib';
