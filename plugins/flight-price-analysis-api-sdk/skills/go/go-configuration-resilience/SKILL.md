    ...
    flightpriceanalysisapi.CreateConfiguration(
        flightpriceanalysisapi.WithHttpConfiguration(
            flightpriceanalysisapi.CreateHttpConfiguration(
                flightpriceanalysisapi.WithTimeout(30),
                flightpriceanalysisapi.WithRetryConfiguration(
                    flightpriceanalysisapi.CreateRetryConfiguration(
                        flightpriceanalysisapi.WithMaxRetryAttempts(3),
                        flightpriceanalysisapi.WithBackoffFactor(2),
                    ),
                ),
            ),
        ),
...
```go
rc := flightpriceanalysisapi.CreateRetryConfiguration(
    flightpriceanalysisapi.WithMaxRetryAttempts(5),
    flightpriceanalysisapi.WithRetryInterval(1),
    flightpriceanalysisapi.WithBackoffFactor(2),
    flightpriceanalysisapi.WithHttpStatusCodesToRetry([]int64{429, 500, 503}),
    flightpriceanalysisapi.WithHttpMethodsToRetry([]string{"GET", "PUT"}),
)
```
...
client := flightpriceanalysisapi.NewClient(
    flightpriceanalysisapi.CreateConfiguration(
        flightpriceanalysisapi.WithHttpConfiguration(
            flightpriceanalysisapi.CreateHttpConfiguration(
                flightpriceanalysisapi.WithTransport(&loggingTransport{inner: http.DefaultTransport}),
            ),
        ),
    ),
)
