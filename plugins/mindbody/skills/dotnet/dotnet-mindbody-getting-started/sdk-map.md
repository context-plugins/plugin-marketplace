...
```csharp
using MindbodyPushApiApi;
using MindbodyPushApiApi.Servers; // ServerEnvironment lives here

var options = new MindbodyPushApiApiClientOptions
{
...
var client = new MindbodyPushApiApiClient(httpClient, options); // httpClient: System.Net.Http.HttpClient
```

DI alternative (`ServiceCollectionExtensions.cs`):

```csharp
services.AddMindbodyPushApiApiClient(o =>
{
...
`MindbodyPushApiApiClient.cs`.

<!-- crawler:client-options -->
All `MindbodyPushApiApiClientOptions` properties (source: `MindbodyPushApiApiClientOptions.cs`):
...
- `MindbodyPushApiApiClient(HttpClient httpClient, MindbodyPushApiApiClientOptions options)`
<!-- /crawler:client-options -->
...
Of **15 operations**, **0 are Case A (typed)** and **15 are Case B (raw)**.
<!-- /crawler:op-stats -->

---

## Operations — by controller (5 groups, 15 operations)
...
|---|---:|---|
| `AdminEventType` | 4 | [map/operations/AdminEventType.md](map/operations/AdminEventType.md) |
| `AdminSubscriptions` | 3 | [map/operations/AdminSubscriptions.md](map/operations/AdminSubscriptions.md) |
| `Metrics` | 1 | [map/operations/Metrics.md](map/operations/Metrics.md) |
| `SmokeTest` | 2 | [map/operations/SmokeTest.md](map/operations/SmokeTest.md) |
| `Subscriptions` | 5 | [map/operations/Subscriptions.md](map/operations/Subscriptions.md) |
<!-- /crawler:ops-table -->
...
| Group | Count | Page |
|---|---:|---|
| Records (plain `record` data models) | 24 | [`AdminGetEventTypesRequest` … `Subscription`](map/models/records-1-Ad-Su.md) |
...
|---|---|
| Client & options (root) | `MindbodyPushApiApi` |
| Operation controllers (`Api/`) | `MindbodyPushApiApi.Api` |
| Records (`Models/`) | `MindbodyPushApiApi.Models` |
<!-- /gen:namespaces -->
...
**Auth.** The scheme(s) this API uses surface as credentials properties on `MindbodyPushApiApiClientOptions` (source: `MindbodyPushApiApiClientOptions.cs`) — set them before constructing the client; load `dotnet-authentication` for the wiring:
