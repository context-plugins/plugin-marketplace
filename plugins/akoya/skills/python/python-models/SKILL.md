...
`UnionTypeLookUp` registry (in `akoya/utilities/union_type_lookup.py`) and each candidate model
...
```python
from akoya.models.animal import Cat, Dog
...
```python
from akoya.models.animal import Animal, Cat, Dog
