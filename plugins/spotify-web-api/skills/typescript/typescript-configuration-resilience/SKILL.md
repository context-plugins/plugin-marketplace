...
All config below is passed at construction time via the `SpotifyWebAPIClientConfig` object.

## Base URL / environment override

```typescript
import { SpotifyWebAPIClient, Environment } from 'spotify-web-apilib';
