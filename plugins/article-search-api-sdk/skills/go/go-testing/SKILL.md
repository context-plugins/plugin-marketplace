...
`testing` + `testify/require` for reference; substitute the real `articlesearchapi` and names.
...
import (
    ...
    "github.com/context-plugins/article-search-api-go"   // root package articlesearchapi
)
...
func clientReturning(status int, body string) (articlesearchapi.ClientInterface, *stubTransport) {
    ...
    client := articlesearchapi.NewClient(
        articlesearchapi.CreateConfiguration(
            articlesearchapi.WithHttpConfiguration(
                articlesearchapi.CreateHttpConfiguration(articlesearchapi.WithTransport(stub)),
            ),
...
```go
import sdkerrors "github.com/context-plugins/article-search-api-go/errors"
...
client := articlesearchapi.NewClient(
    articlesearchapi.CreateConfiguration(
        articlesearchapi.WithHttpConfiguration(
            articlesearchapi.CreateHttpConfiguration(articlesearchapi.WithTransport(redirectTransport{host: target.Host})),
        ),
    ),
)
```
