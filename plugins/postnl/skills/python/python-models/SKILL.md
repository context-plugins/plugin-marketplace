...
`UnionTypeLookUp` registry (in `postnl/utilities/union_type_lookup.py`) and each candidate model
...
```python
from postnl.models.animal import Cat, Dog
...
```python
from postnl.models.animal import Animal, Cat, Dog
