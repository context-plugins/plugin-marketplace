...
- `github.com/context-plugins/notion-go` — the Go import path for the root package; `github.com/context-plugins/notion-go/models` for request/response types.
...
```go
import "github.com/context-plugins/notion-go"
