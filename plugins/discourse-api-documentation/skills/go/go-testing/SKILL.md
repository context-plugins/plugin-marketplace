...
`testing` + `testify/require` for reference; substitute the real `discourseapidocumentation` and names.
...
import (
    ...
    "github.com/context-plugins/discourse-api-documentation-go-sdk"   // root package discourseapidocumentation
)
...
func clientReturning(status int, body string) (discourseapidocumentation.ClientInterface, *stubTransport) {
    ...
    client := discourseapidocumentation.NewClient(
        discourseapidocumentation.CreateConfiguration(
            discourseapidocumentation.WithHttpConfiguration(
                discourseapidocumentation.CreateHttpConfiguration(discourseapidocumentation.WithTransport(stub)),
            ),
...
```go
import sdkerrors "github.com/context-plugins/discourse-api-documentation-go-sdk/errors"
...
client := discourseapidocumentation.NewClient(
    discourseapidocumentation.CreateConfiguration(
        discourseapidocumentation.WithHttpConfiguration(
            discourseapidocumentation.CreateHttpConfiguration(discourseapidocumentation.WithTransport(redirectTransport{host: target.Host})),
        ),
    ),
)
```
