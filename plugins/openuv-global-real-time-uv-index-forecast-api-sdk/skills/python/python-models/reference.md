...
`openuvglobalrealtimeuvindexforecastapi/models/` and `openuvglobalrealtimeuvindexforecastapi/api_helper.py`.
...
```python
from openuvglobalrealtimeuvindexforecastapi.models.o_auth_token import OAuthToken
...
```python
from openuvglobalrealtimeuvindexforecastapi.models.animal import Cat
