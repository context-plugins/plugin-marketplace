...
All config below is passed at construction time via the `MailboxValidatorFreeEmailCheckerClientConfig` object.

## Base URL / environment override

```typescript
import { MailboxValidatorFreeEmailCheckerClient, Environment } from 'mailboxvalidator-free-email-checkerlib';
