...
```typescript
import { {Union}, {Variant} } from 'flight-inspiration-searchlib';
...
```typescript
import { is{Variant} } from 'flight-inspiration-searchlib';
...
```typescript
import { {EnumType} } from 'flight-inspiration-searchlib';
