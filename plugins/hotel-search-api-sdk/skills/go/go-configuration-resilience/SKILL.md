    ...
    hotelsearchapi.CreateConfiguration(
        hotelsearchapi.WithHttpConfiguration(
            hotelsearchapi.CreateHttpConfiguration(
                hotelsearchapi.WithTimeout(30),
                hotelsearchapi.WithRetryConfiguration(
                    hotelsearchapi.CreateRetryConfiguration(
                        hotelsearchapi.WithMaxRetryAttempts(3),
                        hotelsearchapi.WithBackoffFactor(2),
                    ),
                ),
            ),
        ),
...
```go
rc := hotelsearchapi.CreateRetryConfiguration(
    hotelsearchapi.WithMaxRetryAttempts(5),
    hotelsearchapi.WithRetryInterval(1),
    hotelsearchapi.WithBackoffFactor(2),
    hotelsearchapi.WithHttpStatusCodesToRetry([]int64{429, 500, 503}),
    hotelsearchapi.WithHttpMethodsToRetry([]string{"GET", "PUT"}),
)
```
...
client := hotelsearchapi.NewClient(
    hotelsearchapi.CreateConfiguration(
        hotelsearchapi.WithHttpConfiguration(
            hotelsearchapi.CreateHttpConfiguration(
                hotelsearchapi.WithTransport(&loggingTransport{inner: http.DefaultTransport}),
            ),
        ),
    ),
)
