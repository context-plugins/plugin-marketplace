...
```php
$client = new TravelRecommendationsAPIClient([
    'environment' => TravelRecommendationsAPIClient::ENVIRONMENT_PRODUCTION,  // picks server template
...
$client = new TravelRecommendationsAPIClient(['httpClient' => $httpClient, /* ...auth */]);
