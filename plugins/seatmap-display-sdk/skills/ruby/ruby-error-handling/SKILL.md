...
StandardError
  └── CoreLibrary::ApiException
        └── SeatmapDisplay::APIException          ← base for all HTTP errors
              └── SeatmapDisplay::{OperationError}  ← typed, if generated (in exceptions/)
...
with `.local_error('400', '...message...', SeatmapDisplay::{OperationError})`, and any status without a
