...
StandardError
  └── CoreLibrary::ApiException
        └── TeslaFleetManagementAPI::APIException          ← base for all HTTP errors
              └── TeslaFleetManagementAPI::{OperationError}  ← typed, if generated (in exceptions/)
...
with `.local_error('400', '...message...', TeslaFleetManagementAPI::{OperationError})`, and any status without a
