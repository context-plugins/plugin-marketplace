...
`UnionTypeLookUp` registry (in `gitea/utilities/union_type_lookup.py`) and each candidate model
...
```python
from gitea.models.animal import Cat, Dog
...
```python
from gitea.models.animal import Animal, Cat, Dog
