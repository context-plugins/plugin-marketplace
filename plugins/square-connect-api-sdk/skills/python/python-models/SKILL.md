...
your SDK source (`squareconnectapi/models/`).
...
```python
from squareconnectapi.api_helper import APIHelper
...
`UnionTypeLookUp` registry (in `squareconnectapi/utilities/union_type_lookup.py`) and each candidate model
...
```python
from squareconnectapi.models.animal import Cat, Dog
...
```python
from squareconnectapi.models.animal import Animal, Cat, Dog
