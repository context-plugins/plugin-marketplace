...
Confirm every name against `lib/subscriptionclient/client.rb`, `lib/subscriptionclient/configuration.rb`, the
`lib/subscriptionclient/http/auth/*.rb` files, and `doc/auth/*.md` in the cloned source.
