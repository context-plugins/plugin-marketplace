...
### GetDisputes
- **HTTP**: `GET /disputes` (Default23 (balanceplatform-api-test))
...
### GetDisputesId
- **HTTP**: `GET /disputes/{id}` (Default23 (balanceplatform-api-test))
...
### PatchDisputesId
- **HTTP**: `PATCH /disputes/{id}` (Default23 (balanceplatform-api-test))
...
### PostDisputes
- **HTTP**: `POST /disputes` (Default23 (balanceplatform-api-test))
