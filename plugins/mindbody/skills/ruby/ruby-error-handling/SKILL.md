...
StandardError
  └── CoreLibrary::ApiException
        └── Mindbody::APIException          ← base for all HTTP errors
              └── Mindbody::{OperationError}  ← typed, if generated (in exceptions/)
...
with `.local_error('400', '...message...', Mindbody::{OperationError})`, and any status without a
