...
│   └── com.amazonaws.useast1.mgh.exceptions.ApiException          ← base for all non-2xx API responses
│       └── com.amazonaws.useast1.mgh.exceptions.{Name}Exception   ← typed subclass with payload fields
...
`getHttpContext()` returns the SDK's `com.amazonaws.useast1.mgh.http.client.HttpContext`, which carries:
