...
your SDK source (`pazecheckoutapi/models/`).
...
```python
from pazecheckoutapi.api_helper import APIHelper
...
`UnionTypeLookUp` registry (in `pazecheckoutapi/utilities/union_type_lookup.py`) and each candidate model
...
```python
from pazecheckoutapi.models.animal import Cat, Dog
...
```python
from pazecheckoutapi.models.animal import Animal, Cat, Dog
