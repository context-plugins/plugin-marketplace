...
|---|---|---|
| `ApiError` — abstract base of all 8 typed error classes in `Errors/` | `TryGetRawError(out RawError error): bool` | `Core/ErrorResponse/ApiError.cs` |
...
Of **8 operations**, **8 are Case A (typed)** and **0 are Case B (raw)**.
<!-- /crawler:op-stats -->

---

## Operations — by controller (8 groups, 8 operations)
...
|---|---:|---|
| `AddressAutocompleteApi` | 1 | [map/operations/AddressAutocompleteApi.md](map/operations/AddressAutocompleteApi.md) |
| `IpGeolocationApi` | 1 | [map/operations/IpGeolocationApi.md](map/operations/IpGeolocationApi.md) |
| `IsolineApi` | 1 | [map/operations/IsolineApi.md](map/operations/IsolineApi.md) |
| `MapMatchingApi` | 1 | [map/operations/MapMatchingApi.md](map/operations/MapMatchingApi.md) |
| `PlacesApi` | 1 | [map/operations/PlacesApi.md](map/operations/PlacesApi.md) |
| `ReverseGeocodingApi` | 1 | [map/operations/ReverseGeocodingApi.md](map/operations/ReverseGeocodingApi.md) |
| `RouteMatrixApi` | 1 | [map/operations/RouteMatrixApi.md](map/operations/RouteMatrixApi.md) |
| `RoutingApi` | 1 | [map/operations/RoutingApi.md](map/operations/RoutingApi.md) |
<!-- /crawler:ops-table -->
...
| Group | Count | Page |
|---|---:|---|
| Records (plain `record` data models) | 89 | [`AddressComponents` … `Waypoint1`](map/models/records-1-Ad-Wa.md) |
