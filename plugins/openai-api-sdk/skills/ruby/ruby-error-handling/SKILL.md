...
StandardError
  └── CoreLibrary::ApiException
        └── OpenAIAPI::APIException          ← base for all HTTP errors
              └── OpenAIAPI::{OperationError}  ← typed, if generated (in exceptions/)
...
with `.local_error('400', '...message...', OpenAIAPI::{OperationError})`, and any status without a
