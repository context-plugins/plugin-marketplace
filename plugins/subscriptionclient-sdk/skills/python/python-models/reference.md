...
`subscriptionclient/models/` and `subscriptionclient/api_helper.py`.
...
```python
from subscriptionclient.models.o_auth_token import OAuthToken
...
```python
from subscriptionclient.models.animal import Cat
