...
- **HTTP**: `POST /v1/CompositionHooks` (Default6 (video))
...
- **HTTP**: `DELETE /v1/CompositionHooks/{Sid}` (Default6 (video))
...
- **HTTP**: `GET /v1/CompositionHooks/{Sid}` (Default6 (video))
...
### ListCompositionHook
- **HTTP**: `GET /v1/CompositionHooks` (Default6 (video))
...
- **HTTP**: `POST /v1/CompositionHooks/{Sid}` (Default6 (video))
