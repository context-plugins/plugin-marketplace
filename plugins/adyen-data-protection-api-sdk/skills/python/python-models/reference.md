...
`adyendataprotectionapi/models/` and `adyendataprotectionapi/api_helper.py`.
...
```python
from adyendataprotectionapi.models.o_auth_token import OAuthToken
...
```python
from adyendataprotectionapi.models.animal import Cat
