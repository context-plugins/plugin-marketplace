...
`azurecognitive/models/` and `azurecognitive/api_helper.py`.
...
```python
from azurecognitive.models.o_auth_token import OAuthToken
...
```python
from azurecognitive.models.animal import Cat
