...
StandardError
  └── CoreLibrary::ApiException
        └── IPGeolocationAPI::APIException          ← base for all HTTP errors
              └── IPGeolocationAPI::{OperationError}  ← typed, if generated (in exceptions/)
...
with `.local_error('400', '...message...', IPGeolocationAPI::{OperationError})`, and any status without a
