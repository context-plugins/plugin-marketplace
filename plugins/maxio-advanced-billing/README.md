...
Integrate and consume the **APIMatic-generated Maxio Advanced Billing SDK** (the "APIMATIC v3.0" generic
...
(`dotnet-maxio-advanced-billing-getting-started/sdk-map.md` + `map/`) indexing every operation signature,
model, enum, union, and error type. The **`dotnet-integrate-maxio-advanced-billing`** router skill routes all
C#/.NET SDK work to the single **`dotnet-maxio-advanced-billing-sdk`** agent (.NET-only), which answers
