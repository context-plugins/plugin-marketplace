# Coingecko SDK Plugin

Integrate and consume the **APIMatic-generated Coingecko SDK** (the "APIMATIC v3.0" generic
...
(`dotnet-coingecko-getting-started/sdk-map.md` + `map/`) indexing every operation signature,
model, enum, union, and error type. The **`dotnet-integrate-coingecko`** router skill routes all
C#/.NET SDK work to the single **`dotnet-coingecko-sdk`** agent (.NET-only), which answers
