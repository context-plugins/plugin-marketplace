...
Integrate and consume the **APIMatic-generated NYTimes SDK** (the "APIMATIC v3.0" generic
...
(`dotnet-nytimes-getting-started/sdk-map.md` + `map/`) indexing every operation signature,
model, enum, union, and error type. The **`dotnet-integrate-nytimes`** router skill routes all
C#/.NET SDK work to the single **`dotnet-nytimes-sdk`** agent (.NET-only), which answers
