...
- `github.com/context-plugins/maxio-advanced-billing-go` — the Go import path for the root package; `github.com/context-plugins/maxio-advanced-billing-go/models` for request/response types.
...
```go
import "github.com/context-plugins/maxio-advanced-billing-go"
