...
(`dotnet-ebay-sell-getting-started/sdk-map.md` + `map/`) indexing every operation signature,
model, enum, union, and error type. The **`dotnet-integrate-ebay-sell`** router skill routes all
C#/.NET SDK work to the single **`dotnet-ebay-sell-sdk`** agent (.NET-only), which answers
