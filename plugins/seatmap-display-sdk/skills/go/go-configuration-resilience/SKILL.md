    ...
    seatmapdisplay.CreateConfiguration(
        seatmapdisplay.WithHttpConfiguration(
            seatmapdisplay.CreateHttpConfiguration(
                seatmapdisplay.WithTimeout(30),
                seatmapdisplay.WithRetryConfiguration(
                    seatmapdisplay.CreateRetryConfiguration(
                        seatmapdisplay.WithMaxRetryAttempts(3),
                        seatmapdisplay.WithBackoffFactor(2),
                    ),
                ),
            ),
        ),
...
```go
rc := seatmapdisplay.CreateRetryConfiguration(
    seatmapdisplay.WithMaxRetryAttempts(5),
    seatmapdisplay.WithRetryInterval(1),
    seatmapdisplay.WithBackoffFactor(2),
    seatmapdisplay.WithHttpStatusCodesToRetry([]int64{429, 500, 503}),
    seatmapdisplay.WithHttpMethodsToRetry([]string{"GET", "PUT"}),
)
```
...
client := seatmapdisplay.NewClient(
    seatmapdisplay.CreateConfiguration(
        seatmapdisplay.WithHttpConfiguration(
            seatmapdisplay.CreateHttpConfiguration(
                seatmapdisplay.WithTransport(&loggingTransport{inner: http.DefaultTransport}),
            ),
        ),
    ),
)
