...
- **Signature**: `CreateTextTrack(double videoId, RequestOptions? requestOptions = null, CancellationToken ct = default)`
...
- **Notes**: This method adds a text track to the specified video. For more information, see Working with Text Track Uploads .
- **Signature**: `CreateTextTrackAlt1(double channelId, double videoId, RequestOptions? requestOptions = null, CancellationToken ct = default)`
  - defaults: `requestOptions` = null
- **Returns**: `void` (Task)
...
- **Signature**: `EditTextTrack(double texttrackId, double videoId, RequestOptions? requestOptions = null, CancellationToken ct = default)`
  - defaults: `requestOptions` = null
- **Returns**: `void` (Task)
