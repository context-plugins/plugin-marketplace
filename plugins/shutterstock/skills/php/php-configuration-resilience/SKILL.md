...
```php
$client = new ShutterstockApiExplorerClient([
    'environment' => ShutterstockApiExplorerClient::ENVIRONMENT_PRODUCTION,  // picks server template
...
$client = new ShutterstockApiExplorerClient(['httpClient' => $httpClient, /* ...auth */]);
