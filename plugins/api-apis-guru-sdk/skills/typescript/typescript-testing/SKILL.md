...
```typescript
import { ApiApisGuruClient } from 'flight-delay-predictionlib';
...
```typescript
import { {Operation}Error } from 'flight-delay-predictionlib/errors';
...
```typescript
import { ApiError } from 'flight-delay-predictionlib';
