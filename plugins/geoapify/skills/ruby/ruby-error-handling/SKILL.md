...
StandardError
  └── CoreLibrary::ApiException
        └── Geoapify::APIException          ← base for all HTTP errors
              └── Geoapify::{OperationError}  ← typed, if generated (in exceptions/)
...
with `.local_error('400', '...message...', Geoapify::{OperationError})`, and any status without a
