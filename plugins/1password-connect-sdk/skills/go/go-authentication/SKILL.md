...
> Throughout, `1passwordconnect` and other `{...}` tokens are placeholders for names you take from your SDK —
...
client := 1passwordconnect.NewClient(
    1passwordconnect.CreateConfiguration(
        1passwordconnect.WithBasicAuthCredentials(
            1passwordconnect.NewBasicAuthCredentials(
...
1passwordconnect.WithApiKeyCredentials(1passwordconnect.NewApiKeyCredentials("token", "api-key"))

// custom header scheme (often surfaced as ApiHeaderCredentials):
1passwordconnect.WithApiHeaderCredentials(1passwordconnect.NewApiHeaderCredentials("token", "api-key"))
```
...
```go
1passwordconnect.WithOAuthBearerTokenCredentials(
    1passwordconnect.NewOAuthBearerTokenCredentials(os.Getenv("{ACCESS_TOKEN_ENV}")),
)
```
...
client := 1passwordconnect.NewClient(
    1passwordconnect.CreateConfiguration(
        1passwordconnect.WithOAuthCCGCredentials(
            1passwordconnect.NewOAuthCCGCredentials(
