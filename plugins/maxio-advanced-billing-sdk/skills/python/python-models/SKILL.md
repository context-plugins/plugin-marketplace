...
your SDK source (`maxioadvancedbilling/models/`).
...
```python
from maxioadvancedbilling.api_helper import APIHelper
...
`UnionTypeLookUp` registry (in `maxioadvancedbilling/utilities/union_type_lookup.py`) and each candidate model
...
```python
from maxioadvancedbilling.models.animal import Cat, Dog
...
```python
from maxioadvancedbilling.models.animal import Animal, Cat, Dog
