...
your SDK source (`mediumapi/models/`).
...
`UnionTypeLookUp` registry (in `mediumapi/utilities/union_type_lookup.py`) and each candidate model
...
```python
from mediumapi.models.animal import Cat, Dog
...
```python
from mediumapi.models.animal import Animal, Cat, Dog
