    ...
    articlesearchapi.CreateConfiguration(
        articlesearchapi.WithHttpConfiguration(
            articlesearchapi.CreateHttpConfiguration(
                articlesearchapi.WithTimeout(30),
                articlesearchapi.WithRetryConfiguration(
                    articlesearchapi.CreateRetryConfiguration(
                        articlesearchapi.WithMaxRetryAttempts(3),
                        articlesearchapi.WithBackoffFactor(2),
                    ),
                ),
            ),
        ),
...
```go
rc := articlesearchapi.CreateRetryConfiguration(
    articlesearchapi.WithMaxRetryAttempts(5),
    articlesearchapi.WithRetryInterval(1),
    articlesearchapi.WithBackoffFactor(2),
    articlesearchapi.WithHttpStatusCodesToRetry([]int64{429, 500, 503}),
    articlesearchapi.WithHttpMethodsToRetry([]string{"GET", "PUT"}),
)
```
...
client := articlesearchapi.NewClient(
    articlesearchapi.CreateConfiguration(
        articlesearchapi.WithHttpConfiguration(
            articlesearchapi.CreateHttpConfiguration(
                articlesearchapi.WithTransport(&loggingTransport{inner: http.DefaultTransport}),
            ),
        ),
    ),
)
