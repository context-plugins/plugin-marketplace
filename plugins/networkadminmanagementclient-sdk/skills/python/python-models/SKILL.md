...
your SDK source (`networkadminmanagementclient/models/`).
...
```python
from networkadminmanagementclient.api_helper import APIHelper
...
`UnionTypeLookUp` registry (in `networkadminmanagementclient/utilities/union_type_lookup.py`) and each candidate model
...
```python
from networkadminmanagementclient.models.animal import Cat, Dog
...
```python
from networkadminmanagementclient.models.animal import Animal, Cat, Dog
