...
```php
$client = new AdyenDataProtectionAPIClient([
    'environment' => AdyenDataProtectionAPIClient::ENVIRONMENT_PRODUCTION,  // picks server template
...
$client = new AdyenDataProtectionAPIClient(['httpClient' => $httpClient, /* ...auth */]);
