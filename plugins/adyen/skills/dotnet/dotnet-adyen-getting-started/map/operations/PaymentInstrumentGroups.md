...
- **HTTP**: `GET /paymentInstrumentGroups/{id}` (Default (balanceplatform-api-test))
...
- **HTTP**: `GET /paymentInstrumentGroups/{id}/transactionRules` (Default (balanceplatform-api-test))
...
- **HTTP**: `POST /paymentInstrumentGroups` (Default (balanceplatform-api-test))
