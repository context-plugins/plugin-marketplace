...
your SDK source (`configurationapi/models/`).
...
```python
from configurationapi.api_helper import APIHelper
...
`UnionTypeLookUp` registry (in `configurationapi/utilities/union_type_lookup.py`) and each candidate model
...
```python
from configurationapi.models.animal import Cat, Dog
...
```python
from configurationapi.models.animal import Animal, Cat, Dog
