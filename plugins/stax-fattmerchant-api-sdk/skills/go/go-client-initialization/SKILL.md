...
- `github.com/context-plugins/stax-fattmerchant-api-go` — the Go import path for the root package; `github.com/context-plugins/stax-fattmerchant-api-go/models` for request/response types.
...
```go
import "github.com/context-plugins/stax-fattmerchant-api-go"
