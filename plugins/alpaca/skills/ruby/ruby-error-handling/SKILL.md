...
StandardError
  └── CoreLibrary::ApiException
        └── Alpaca::APIException          ← base for all HTTP errors
              └── Alpaca::{OperationError}  ← typed, if generated (in exceptions/)
...
with `.local_error('400', '...message...', Alpaca::{OperationError})`, and any status without a
