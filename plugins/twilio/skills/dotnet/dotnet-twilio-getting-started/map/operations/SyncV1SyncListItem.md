...
### CreateSyncListItem
- **HTTP**: `POST /v1/Services/{ServiceSid}/Lists/{ListSid}/Items` (Default10 (sync))
...
### DeleteSyncListItem
- **HTTP**: `DELETE /v1/Services/{ServiceSid}/Lists/{ListSid}/Items/{Index}` (Default10 (sync))
...
### FetchSyncListItem
- **HTTP**: `GET /v1/Services/{ServiceSid}/Lists/{ListSid}/Items/{Index}` (Default10 (sync))
...
### ListSyncListItem
- **HTTP**: `GET /v1/Services/{ServiceSid}/Lists/{ListSid}/Items` (Default10 (sync))
- **Signature**: `ListSyncListItem(string serviceSid, string listSid, ConversationMessageEnumOrderType? order, string? from, SyncListItemEnumQueryFromBoundType? bounds, long? pageSize, int? page, string? pageToken, RequestOptions? requestOptions = null, CancellationToken ct = default)`
...
### UpdateSyncListItem
- **HTTP**: `POST /v1/Services/{ServiceSid}/Lists/{ListSid}/Items/{Index}` (Default10 (sync))
