...
| Install | `pip install "git+https://github.com/context-plugins/maxio-advanced-billing-python@main"` |
...
```bash
pip install "git+https://github.com/context-plugins/maxio-advanced-billing-python@main"
```
...
```bash
# Linux / macOS:
git clone --depth 1 --branch main https://github.com/context-plugins/maxio-advanced-billing-python /tmp/maxio-advanced-billing-python-src
```

```powershell
# Windows (PowerShell):
git clone --depth 1 --branch main https://github.com/context-plugins/maxio-advanced-billing-python "$env:TEMP\maxio-advanced-billing-python-src"
```
