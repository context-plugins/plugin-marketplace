...
`adobeexperiencemanageraemapi/models/` and `adobeexperiencemanageraemapi/api_helper.py`.
...
```python
from adobeexperiencemanageraemapi.models.o_auth_token import OAuthToken
...
```python
from adobeexperiencemanageraemapi.models.animal import Cat
