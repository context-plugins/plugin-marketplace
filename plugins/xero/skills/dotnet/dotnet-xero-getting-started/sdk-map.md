...
| | |
|---|---|
| SDK display name | Xero |
| Root namespace/module | `Xero` |
<!-- gen:stamp -->
| Target framework(s) | `netstandard2.0` (C# `LangVersion 14`, `Nullable enable`) |
| Source commit (spec stamp) | `fb37e30` (`fb37e3049b8a1d3465ff55579b08a776a4f07599`, tagged `fb37e30`) |
<!-- /gen:stamp -->
| Generator | APIMatic |
| Repo | https://github.com/context-plugins/xero-csharp-sdk (branch `main`) |
...
```csharp
using Xero;
using Xero.Servers; // ServerEnvironment lives here

var options = new XeroClientOptions
{
...
var client = new XeroClient(httpClient, options); // httpClient: System.Net.Http.HttpClient
```

DI alternative (`ServiceCollectionExtensions.cs`):

```csharp
services.AddXeroClient(o =>
{
...
All `XeroClientOptions` properties (source: `XeroClientOptions.cs`):
...
| `Oauth21` | `OAuth2ClientCredentials?` |
| `Oauth21TokenStrategy` | `IOAuth2TokenStrategy<OAuth2ClientCredentials>?` |
...
- `XeroClient(HttpClient httpClient, XeroClientOptions options)`
<!-- /crawler:client-options -->
...
|---|---|---|
| `ApiError` — abstract base of all 247 typed error classes in `Errors/` | `TryGetRawError(out RawError error): bool` | `Core/ErrorResponse/ApiError.cs` |
...
Of **477 operations**, **247 are Case A (typed)** and **230 are Case B (raw)**.
<!-- /crawler:op-stats -->

---

## Operations — by controller (12 groups, 477 operations)
...
|---|---:|---|
| `Accounting` | 235 | [map/operations/Accounting.md](map/operations/Accounting.md) |
| `AppStore` | 4 | [map/operations/AppStore.md](map/operations/AppStore.md) |
| `AssetApi` | 6 | [map/operations/AssetApi.md](map/operations/AssetApi.md) |
| `BankFeeds` | 7 | [map/operations/BankFeeds.md](map/operations/BankFeeds.md) |
| `FilesApi` | 18 | [map/operations/FilesApi.md](map/operations/FilesApi.md) |
| `Finance` | 8 | [map/operations/Finance.md](map/operations/Finance.md) |
| `Identity` | 2 | [map/operations/Identity.md](map/operations/Identity.md) |
| `PayrollAu` | 32 | [map/operations/PayrollAu.md](map/operations/PayrollAu.md) |
| `PayrollAuV2` | 9 | [map/operations/PayrollAuV2.md](map/operations/PayrollAuV2.md) |
| `PayrollNz` | 71 | [map/operations/PayrollNz.md](map/operations/PayrollNz.md) |
| `PayrollUk` | 69 | [map/operations/PayrollUk.md](map/operations/PayrollUk.md) |
| `ProjectApi` | 16 | [map/operations/ProjectApi.md](map/operations/ProjectApi.md) |
<!-- /crawler:ops-table -->
...
| Group | Count | Page |
|---|---:|---|
| Records (plain `record` data models) | 467 | [`AccessToken` … `EmployeeOpeningBalancesObject1`](map/models/records-1-Ac-Em.md) · [`EmployeePayTemplate` … `Payslips2`](map/models/records-2-Em-Pa.md) · [`PayslipSummary` … `WorkingWeek`](map/models/records-3-Pa-Wo.md) |
| Unions (`OneOf` / `AnyOf`) — variant factories + `TryGet…` | 0 + 1 | [map/models/unions.md](map/models/unions.md) |
| Enums (`StringEnum<T>` / `IntEnum<T>`) — literal C# member names + wire values | 186 | [map/models/enums.md](map/models/enums.md) |
<!-- /gen:models-table -->
...
|---|---|
| Client & options (root) | `Xero` |
| Operation controllers (`Api/`) | `Xero.Api` |
| Records (`Models/`) | `Xero.Models` |
| Enums (`Models/Enums/`) | `Xero.Models.Enums` |
| Unions (`Models/AnyOf/`, `Models/OneOf/`) | `Xero.Models.AnyOf` |
| Error classes (`Errors/`) | `Xero.Errors` |
<!-- /gen:namespaces -->
...
**Auth.** The scheme(s) this API uses surface as credentials properties on `XeroClientOptions` (source: `XeroClientOptions.cs`) — set them before constructing the client; load `dotnet-authentication` for the wiring:

| Property | Type | Notes (from the source XML docs) |
|---|---|---|
| `Oauth2` | `OAuth2AuthorizationCodeCredentials?` | For more information, For more information visit https://developer.xero.com/documentation/oauth2/overview, For more information, For more information, For more information, For more information visit https://developer.xero.com/documentation/oauth2/overview, For more information visit https://developer.xero.com/documentation/oauth2/overview, For more information visit https://developer.xero.com/documentation/oauth2/overview, For more information visit https://developer.xero.com/documentation/oauth2/overview, For more information |
| `Oauth2TokenStrategy` | `IOAuth2RefreshableTokenStrategy<OAuth2AuthorizationCodeCredentials>?` | — |
| `Oauth21` | `OAuth2ClientCredentials?` | For more information |
| `Oauth21TokenStrategy` | `IOAuth2TokenStrategy<OAuth2ClientCredentials>?` | — |
| `BasicAuth` | `BasicAuthCredentials?` | — |
