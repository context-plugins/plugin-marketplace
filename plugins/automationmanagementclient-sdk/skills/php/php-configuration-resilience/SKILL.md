...
```php
$client = new AutomationManagementClientClient([
    'environment' => AutomationManagementClientClient::ENVIRONMENT_PRODUCTION,  // picks server template
...
$client = new AutomationManagementClientClient(['httpClient' => $httpClient, /* ...auth */]);
