...
your SDK source (`flightordermanagement/models/`).
...
```python
from flightordermanagement.api_helper import APIHelper
...
`UnionTypeLookUp` registry (in `flightordermanagement/utilities/union_type_lookup.py`) and each candidate model
...
```python
from flightordermanagement.models.animal import Cat, Dog
...
```python
from flightordermanagement.models.animal import Animal, Cat, Dog
