...
> Throughout this skill, `{...}` is a placeholder for a name you take from your SDK (e.g. `{operation}`, `{apiGroup}`, `binance-public-spot-apilib`) — replace it with the concrete identifier from the source.
...
```typescript
import { Client } from 'binance-public-spot-apilib';
import { ApiError } from 'binance-public-spot-apilib';
import { {Operation}Error } from 'binance-public-spot-apilib/errors';
