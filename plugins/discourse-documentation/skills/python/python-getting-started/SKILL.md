...
| Install | `pip install "git+https://github.com/context-plugins/discourse-api-documentation-python@main"` |
...
- `discourseapidocumentation/controllers/` — one `{Resource}Controller` per API resource group, all inheriting from
...
```bash
pip install "git+https://github.com/context-plugins/discourse-api-documentation-python@main"
```
...
```bash
# Linux / macOS:
git clone --depth 1 --branch main https://github.com/context-plugins/discourse-api-documentation-python /tmp/discourse-api-documentation-python-src
```

```powershell
# Windows (PowerShell):
git clone --depth 1 --branch main https://github.com/context-plugins/discourse-api-documentation-python "$env:TEMP\discourse-api-documentation-python-src"
```
