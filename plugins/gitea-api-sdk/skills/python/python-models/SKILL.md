...
your SDK source (`giteaapi/models/`).
...
`UnionTypeLookUp` registry (in `giteaapi/utilities/union_type_lookup.py`) and each candidate model
...
```python
from giteaapi.models.animal import Cat, Dog
...
```python
from giteaapi.models.animal import Animal, Cat, Dog
