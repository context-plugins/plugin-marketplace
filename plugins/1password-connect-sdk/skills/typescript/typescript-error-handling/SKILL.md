...
> Throughout this skill, `{...}` is a placeholder for a name you take from your SDK (e.g. `{operation}`, `{apiGroup}`, `m1-password-connectlib`) — replace it with the concrete identifier from the source.
