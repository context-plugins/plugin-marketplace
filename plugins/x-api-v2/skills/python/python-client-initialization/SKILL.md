...
- `XAPIV2Client` — the generated client class (e.g. `MultiauthsampleClient`, `BatesterClient`).
...
`Environment` is an `Enum` subclass in `xapiv2/configuration.py`. Use the constant for the desired
