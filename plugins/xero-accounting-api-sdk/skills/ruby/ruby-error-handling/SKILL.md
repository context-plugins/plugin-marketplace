...
StandardError
  └── CoreLibrary::ApiException
        └── XeroAccountingAPI::APIException          ← base for all HTTP errors
              └── XeroAccountingAPI::{OperationError}  ← typed, if generated (in exceptions/)
...
with `.local_error('400', '...message...', XeroAccountingAPI::{OperationError})`, and any status without a
