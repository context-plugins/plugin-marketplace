...
- `OpenUvGlobalRealTimeUvIndexForecastApiClientOptions` — its options class.
- `OpenUvGlobalRealTimeUvIndexForecastApi` — the SDK's root namespace, used in `using` directives. This can differ from the NuGet
...
```csharp
public OpenUvGlobalRealTimeUvIndexForecastApiClient(HttpClient httpClient, OpenUvGlobalRealTimeUvIndexForecastApiClientOptions options)
```
...
```csharp
public class OpenUvGlobalRealTimeUvIndexForecastApiClientOptions
{
...
```csharp
using OpenUvGlobalRealTimeUvIndexForecastApi;
using OpenUvGlobalRealTimeUvIndexForecastApi.Servers;

var options = new OpenUvGlobalRealTimeUvIndexForecastApiClientOptions
{
...
var client = new OpenUvGlobalRealTimeUvIndexForecastApiClient(httpClient, options);
```
...
Every APIMatic .NET SDK ships a `ServiceCollection` extension named `AddOpenUvGlobalRealTimeUvIndexForecastApiClient`, which registers the
...
builder.Services.AddOpenUvGlobalRealTimeUvIndexForecastApiClient(options =>
{
...
```csharp
public sealed class MyService(OpenUvGlobalRealTimeUvIndexForecastApiClient client)
{
