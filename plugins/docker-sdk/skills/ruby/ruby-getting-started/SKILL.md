...
| Install | `gem 'docker', git: 'https://github.com/context-plugins/docker-ruby', branch: 'main'` in a Gemfile |
...
```ruby
# In your Gemfile:
gem 'docker', git: 'https://github.com/context-plugins/docker-ruby', branch: 'main'
```
...
```bash
# Linux / macOS:
git clone --depth 1 --branch main https://github.com/context-plugins/docker-ruby /tmp/docker-ruby-src
```

```powershell
# Windows (PowerShell):
git clone --depth 1 --branch main https://github.com/context-plugins/docker-ruby "$env:TEMP\docker-ruby-src"
```
