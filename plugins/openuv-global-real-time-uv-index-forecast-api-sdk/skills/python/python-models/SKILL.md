...
your SDK source (`openuvglobalrealtimeuvindexforecastapi/models/`).
...
```python
from openuvglobalrealtimeuvindexforecastapi.api_helper import APIHelper
...
`UnionTypeLookUp` registry (in `openuvglobalrealtimeuvindexforecastapi/utilities/union_type_lookup.py`) and each candidate model
...
```python
from openuvglobalrealtimeuvindexforecastapi.models.animal import Cat, Dog
...
```python
from openuvglobalrealtimeuvindexforecastapi.models.animal import Animal, Cat, Dog
