...
StandardError
  └── CoreLibrary::ApiException
        └── ShellAPI::APIException          ← base for all HTTP errors
              └── ShellAPI::{OperationError}  ← typed, if generated (in exceptions/)
...
with `.local_error('400', '...message...', ShellAPI::{OperationError})`, and any status without a
