...
`shelldataandreporting/models/` and `shelldataandreporting/api_helper.py`.
...
```python
from shelldataandreporting.models.o_auth_token import OAuthToken
...
```python
from shelldataandreporting.models.animal import Cat
