...
| Install | `gem 'pq_api_v2', git: 'https://github.com/context-plugins/pq-api-v2-ruby', branch: 'main'` in a Gemfile |
...
```ruby
# In your Gemfile:
gem 'pq_api_v2', git: 'https://github.com/context-plugins/pq-api-v2-ruby', branch: 'main'
```
...
```bash
# Linux / macOS:
git clone --depth 1 --branch main https://github.com/context-plugins/pq-api-v2-ruby /tmp/pq-api-v2-ruby-src
```

```powershell
# Windows (PowerShell):
git clone --depth 1 --branch main https://github.com/context-plugins/pq-api-v2-ruby "$env:TEMP\pq-api-v2-ruby-src"
```
