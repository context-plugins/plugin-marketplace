...
Confirm every name against `lib/x_api_v2/client.rb`, `lib/x_api_v2/configuration.rb`, the
`lib/x_api_v2/http/auth/*.rb` files, and `doc/auth/*.md` in the cloned source.
