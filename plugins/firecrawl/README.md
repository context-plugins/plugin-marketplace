# firecrawl SDK Plugin

Integrate and consume the **APIMatic-generated firecrawl SDK** (the "APIMATIC v3.0" generic
...
(`dotnet-firecrawl-getting-started/sdk-map.md` + `map/`) indexing every operation signature,
model, enum, union, and error type. The **`dotnet-integrate-firecrawl`** router skill routes all
C#/.NET SDK work to the single **`dotnet-firecrawl-sdk`** agent (.NET-only), which answers
