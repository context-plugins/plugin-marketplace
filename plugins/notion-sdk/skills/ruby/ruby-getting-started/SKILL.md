...
| Install | `gem 'notion', git: 'https://github.com/context-plugins/notion-ruby', branch: 'main'` in a Gemfile |
...
```ruby
# In your Gemfile:
gem 'notion', git: 'https://github.com/context-plugins/notion-ruby', branch: 'main'
```
...
```bash
# Linux / macOS:
git clone --depth 1 --branch main https://github.com/context-plugins/notion-ruby /tmp/notion-ruby-src
```

```powershell
# Windows (PowerShell):
git clone --depth 1 --branch main https://github.com/context-plugins/notion-ruby "$env:TEMP\notion-ruby-src"
```
