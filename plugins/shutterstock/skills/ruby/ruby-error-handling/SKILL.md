...
StandardError
  └── CoreLibrary::ApiException
        └── Shutterstock::APIException          ← base for all HTTP errors
              └── Shutterstock::{OperationError}  ← typed, if generated (in exceptions/)
...
with `.local_error('400', '...message...', Shutterstock::{OperationError})`, and any status without a
