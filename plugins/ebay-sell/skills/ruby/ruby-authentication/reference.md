...
Confirm every name against `lib/ebay_sell/client.rb`, `lib/ebay_sell/configuration.rb`, the
`lib/ebay_sell/http/auth/*.rb` files, and `doc/auth/*.md` in the cloned source.
