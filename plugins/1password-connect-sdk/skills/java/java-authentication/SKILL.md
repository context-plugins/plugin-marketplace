...
To see which schemes a specific SDK accepts, read the credential setter methods on `1PasswordConnectClient.Builder`
...
- Set credentials **on the `1PasswordConnectClient.Builder`** before calling `.build()` — the client is immutable
