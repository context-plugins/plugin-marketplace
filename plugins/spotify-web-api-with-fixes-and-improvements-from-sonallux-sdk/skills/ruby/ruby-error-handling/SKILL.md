...
StandardError
  └── CoreLibrary::ApiException
        └── SpotifyWebAPIWithFixesAndImprovementsFromSonallux::APIException          ← base for all HTTP errors
              └── SpotifyWebAPIWithFixesAndImprovementsFromSonallux::{OperationError}  ← typed, if generated (in exceptions/)
...
with `.local_error('400', '...message...', SpotifyWebAPIWithFixesAndImprovementsFromSonallux::{OperationError})`, and any status without a
