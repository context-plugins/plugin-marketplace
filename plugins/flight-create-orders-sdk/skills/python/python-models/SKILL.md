...
your SDK source (`flightcreateorders/models/`).
...
```python
from flightcreateorders.api_helper import APIHelper
...
`UnionTypeLookUp` registry (in `flightcreateorders/utilities/union_type_lookup.py`) and each candidate model
...
```python
from flightcreateorders.models.animal import Cat, Dog
...
```python
from flightcreateorders.models.animal import Animal, Cat, Dog
