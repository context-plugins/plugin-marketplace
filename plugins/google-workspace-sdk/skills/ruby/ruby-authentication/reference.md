...
Confirm every name against `lib/google_workspace/client.rb`, `lib/google_workspace/configuration.rb`, the
`lib/google_workspace/http/auth/*.rb` files, and `doc/auth/*.md` in the cloned source.
