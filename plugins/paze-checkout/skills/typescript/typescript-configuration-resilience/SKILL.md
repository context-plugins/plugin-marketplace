...
All config below is passed at construction time via the `PazeCheckoutAPIClientConfig` object.

## Base URL / environment override

```typescript
import { PazeCheckoutAPIClient, Environment } from 'paze-checkout-apilib';
