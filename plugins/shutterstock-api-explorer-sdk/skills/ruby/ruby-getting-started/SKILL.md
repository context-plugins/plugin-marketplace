...
| Install | `gem 'shutterstock_api_explorer', git: 'https://github.com/context-plugins/shutterstock-api-explorer-ruby', branch: 'main'` in a Gemfile |
...
```ruby
# In your Gemfile:
gem 'shutterstock_api_explorer', git: 'https://github.com/context-plugins/shutterstock-api-explorer-ruby', branch: 'main'
```
...
```bash
# Linux / macOS:
git clone --depth 1 --branch main https://github.com/context-plugins/shutterstock-api-explorer-ruby /tmp/shutterstock-api-explorer-ruby-src
```

```powershell
# Windows (PowerShell):
git clone --depth 1 --branch main https://github.com/context-plugins/shutterstock-api-explorer-ruby "$env:TEMP\shutterstock-api-explorer-ruby-src"
```
