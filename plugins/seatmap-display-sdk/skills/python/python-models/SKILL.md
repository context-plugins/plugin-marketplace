...
your SDK source (`seatmapdisplay/models/`).
...
```python
from seatmapdisplay.api_helper import APIHelper
...
`UnionTypeLookUp` registry (in `seatmapdisplay/utilities/union_type_lookup.py`) and each candidate model
...
```python
from seatmapdisplay.models.animal import Cat, Dog
...
```python
from seatmapdisplay.models.animal import Animal, Cat, Dog
