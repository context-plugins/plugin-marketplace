...
All config below is passed at construction time via the `1PasswordConnectClientConfig` object.

## Base URL / environment override

```typescript
import { 1PasswordConnectClient, Environment } from 'm1-password-connectlib';
