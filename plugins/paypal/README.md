...
Integrate and consume the **APIMatic-generated paypal SDK** across C#/.NET, TypeScript,
...
(`dotnet-paypal-getting-started/sdk-map.md` + `map/`) indexing every operation signature,
model, enum, union, and error type. The **`dotnet-integrate-paypal`** router skill routes all
C#/.NET SDK work to the single **`dotnet-paypal-sdk`** agent (.NET-only), which answers
