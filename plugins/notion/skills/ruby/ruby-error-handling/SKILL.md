...
StandardError
  └── CoreLibrary::ApiException
        └── Notion::APIException          ← base for all HTTP errors
              └── Notion::{OperationError}  ← typed, if generated (in exceptions/)
...
with `.local_error('400', '...message...', Notion::{OperationError})`, and any status without a
