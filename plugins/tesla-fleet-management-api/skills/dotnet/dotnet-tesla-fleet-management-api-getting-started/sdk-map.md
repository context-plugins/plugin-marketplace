# SDK map — Tesla Fleet Management API (.NET)
...
| Source commit (spec stamp) | `bc673c6` (`bc673c63b14bbc01519b0cd231bc41f4c87935ef`, tagged `bc673c6`) |
<!-- /gen:stamp -->
| Generator | APIMatic |
| Repo | https://github.com/context-plugins/tesla-fleet-management-api-csharp-sdk (branch `main`) |
...
| `BearerAuth` | `string?` |
| `Thirdpartytoken` | `OAuth2AuthorizationCodeCredentials?` |
| `ThirdpartytokenTokenStrategy` | `IOAuth2RefreshableTokenStrategy<OAuth2AuthorizationCodeCredentials>?` |
