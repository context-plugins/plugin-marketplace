...
> Throughout, `hotelnameautocomplete` and other `{...}` tokens are placeholders for names you take from your SDK —
...
client := hotelnameautocomplete.NewClient(
    hotelnameautocomplete.CreateConfiguration(
        hotelnameautocomplete.WithBasicAuthCredentials(
            hotelnameautocomplete.NewBasicAuthCredentials(
...
hotelnameautocomplete.WithApiKeyCredentials(hotelnameautocomplete.NewApiKeyCredentials("token", "api-key"))

// custom header scheme (often surfaced as ApiHeaderCredentials):
hotelnameautocomplete.WithApiHeaderCredentials(hotelnameautocomplete.NewApiHeaderCredentials("token", "api-key"))
```
...
```go
hotelnameautocomplete.WithOAuthBearerTokenCredentials(
    hotelnameautocomplete.NewOAuthBearerTokenCredentials(os.Getenv("{ACCESS_TOKEN_ENV}")),
)
```
...
client := hotelnameautocomplete.NewClient(
    hotelnameautocomplete.CreateConfiguration(
        hotelnameautocomplete.WithOAuthCCGCredentials(
            hotelnameautocomplete.NewOAuthCCGCredentials(
