...
StandardError
  └── CoreLibrary::ApiException
        └── Fdx::APIException          ← base for all HTTP errors
              └── Fdx::{OperationError}  ← typed, if generated (in exceptions/)
...
with `.local_error('400', '...message...', Fdx::{OperationError})`, and any status without a
