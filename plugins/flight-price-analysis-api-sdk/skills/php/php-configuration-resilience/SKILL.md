...
```php
$client = new FlightPriceAnalysisAPIClient([
    'environment' => FlightPriceAnalysisAPIClient::ENVIRONMENT_PRODUCTION,  // picks server template
...
$client = new FlightPriceAnalysisAPIClient(['httpClient' => $httpClient, /* ...auth */]);
