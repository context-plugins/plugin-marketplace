...
`testing` + `testify/require` for reference; substitute the real `networkadminmanagementclient` and names.
...
import (
    ...
    "github.com/context-plugins/networkadminmanagementclient-go"   // root package networkadminmanagementclient
)
...
func clientReturning(status int, body string) (networkadminmanagementclient.ClientInterface, *stubTransport) {
    ...
    client := networkadminmanagementclient.NewClient(
        networkadminmanagementclient.CreateConfiguration(
            networkadminmanagementclient.WithHttpConfiguration(
                networkadminmanagementclient.CreateHttpConfiguration(networkadminmanagementclient.WithTransport(stub)),
            ),
...
```go
import sdkerrors "github.com/context-plugins/networkadminmanagementclient-go/errors"
...
client := networkadminmanagementclient.NewClient(
    networkadminmanagementclient.CreateConfiguration(
        networkadminmanagementclient.WithHttpConfiguration(
            networkadminmanagementclient.CreateHttpConfiguration(networkadminmanagementclient.WithTransport(redirectTransport{host: target.Host})),
        ),
    ),
)
```
