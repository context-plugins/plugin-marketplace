...
StandardError
  └── CoreLibrary::ApiException
        └── APIsGuru::APIException          ← base for all HTTP errors
              └── APIsGuru::{OperationError}  ← typed, if generated (in exceptions/)
...
with `.local_error('400', '...message...', APIsGuru::{OperationError})`, and any status without a
