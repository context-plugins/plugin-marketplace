...
StandardError
  └── CoreLibrary::ApiException
        └── DeploymentAdminClient::APIException          ← base for all HTTP errors
              └── DeploymentAdminClient::{OperationError}  ← typed, if generated (in exceptions/)
...
with `.local_error('400', '...message...', DeploymentAdminClient::{OperationError})`, and any status without a
