...
your SDK source (`spotifywebapi/models/`).
...
`UnionTypeLookUp` registry (in `spotifywebapi/utilities/union_type_lookup.py`) and each candidate model
...
```python
from spotifywebapi.models.animal import Cat, Dog
...
```python
from spotifywebapi.models.animal import Animal, Cat, Dog
