...
StandardError
  └── CoreLibrary::ApiException
        └── MailboxValidatorFreeEmailChecker::APIException          ← base for all HTTP errors
              └── MailboxValidatorFreeEmailChecker::{OperationError}  ← typed, if generated (in exceptions/)
...
with `.local_error('400', '...message...', MailboxValidatorFreeEmailChecker::{OperationError})`, and any status without a
