...
StandardError
  └── CoreLibrary::ApiException
        └── ShellDigitalpayments::APIException          ← base for all HTTP errors
              └── ShellDigitalpayments::{OperationError}  ← typed, if generated (in exceptions/)
...
with `.local_error('400', '...message...', ShellDigitalpayments::{OperationError})`, and any status without a
