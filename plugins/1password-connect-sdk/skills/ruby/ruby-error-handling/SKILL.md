...
StandardError
  └── CoreLibrary::ApiException
        └── 1PasswordConnect::APIException          ← base for all HTTP errors
              └── 1PasswordConnect::{OperationError}  ← typed, if generated (in exceptions/)
...
with `.local_error('400', '...message...', 1PasswordConnect::{OperationError})`, and any status without a
