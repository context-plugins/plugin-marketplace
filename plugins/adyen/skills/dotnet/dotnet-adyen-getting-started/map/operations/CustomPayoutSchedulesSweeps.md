...
- **HTTP**: `DELETE /balanceAccounts/{balanceAccountId}/sweeps/{sweepId}` (Default (balanceplatform-api-test))
...
- **HTTP**: `GET /balanceAccounts/{balanceAccountId}/sweeps` (Default (balanceplatform-api-test))
...
- **HTTP**: `GET /balanceAccounts/{balanceAccountId}/sweeps/{sweepId}` (Default (balanceplatform-api-test))
...
- **HTTP**: `PATCH /balanceAccounts/{balanceAccountId}/sweeps/{sweepId}` (Default (balanceplatform-api-test))
...
- **HTTP**: `POST /balanceAccounts/{balanceAccountId}/sweeps` (Default (balanceplatform-api-test))
