...
```php
$client = new MailboxValidatorFreeEmailCheckerClient([
    'environment' => MailboxValidatorFreeEmailCheckerClient::ENVIRONMENT_PRODUCTION,  // picks server template
...
$client = new MailboxValidatorFreeEmailCheckerClient(['httpClient' => $httpClient, /* ...auth */]);
