    ...
    adafruitiorestapi.CreateConfiguration(
        adafruitiorestapi.WithHttpConfiguration(
            adafruitiorestapi.CreateHttpConfiguration(
                adafruitiorestapi.WithTimeout(30),
                adafruitiorestapi.WithRetryConfiguration(
                    adafruitiorestapi.CreateRetryConfiguration(
                        adafruitiorestapi.WithMaxRetryAttempts(3),
                        adafruitiorestapi.WithBackoffFactor(2),
                    ),
                ),
            ),
        ),
...
```go
rc := adafruitiorestapi.CreateRetryConfiguration(
    adafruitiorestapi.WithMaxRetryAttempts(5),
    adafruitiorestapi.WithRetryInterval(1),
    adafruitiorestapi.WithBackoffFactor(2),
    adafruitiorestapi.WithHttpStatusCodesToRetry([]int64{429, 500, 503}),
    adafruitiorestapi.WithHttpMethodsToRetry([]string{"GET", "PUT"}),
)
```
...
client := adafruitiorestapi.NewClient(
    adafruitiorestapi.CreateConfiguration(
        adafruitiorestapi.WithHttpConfiguration(
            adafruitiorestapi.CreateHttpConfiguration(
                adafruitiorestapi.WithTransport(&loggingTransport{inner: http.DefaultTransport}),
            ),
        ),
    ),
)
