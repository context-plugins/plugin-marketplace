...
Integrate and consume the **APIMatic-generated klarna SDK** (the "APIMATIC v3.0" generic
...
(`dotnet-klarna-getting-started/sdk-map.md` + `map/`) indexing every operation signature,
model, enum, union, and error type. The **`dotnet-integrate-klarna`** router skill routes all
C#/.NET SDK work to the single **`dotnet-klarna-sdk`** agent (.NET-only), which answers
