...
your SDK source (`travelrecommendationsapi/models/`).
...
```python
from travelrecommendationsapi.api_helper import APIHelper
...
`UnionTypeLookUp` registry (in `travelrecommendationsapi/utilities/union_type_lookup.py`) and each candidate model
...
```python
from travelrecommendationsapi.models.animal import Cat, Dog
...
```python
from travelrecommendationsapi.models.animal import Animal, Cat, Dog
