...
`flightoffersprice/models/` and `flightoffersprice/api_helper.py`.
...
```python
from flightoffersprice.models.o_auth_token import OAuthToken
...
```python
from flightoffersprice.models.animal import Cat
