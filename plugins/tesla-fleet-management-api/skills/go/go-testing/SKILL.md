...
`testing` + `testify/require` for reference; substitute the real `teslafleetmanagementapi` and names.
...
import (
    ...
    "github.com/context-plugins/tesla-fleet-management-api-go-sdk"   // root package teslafleetmanagementapi
)
...
func clientReturning(status int, body string) (teslafleetmanagementapi.ClientInterface, *stubTransport) {
    ...
    client := teslafleetmanagementapi.NewClient(
        teslafleetmanagementapi.CreateConfiguration(
            teslafleetmanagementapi.WithHttpConfiguration(
                teslafleetmanagementapi.CreateHttpConfiguration(teslafleetmanagementapi.WithTransport(stub)),
            ),
...
```go
import sdkerrors "github.com/context-plugins/tesla-fleet-management-api-go-sdk/errors"
...
client := teslafleetmanagementapi.NewClient(
    teslafleetmanagementapi.CreateConfiguration(
        teslafleetmanagementapi.WithHttpConfiguration(
            teslafleetmanagementapi.CreateHttpConfiguration(teslafleetmanagementapi.WithTransport(redirectTransport{host: target.Host})),
        ),
    ),
)
```
