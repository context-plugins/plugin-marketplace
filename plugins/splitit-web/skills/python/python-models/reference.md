...
`splititwebapiv3/models/` and `splititwebapiv3/api_helper.py`.
...
```python
from splititwebapiv3.models.o_auth_token import OAuthToken
...
```python
from splititwebapiv3.models.animal import Cat
