...
- **HTTP**: `GET /legalEntities/{id}/pciQuestionnaires` (Default (balanceplatform-api-test))
...
- **HTTP**: `GET /legalEntities/{id}/pciQuestionnaires/{pciid}` (Default (balanceplatform-api-test))
...
- **HTTP**: `POST /legalEntities/{id}/pciQuestionnaires/generatePciTemplates` (Default (balanceplatform-api-test))
...
- **HTTP**: `POST /legalEntities/{id}/pciQuestionnaires/signPciTemplates` (Default (balanceplatform-api-test))
...
- **HTTP**: `POST /legalEntities/{id}/pciQuestionnaires/signingRequired` (Default (balanceplatform-api-test))
