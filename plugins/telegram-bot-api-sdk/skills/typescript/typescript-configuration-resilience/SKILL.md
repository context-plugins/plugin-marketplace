...
All config below is passed at construction time via the `TelegramBotAPIClientConfig` object.

## Base URL / environment override

```typescript
import { TelegramBotAPIClient, Environment } from 'telegram-bot-apilib';
