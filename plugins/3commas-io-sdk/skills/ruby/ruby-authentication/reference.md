...
Confirm every name against `lib/3commas_io/client.rb`, `lib/3commas_io/configuration.rb`, the
`lib/3commas_io/http/auth/*.rb` files, and `doc/auth/*.md` in the cloned source.
