...
> Throughout, `openmeteoweatherforecastapi` and other `{...}` tokens are placeholders for names you take from your SDK —
...
client := openmeteoweatherforecastapi.NewClient(
    openmeteoweatherforecastapi.CreateConfiguration(
        openmeteoweatherforecastapi.WithBasicAuthCredentials(
            openmeteoweatherforecastapi.NewBasicAuthCredentials(
...
openmeteoweatherforecastapi.WithApiKeyCredentials(openmeteoweatherforecastapi.NewApiKeyCredentials("token", "api-key"))

// custom header scheme (often surfaced as ApiHeaderCredentials):
openmeteoweatherforecastapi.WithApiHeaderCredentials(openmeteoweatherforecastapi.NewApiHeaderCredentials("token", "api-key"))
```
...
```go
openmeteoweatherforecastapi.WithOAuthBearerTokenCredentials(
    openmeteoweatherforecastapi.NewOAuthBearerTokenCredentials(os.Getenv("{ACCESS_TOKEN_ENV}")),
)
```
...
client := openmeteoweatherforecastapi.NewClient(
    openmeteoweatherforecastapi.CreateConfiguration(
        openmeteoweatherforecastapi.WithOAuthCCGCredentials(
            openmeteoweatherforecastapi.NewOAuthCCGCredentials(
