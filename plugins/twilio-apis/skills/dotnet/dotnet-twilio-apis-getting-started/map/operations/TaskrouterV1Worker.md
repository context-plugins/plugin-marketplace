...
### CreateWorker
- **HTTP**: `POST /v1/Workspaces/{WorkspaceSid}/Workers` (Default (accounts))
- **Signature**: `CreateWorker(string workspaceSid, ContentType contentType, string friendlyName, string? activitySid, string? attributes, RequestOptions? requestOptions = null, CancellationToken ct = default)`
...
### DeleteWorker
- **HTTP**: `DELETE /v1/Workspaces/{WorkspaceSid}/Workers/{Sid}` (Default (accounts))
...
### FetchWorker
- **HTTP**: `GET /v1/Workspaces/{WorkspaceSid}/Workers/{Sid}` (Default (accounts))
...
### ListWorker
- **HTTP**: `GET /v1/Workspaces/{WorkspaceSid}/Workers` (Default (accounts))
...
### UpdateWorker
- **HTTP**: `POST /v1/Workspaces/{WorkspaceSid}/Workers/{Sid}` (Default (accounts))
- **Signature**: `UpdateWorker(string workspaceSid, string sid, ContentType contentType, string? ifMatch, string? activitySid, string? attributes, string? friendlyName, bool? rejectPendingReservations, RequestOptions? requestOptions = null, CancellationToken ct = default)`
