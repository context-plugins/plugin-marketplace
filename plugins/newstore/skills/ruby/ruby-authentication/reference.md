...
Confirm every name against `lib/newstore/client.rb`, `lib/newstore/configuration.rb`, the
`lib/newstore/http/auth/*.rb` files, and `doc/auth/*.md` in the cloned source.
