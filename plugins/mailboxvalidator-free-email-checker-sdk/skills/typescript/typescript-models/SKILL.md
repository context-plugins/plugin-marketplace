...
```typescript
import { {Union}, {Variant} } from 'mailboxvalidator-free-email-checkerlib';
...
```typescript
import { is{Variant} } from 'mailboxvalidator-free-email-checkerlib';
...
```typescript
import { {EnumType} } from 'mailboxvalidator-free-email-checkerlib';
