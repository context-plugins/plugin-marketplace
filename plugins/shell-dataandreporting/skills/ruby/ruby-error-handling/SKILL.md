...
StandardError
  └── CoreLibrary::ApiException
        └── ShellDataandreporting::APIException          ← base for all HTTP errors
              └── ShellDataandreporting::{OperationError}  ← typed, if generated (in exceptions/)
...
with `.local_error('400', '...message...', ShellDataandreporting::{OperationError})`, and any status without a
