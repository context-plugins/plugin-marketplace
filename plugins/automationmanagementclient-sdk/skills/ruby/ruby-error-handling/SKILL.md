...
StandardError
  └── CoreLibrary::ApiException
        └── AutomationManagementClient::APIException          ← base for all HTTP errors
              └── AutomationManagementClient::{OperationError}  ← typed, if generated (in exceptions/)
...
with `.local_error('400', '...message...', AutomationManagementClient::{OperationError})`, and any status without a
