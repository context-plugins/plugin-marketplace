...
`squareconnectapi/models/` and `squareconnectapi/api_helper.py`.
...
```python
from squareconnectapi.models.o_auth_token import OAuthToken
...
```python
from squareconnectapi.models.animal import Cat
