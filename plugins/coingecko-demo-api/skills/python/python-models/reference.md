...
`coingeckodemoapi/models/` and `coingeckodemoapi/api_helper.py`.
...
```python
from coingeckodemoapi.models.o_auth_token import OAuthToken
...
```python
from coingeckodemoapi.models.animal import Cat
