...
StandardError
  └── CoreLibrary::ApiException
        └── HotelNameAutocomplete::APIException          ← base for all HTTP errors
              └── HotelNameAutocomplete::{OperationError}  ← typed, if generated (in exceptions/)
...
with `.local_error('400', '...message...', HotelNameAutocomplete::{OperationError})`, and any status without a
