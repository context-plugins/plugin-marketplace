...
| Install | `pip install "git+https://github.com/context-plugins/alpaca-python-sdk@main"` |
...
```bash
pip install "git+https://github.com/context-plugins/alpaca-python-sdk@main"
```
...
```bash
# Linux / macOS:
git clone --depth 1 --branch main https://github.com/context-plugins/alpaca-python-sdk /tmp/alpaca-python-src
```

```powershell
# Windows (PowerShell):
git clone --depth 1 --branch main https://github.com/context-plugins/alpaca-python-sdk "$env:TEMP\alpaca-python-src"
```
...
```bash
rm -rf /tmp/alpaca-python-src                               # Linux / macOS
```
```powershell
Remove-Item -Recurse -Force "$env:TEMP\alpaca-python-src"   # Windows
```
