...
`ipgeolocationapi/models/` and `ipgeolocationapi/api_helper.py`.
...
```python
from ipgeolocationapi.models.o_auth_token import OAuthToken
...
```python
from ipgeolocationapi.models.animal import Cat
