...
StandardError
  └── CoreLibrary::ApiException
        └── Authentication::APIException          ← base for all HTTP errors
              └── Authentication::{OperationError}  ← typed, if generated (in exceptions/)
...
with `.local_error('400', '...message...', Authentication::{OperationError})`, and any status without a
