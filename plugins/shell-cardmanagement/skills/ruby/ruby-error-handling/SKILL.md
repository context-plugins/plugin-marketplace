...
StandardError
  └── CoreLibrary::ApiException
        └── ShellCardmanagement::APIException          ← base for all HTTP errors
              └── ShellCardmanagement::{OperationError}  ← typed, if generated (in exceptions/)
...
with `.local_error('400', '...message...', ShellCardmanagement::{OperationError})`, and any status without a
