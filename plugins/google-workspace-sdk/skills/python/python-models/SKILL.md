...
your SDK source (`googleworkspace/models/`).
...
```python
from googleworkspace.api_helper import APIHelper
...
`UnionTypeLookUp` registry (in `googleworkspace/utilities/union_type_lookup.py`) and each candidate model
...
```python
from googleworkspace.models.animal import Cat, Dog
...
```python
from googleworkspace.models.animal import Animal, Cat, Dog
