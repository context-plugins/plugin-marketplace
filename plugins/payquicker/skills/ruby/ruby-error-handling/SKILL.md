...
StandardError
  └── CoreLibrary::ApiException
        └── Payquicker::APIException          ← base for all HTTP errors
              └── Payquicker::{OperationError}  ← typed, if generated (in exceptions/)
...
with `.local_error('400', '...message...', Payquicker::{OperationError})`, and any status without a
