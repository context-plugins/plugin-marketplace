# Twilio APIs SDK Plugin

Integrate and consume the **APIMatic-generated Twilio APIs SDK** (the "APIMATIC v3.0" generic
...
(`dotnet-twilio-apis-getting-started/sdk-map.md` + `map/`) indexing every operation signature,
model, enum, union, and error type. The **`dotnet-integrate-twilio-apis`** router skill routes all
C#/.NET SDK work to the single **`dotnet-twilio-apis-sdk`** agent (.NET-only), which answers
