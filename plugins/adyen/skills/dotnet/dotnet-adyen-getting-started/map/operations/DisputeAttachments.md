...
- **HTTP**: `DELETE /disputes/{disputeId}/attachments/{attachmentId}` (Default (balanceplatform-api-test))
...
- **Error accessors**: `TryGetDisputesAttachments401Error1(out DisputesAttachments401Error1)` [401] · `TryGetDisputesAttachments403Error1(out DisputesAttachments403Error1)` [403] · `TryGetDisputesAttachments422Error1(out DisputesAttachments422Error1)` [422] · `TryGetRawError(out RawError)` [fallback]
- **No-throw variant**: absent
- **Pagination**: none

### GetDisputesDisputeIdAttachments
- **HTTP**: `GET /disputes/{disputeId}/attachments` (Default (balanceplatform-api-test))
...
- **HTTP**: `GET /disputes/{disputeId}/attachments/{attachmentId}` (Default (balanceplatform-api-test))
...
- **HTTP**: `POST /disputes/{disputeId}/attachments` (Default (balanceplatform-api-test))
