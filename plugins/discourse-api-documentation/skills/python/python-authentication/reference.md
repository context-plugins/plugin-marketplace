...
kwarg names are generated per-API — confirm from `discourseapidocumentation/discourseapidocumentation_client.py` and `discourseapidocumentation/http/auth/` in
the cloned source.

## Basic auth

```python
from discourseapidocumentation.http.auth.basic_auth import BasicAuthCredentials
...
```python
from discourseapidocumentation.http.auth.api_key import ApiKeyCredentials
...
```python
from discourseapidocumentation.http.auth.api_header import ApiHeaderCredentials
...
```python
from discourseapidocumentation.http.auth.o_auth_bearer_token import OAuthBearerTokenCredentials
...
```python
from discourseapidocumentation.http.auth.o_auth_ccg import OAuthCCGCredentials
...
```python
from discourseapidocumentation.http.auth.o_auth_acg import OAuthACGCredentials
from discourseapidocumentation.models.o_auth_scope_discourseapidocumentation_enum import OAuthScope{Pkg}Enum
...
```python
from discourseapidocumentation.http.auth.o_auth_ropcg import OAuthROPCGCredentials
...
Grep `from_environment` in `discourseapidocumentation/configuration.py` and each `discourseapidocumentation/http/auth/*.py` for the exact
