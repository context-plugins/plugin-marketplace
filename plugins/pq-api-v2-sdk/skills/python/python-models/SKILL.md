...
your SDK source (`pqapiv2/models/`).
...
`UnionTypeLookUp` registry (in `pqapiv2/utilities/union_type_lookup.py`) and each candidate model
...
```python
from pqapiv2.models.animal import Cat, Dog
...
```python
from pqapiv2.models.animal import Animal, Cat, Dog
