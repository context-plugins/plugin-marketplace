...
> Throughout, `staxfattmerchantapi` and other `{...}` tokens are placeholders for names you take from your SDK —
...
client := staxfattmerchantapi.NewClient(
    staxfattmerchantapi.CreateConfiguration(
        staxfattmerchantapi.WithBasicAuthCredentials(
            staxfattmerchantapi.NewBasicAuthCredentials(
...
staxfattmerchantapi.WithApiKeyCredentials(staxfattmerchantapi.NewApiKeyCredentials("token", "api-key"))

// custom header scheme (often surfaced as ApiHeaderCredentials):
staxfattmerchantapi.WithApiHeaderCredentials(staxfattmerchantapi.NewApiHeaderCredentials("token", "api-key"))
```
...
```go
staxfattmerchantapi.WithOAuthBearerTokenCredentials(
    staxfattmerchantapi.NewOAuthBearerTokenCredentials(os.Getenv("{ACCESS_TOKEN_ENV}")),
)
```
...
client := staxfattmerchantapi.NewClient(
    staxfattmerchantapi.CreateConfiguration(
        staxfattmerchantapi.WithOAuthCCGCredentials(
            staxfattmerchantapi.NewOAuthCCGCredentials(
