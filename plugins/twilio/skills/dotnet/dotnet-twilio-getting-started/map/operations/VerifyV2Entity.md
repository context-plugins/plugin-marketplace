...
### CreateEntity
- **HTTP**: `POST /v2/Services/{ServiceSid}/Entities` (Default3 (verify))
...
### DeleteEntity
- **HTTP**: `DELETE /v2/Services/{ServiceSid}/Entities/{Identity}` (Default3 (verify))
...
### FetchEntity
- **HTTP**: `GET /v2/Services/{ServiceSid}/Entities/{Identity}` (Default3 (verify))
...
### ListEntity
- **HTTP**: `GET /v2/Services/{ServiceSid}/Entities` (Default3 (verify))
