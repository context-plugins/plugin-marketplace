...
Confirm every name against `lib/stax_fattmerchant_api/client.rb`, `lib/stax_fattmerchant_api/configuration.rb`, the
`lib/stax_fattmerchant_api/http/auth/*.rb` files, and `doc/auth/*.md` in the cloned source.
