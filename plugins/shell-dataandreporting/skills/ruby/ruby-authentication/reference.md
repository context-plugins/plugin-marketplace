...
Confirm every name against `lib/shell_dataandreporting/client.rb`, `lib/shell_dataandreporting/configuration.rb`, the
`lib/shell_dataandreporting/http/auth/*.rb` files, and `doc/auth/*.md` in the cloned source.
