...
Confirm every name against `lib/vimeo_api/client.rb`, `lib/vimeo_api/configuration.rb`, the
`lib/vimeo_api/http/auth/*.rb` files, and `doc/auth/*.md` in the cloned source.
