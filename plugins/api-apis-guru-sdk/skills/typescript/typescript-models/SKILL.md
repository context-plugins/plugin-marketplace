...
```typescript
import { {Union}, {Variant} } from 'flight-most-booked-destinationslib';
...
```typescript
import { is{Variant} } from 'flight-most-booked-destinationslib';
...
```typescript
import { {EnumType} } from 'flight-most-booked-destinationslib';
