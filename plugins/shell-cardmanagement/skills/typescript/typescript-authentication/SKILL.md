...
> Throughout this skill, `{...}` is a placeholder for a name you take from your SDK (e.g. `shell-card-management-apislib`, `Configuration`, `{basicAuthProperty}`) — replace it with the concrete identifier from the source.
