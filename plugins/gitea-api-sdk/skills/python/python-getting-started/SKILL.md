...
| Install | `pip install "git+https://github.com/context-plugins/gitea-api-python@main"` |
...
```bash
pip install "git+https://github.com/context-plugins/gitea-api-python@main"
```
...
```bash
# Linux / macOS:
git clone --depth 1 --branch main https://github.com/context-plugins/gitea-api-python /tmp/gitea-api-python-src
```

```powershell
# Windows (PowerShell):
git clone --depth 1 --branch main https://github.com/context-plugins/gitea-api-python "$env:TEMP\gitea-api-python-src"
```
