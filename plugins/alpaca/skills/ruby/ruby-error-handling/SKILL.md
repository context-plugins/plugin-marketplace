...
StandardError
  └── CoreLibrary::ApiException
        └── TraderAPI::APIException          ← base for all HTTP errors
              └── TraderAPI::{OperationError}  ← typed, if generated (in exceptions/)
...
with `.local_error('400', '...message...', TraderAPI::{OperationError})`, and any status without a
