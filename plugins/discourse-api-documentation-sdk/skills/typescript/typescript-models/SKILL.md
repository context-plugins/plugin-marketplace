...
```typescript
import { {Union}, {Variant} } from 'discourse-api-documentationlib';
...
```typescript
import { is{Variant} } from 'discourse-api-documentationlib';
...
```typescript
import { {EnumType} } from 'discourse-api-documentationlib';
