...
```php
$client = new OpenMeteoWeatherForecastAPIClient([
    'environment' => OpenMeteoWeatherForecastAPIClient::ENVIRONMENT_PRODUCTION,  // picks server template
...
$client = new OpenMeteoWeatherForecastAPIClient(['httpClient' => $httpClient, /* ...auth */]);
