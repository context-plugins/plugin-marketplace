...
A plugin whose skills teach a coding agent to install and use the APIMatic-generated **Shutterstock SDK**, in C#/.NET, Python, TypeScript. Every SDK fact the skills state is grounded in the SDK's own source and generated documentation, not in what a model remembers about this API.
