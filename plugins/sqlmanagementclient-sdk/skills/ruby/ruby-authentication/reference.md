...
Confirm every name against `lib/sqlmanagementclient/client.rb`, `lib/sqlmanagementclient/configuration.rb`, the
`lib/sqlmanagementclient/http/auth/*.rb` files, and `doc/auth/*.md` in the cloned source.
