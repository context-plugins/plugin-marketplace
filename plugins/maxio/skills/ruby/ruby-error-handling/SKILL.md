...
StandardError
  └── CoreLibrary::ApiException
        └── Maxio::APIException          ← base for all HTTP errors
              └── Maxio::{OperationError}  ← typed, if generated (in exceptions/)
...
with `.local_error('400', '...message...', Maxio::{OperationError})`, and any status without a
