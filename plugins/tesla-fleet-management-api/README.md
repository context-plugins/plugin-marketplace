...
Integrate and consume the **APIMatic-generated Tesla Fleet Management API SDK** (the "APIMATIC v3.0" generic
...
(`dotnet-tesla-fleet-management-api-getting-started/sdk-map.md` + `map/`) indexing every operation signature,
model, enum, union, and error type. The **`dotnet-integrate-tesla-fleet-management-api`** router skill routes all
C#/.NET SDK work to the single **`dotnet-tesla-fleet-management-api-sdk`** agent (.NET-only), which answers
