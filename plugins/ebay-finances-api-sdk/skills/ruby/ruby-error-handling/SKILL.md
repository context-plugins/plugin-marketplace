...
StandardError
  └── CoreLibrary::ApiException
        └── EBayFinancesAPI::APIException          ← base for all HTTP errors
              └── EBayFinancesAPI::{OperationError}  ← typed, if generated (in exceptions/)
...
with `.local_error('400', '...message...', EBayFinancesAPI::{OperationError})`, and any status without a
