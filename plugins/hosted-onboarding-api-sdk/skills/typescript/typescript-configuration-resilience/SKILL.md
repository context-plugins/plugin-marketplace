...
All config below is passed at construction time via the `HostedOnboardingAPIClientConfig` object.

## Base URL / environment override

```typescript
import { HostedOnboardingAPIClient, Environment } from 'hosted-onboarding-apilib';
