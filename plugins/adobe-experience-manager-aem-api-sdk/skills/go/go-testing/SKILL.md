...
`testing` + `testify/require` for reference; substitute the real `adobeexperiencemanageraemapi` and names.
...
import (
    ...
    "github.com/context-plugins/adobe-experience-manager-aem-api-go"   // root package adobeexperiencemanageraemapi
)
...
func clientReturning(status int, body string) (adobeexperiencemanageraemapi.ClientInterface, *stubTransport) {
    ...
    client := adobeexperiencemanageraemapi.NewClient(
        adobeexperiencemanageraemapi.CreateConfiguration(
            adobeexperiencemanageraemapi.WithHttpConfiguration(
                adobeexperiencemanageraemapi.CreateHttpConfiguration(adobeexperiencemanageraemapi.WithTransport(stub)),
            ),
...
```go
import sdkerrors "github.com/context-plugins/adobe-experience-manager-aem-api-go/errors"
...
client := adobeexperiencemanageraemapi.NewClient(
    adobeexperiencemanageraemapi.CreateConfiguration(
        adobeexperiencemanageraemapi.WithHttpConfiguration(
            adobeexperiencemanageraemapi.CreateHttpConfiguration(adobeexperiencemanageraemapi.WithTransport(redirectTransport{host: target.Host})),
        ),
    ),
)
```
