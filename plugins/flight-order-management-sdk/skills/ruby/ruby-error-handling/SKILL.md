...
StandardError
  └── CoreLibrary::ApiException
        └── FlightOrderManagement::APIException          ← base for all HTTP errors
              └── FlightOrderManagement::{OperationError}  ← typed, if generated (in exceptions/)
...
with `.local_error('400', '...message...', FlightOrderManagement::{OperationError})`, and any status without a
