...
`configurationapi/models/` and `configurationapi/api_helper.py`.
...
```python
from configurationapi.models.o_auth_token import OAuthToken
...
```python
from configurationapi.models.animal import Cat
