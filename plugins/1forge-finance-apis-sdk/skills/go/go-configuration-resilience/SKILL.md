    ...
    1forgefinanceapis.CreateConfiguration(
        1forgefinanceapis.WithHttpConfiguration(
            1forgefinanceapis.CreateHttpConfiguration(
                1forgefinanceapis.WithTimeout(30),
                1forgefinanceapis.WithRetryConfiguration(
                    1forgefinanceapis.CreateRetryConfiguration(
                        1forgefinanceapis.WithMaxRetryAttempts(3),
                        1forgefinanceapis.WithBackoffFactor(2),
                    ),
                ),
            ),
        ),
...
```go
rc := 1forgefinanceapis.CreateRetryConfiguration(
    1forgefinanceapis.WithMaxRetryAttempts(5),
    1forgefinanceapis.WithRetryInterval(1),
    1forgefinanceapis.WithBackoffFactor(2),
    1forgefinanceapis.WithHttpStatusCodesToRetry([]int64{429, 500, 503}),
    1forgefinanceapis.WithHttpMethodsToRetry([]string{"GET", "PUT"}),
)
```
...
client := 1forgefinanceapis.NewClient(
    1forgefinanceapis.CreateConfiguration(
        1forgefinanceapis.WithHttpConfiguration(
            1forgefinanceapis.CreateHttpConfiguration(
                1forgefinanceapis.WithTransport(&loggingTransport{inner: http.DefaultTransport}),
            ),
        ),
    ),
)
