...
Integrate and consume the **APIMatic-generated geoapify SDK** (the "APIMATIC v3.0" generic
...
(`dotnet-geoapify-getting-started/sdk-map.md` + `map/`) indexing every operation signature,
model, enum, union, and error type. The **`dotnet-integrate-geoapify`** router skill routes all
C#/.NET SDK work to the single **`dotnet-geoapify-sdk`** agent (.NET-only), which answers
