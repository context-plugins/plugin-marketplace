...
All config below is passed at construction time via the `AdyenBinLookupAPIClientConfig` object.

## Base URL / environment override

```typescript
import { AdyenBinLookupAPIClient, Environment } from 'adyen-binlookup-apilib';
