...
`flightpriceanalysisapi/models/` and `flightpriceanalysisapi/api_helper.py`.
...
```python
from flightpriceanalysisapi.models.o_auth_token import OAuthToken
...
```python
from flightpriceanalysisapi.models.animal import Cat
