...
| Install | `gem 'api_apis_guru', git: 'https://github.com/context-plugins/api-apis-guru-ruby-832e4b', branch: 'main'` in a Gemfile |
...
```ruby
# In your Gemfile:
gem 'api_apis_guru', git: 'https://github.com/context-plugins/api-apis-guru-ruby-832e4b', branch: 'main'
```
...
```bash
# Linux / macOS:
git clone --depth 1 --branch main https://github.com/context-plugins/api-apis-guru-ruby-832e4b /tmp/api-apis-guru-ruby-src
```

```powershell
# Windows (PowerShell):
git clone --depth 1 --branch main https://github.com/context-plugins/api-apis-guru-ruby-832e4b "$env:TEMP\api-apis-guru-ruby-src"
```
