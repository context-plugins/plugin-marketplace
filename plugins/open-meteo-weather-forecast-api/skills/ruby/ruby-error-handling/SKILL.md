...
StandardError
  └── CoreLibrary::ApiException
        └── OpenMeteoWeatherForecastAPI::APIException          ← base for all HTTP errors
              └── OpenMeteoWeatherForecastAPI::{OperationError}  ← typed, if generated (in exceptions/)
...
with `.local_error('400', '...message...', OpenMeteoWeatherForecastAPI::{OperationError})`, and any status without a
