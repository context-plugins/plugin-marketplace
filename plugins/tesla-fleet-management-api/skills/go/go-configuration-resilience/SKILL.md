    ...
    teslafleetmanagementapi.CreateConfiguration(
        teslafleetmanagementapi.WithHttpConfiguration(
            teslafleetmanagementapi.CreateHttpConfiguration(
                teslafleetmanagementapi.WithTimeout(30),
                teslafleetmanagementapi.WithRetryConfiguration(
                    teslafleetmanagementapi.CreateRetryConfiguration(
                        teslafleetmanagementapi.WithMaxRetryAttempts(3),
                        teslafleetmanagementapi.WithBackoffFactor(2),
                    ),
                ),
            ),
        ),
...
```go
rc := teslafleetmanagementapi.CreateRetryConfiguration(
    teslafleetmanagementapi.WithMaxRetryAttempts(5),
    teslafleetmanagementapi.WithRetryInterval(1),
    teslafleetmanagementapi.WithBackoffFactor(2),
    teslafleetmanagementapi.WithHttpStatusCodesToRetry([]int64{429, 500, 503}),
    teslafleetmanagementapi.WithHttpMethodsToRetry([]string{"GET", "PUT"}),
)
```
...
client := teslafleetmanagementapi.NewClient(
    teslafleetmanagementapi.CreateConfiguration(
        teslafleetmanagementapi.WithHttpConfiguration(
            teslafleetmanagementapi.CreateHttpConfiguration(
                teslafleetmanagementapi.WithTransport(&loggingTransport{inner: http.DefaultTransport}),
            ),
        ),
    ),
)
