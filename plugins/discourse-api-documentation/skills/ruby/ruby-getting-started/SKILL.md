...
| Install | `gem 'discourse_api_documentation', git: 'https://github.com/context-plugins/discourse-api-documentation-ruby-sdk', branch: 'main'` in a Gemfile |
...
- `lib/discourse_api_documentation/controllers/` — one `{Resource}Api` per API resource group, each extending `BaseController`. **This is where operation method signatures and required vs. optional params live.**
...
```ruby
# In your Gemfile:
gem 'discourse_api_documentation', git: 'https://github.com/context-plugins/discourse-api-documentation-ruby-sdk', branch: 'main'
```
...
```bash
# Linux / macOS:
git clone --depth 1 --branch main https://github.com/context-plugins/discourse-api-documentation-ruby-sdk /tmp/discourse-api-documentation-ruby-src
```

```powershell
# Windows (PowerShell):
git clone --depth 1 --branch main https://github.com/context-plugins/discourse-api-documentation-ruby-sdk "$env:TEMP\discourse-api-documentation-ruby-src"
```
