...
your SDK source (`twilioapis/models/`).
...
`UnionTypeLookUp` registry (in `twilioapis/utilities/union_type_lookup.py`) and each candidate model
...
```python
from twilioapis.models.animal import Cat, Dog
...
```python
from twilioapis.models.animal import Animal, Cat, Dog
