...
StandardError
  └── CoreLibrary::ApiException
        └── TravelRecommendationsAPI::APIException          ← base for all HTTP errors
              └── TravelRecommendationsAPI::{OperationError}  ← typed, if generated (in exceptions/)
...
with `.local_error('400', '...message...', TravelRecommendationsAPI::{OperationError})`, and any status without a
