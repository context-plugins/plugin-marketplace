...
git clone --branch main https://github.com/context-plugins/pq-api-v2-csharp
dotnet add reference pq-api-v2-csharp/PqApiV2.csproj
```
...
```bash
# Linux / macOS:
git clone --depth 1 --branch main https://github.com/context-plugins/pq-api-v2-csharp /tmp/pq-api-v2-dotnet-src
```

```powershell
# Windows (PowerShell):
git clone --depth 1 --branch main https://github.com/context-plugins/pq-api-v2-csharp "$env:TEMP\pq-api-v2-dotnet-src"
```
