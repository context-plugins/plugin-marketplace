...
your SDK source (`adyendataprotectionapi/models/`).
...
```python
from adyendataprotectionapi.api_helper import APIHelper
...
`UnionTypeLookUp` registry (in `adyendataprotectionapi/utilities/union_type_lookup.py`) and each candidate model
...
```python
from adyendataprotectionapi.models.animal import Cat, Dog
...
```python
from adyendataprotectionapi.models.animal import Animal, Cat, Dog
