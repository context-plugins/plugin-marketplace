...
```typescript
import { {Union}, {Variant} } from 'adyen-data-protection-apilib';
...
```typescript
import { is{Variant} } from 'adyen-data-protection-apilib';
...
```typescript
import { {EnumType} } from 'adyen-data-protection-apilib';
