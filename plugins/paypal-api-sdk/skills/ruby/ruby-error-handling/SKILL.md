...
StandardError
  └── CoreLibrary::ApiException
        └── PayPalAPI::APIException          ← base for all HTTP errors
              └── PayPalAPI::{OperationError}  ← typed, if generated (in exceptions/)
...
with `.local_error('400', '...message...', PayPalAPI::{OperationError})`, and any status without a
