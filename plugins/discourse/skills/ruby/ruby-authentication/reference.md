...
Confirm every name against `lib/discourse/client.rb`, `lib/discourse/configuration.rb`, the
`lib/discourse/http/auth/*.rb` files, and `doc/auth/*.md` in the cloned source.
