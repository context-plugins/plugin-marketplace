...
Confirm every name against `lib/seatmap_display/client.rb`, `lib/seatmap_display/configuration.rb`, the
`lib/seatmap_display/http/auth/*.rb` files, and `doc/auth/*.md` in the cloned source.
