...
- **HTTP**: `DELETE /registeredDevices/{id}` (Default (balanceplatform-api-test))
...
- **HTTP**: `GET /registeredDevices` (Default (balanceplatform-api-test))
...
- **HTTP**: `PATCH /registeredDevices/{deviceId}/associations` (Default (balanceplatform-api-test))
...
- **HTTP**: `PATCH /registeredDevices/{id}` (Default (balanceplatform-api-test))
...
- **HTTP**: `POST /registeredDevices` (Default (balanceplatform-api-test))
...
- **HTTP**: `POST /registeredDevices/{deviceId}/associations` (Default (balanceplatform-api-test))
