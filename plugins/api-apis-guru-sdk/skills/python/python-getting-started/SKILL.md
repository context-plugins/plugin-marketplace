...
| Install | `pip install "git+https://github.com/context-plugins/api-apis-guru-python-6418e6@main"` |
...
```bash
pip install "git+https://github.com/context-plugins/api-apis-guru-python-6418e6@main"
```
...
```bash
# Linux / macOS:
git clone --depth 1 --branch main https://github.com/context-plugins/api-apis-guru-python-6418e6 /tmp/api-apis-guru-python-src
```

```powershell
# Windows (PowerShell):
git clone --depth 1 --branch main https://github.com/context-plugins/api-apis-guru-python-6418e6 "$env:TEMP\api-apis-guru-python-src"
```
