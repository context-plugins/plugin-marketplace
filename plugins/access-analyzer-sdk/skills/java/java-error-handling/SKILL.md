...
│   └── com.amazonaws.useast1.accessanalyzer.exceptions.ApiException          ← base for all non-2xx API responses
│       └── com.amazonaws.useast1.accessanalyzer.exceptions.{Name}Exception   ← typed subclass with payload fields
...
`getHttpContext()` returns the SDK's `com.amazonaws.useast1.accessanalyzer.http.client.HttpContext`, which carries:
