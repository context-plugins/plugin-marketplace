...
`openmeteoweatherforecastapi/models/` and `openmeteoweatherforecastapi/api_helper.py`.
...
```python
from openmeteoweatherforecastapi.models.o_auth_token import OAuthToken
...
```python
from openmeteoweatherforecastapi.models.animal import Cat
