...
All config below is passed at construction time via the `AuthenticationClientConfig` object.

## Base URL / environment override

```typescript
import { AuthenticationClient, Environment } from 'authenticationlib';
