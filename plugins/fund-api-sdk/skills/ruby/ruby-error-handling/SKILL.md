...
StandardError
  └── CoreLibrary::ApiException
        └── FundAPI::APIException          ← base for all HTTP errors
              └── FundAPI::{OperationError}  ← typed, if generated (in exceptions/)
...
with `.local_error('400', '...message...', FundAPI::{OperationError})`, and any status without a
