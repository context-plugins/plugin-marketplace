...
All config below is passed at construction time via the `AdobeExperienceManagerAEMAPIClientConfig` object.

## Base URL / environment override

```typescript
import { AdobeExperienceManagerAEMAPIClient, Environment } from 'adobe-experience-manager-aem-apilib';
