...
`automationmanagementclient/models/` and `automationmanagementclient/api_helper.py`.
...
```python
from automationmanagementclient.models.o_auth_token import OAuthToken
...
```python
from automationmanagementclient.models.animal import Cat
