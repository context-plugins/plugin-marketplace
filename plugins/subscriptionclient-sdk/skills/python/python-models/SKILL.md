...
your SDK source (`subscriptionclient/models/`).
...
```python
from subscriptionclient.api_helper import APIHelper
...
`UnionTypeLookUp` registry (in `subscriptionclient/utilities/union_type_lookup.py`) and each candidate model
...
```python
from subscriptionclient.models.animal import Cat, Dog
...
```python
from subscriptionclient.models.animal import Animal, Cat, Dog
