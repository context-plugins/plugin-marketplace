...
Confirm every name against `lib/discourse_api_documentation/client.rb`, `lib/discourse_api_documentation/configuration.rb`, the
`lib/discourse_api_documentation/http/auth/*.rb` files, and `doc/auth/*.md` in the cloned source.
