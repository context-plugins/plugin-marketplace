...
StandardError
  └── CoreLibrary::ApiException
        └── FirecrawlAPI::APIException          ← base for all HTTP errors
              └── FirecrawlAPI::{OperationError}  ← typed, if generated (in exceptions/)
...
with `.local_error('400', '...message...', FirecrawlAPI::{OperationError})`, and any status without a
