...
your SDK source (`articlesearchapi/models/`).
...
```python
from articlesearchapi.api_helper import APIHelper
...
`UnionTypeLookUp` registry (in `articlesearchapi/utilities/union_type_lookup.py`) and each candidate model
...
```python
from articlesearchapi.models.animal import Cat, Dog
...
```python
from articlesearchapi.models.animal import Animal, Cat, Dog
