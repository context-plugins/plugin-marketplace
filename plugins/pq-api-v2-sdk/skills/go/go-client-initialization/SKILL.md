...
- `github.com/context-plugins/pq-api-v2-go` — the Go import path for the root package; `github.com/context-plugins/pq-api-v2-go/models` for request/response types.
...
```go
import "github.com/context-plugins/pq-api-v2-go"
