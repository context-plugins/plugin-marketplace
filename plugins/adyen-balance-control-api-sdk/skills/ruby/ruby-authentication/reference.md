...
Confirm every name against `lib/adyen_balance_control_api/client.rb`, `lib/adyen_balance_control_api/configuration.rb`, the
`lib/adyen_balance_control_api/http/auth/*.rb` files, and `doc/auth/*.md` in the cloned source.
