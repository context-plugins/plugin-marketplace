...
- `GiteaAPIClient` — the gateway class (e.g. `APIMATICCalculatorClient`, `MultiAuthSampleClient`).
- `v1.api` — the root Java package (e.g. `io.apimatic.examples`, `localhost3000`).
...
```java
import v1.api.GiteaAPIClient;
import v1.api.Environment;
