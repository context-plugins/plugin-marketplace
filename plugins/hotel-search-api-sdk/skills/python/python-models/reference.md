...
`hotelsearchapi/models/` and `hotelsearchapi/api_helper.py`.
...
```python
from hotelsearchapi.models.o_auth_token import OAuthToken
...
```python
from hotelsearchapi.models.animal import Cat
