...
`travelrecommendationsapi/models/` and `travelrecommendationsapi/api_helper.py`.
...
```python
from travelrecommendationsapi.models.o_auth_token import OAuthToken
...
```python
from travelrecommendationsapi.models.animal import Cat
