...
your SDK source (`3commasio/models/`).
...
```python
from 3commasio.api_helper import APIHelper
...
`UnionTypeLookUp` registry (in `3commasio/utilities/union_type_lookup.py`) and each candidate model
...
```python
from 3commasio.models.animal import Cat, Dog
...
```python
from 3commasio.models.animal import Animal, Cat, Dog
