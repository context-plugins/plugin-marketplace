...
### DeleteDocumentsId
- **HTTP**: `DELETE /documents/{id}` (Default18 (kyc-test))
...
### GetDocumentsId
- **HTTP**: `GET /documents/{id}` (Default18 (kyc-test))
...
### PatchDocumentsId
- **HTTP**: `PATCH /documents/{id}` (Default18 (kyc-test))
...
### PostDocuments
- **HTTP**: `POST /documents` (Default18 (kyc-test))
