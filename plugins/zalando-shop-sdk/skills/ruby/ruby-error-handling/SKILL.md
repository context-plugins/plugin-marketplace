...
StandardError
  └── CoreLibrary::ApiException
        └── ZalandoShop::APIException          ← base for all HTTP errors
              └── ZalandoShop::{OperationError}  ← typed, if generated (in exceptions/)
...
with `.local_error('400', '...message...', ZalandoShop::{OperationError})`, and any status without a
