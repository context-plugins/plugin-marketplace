    ...
    subscriptionclient.CreateConfiguration(
        subscriptionclient.WithHttpConfiguration(
            subscriptionclient.CreateHttpConfiguration(
                subscriptionclient.WithTimeout(30),
                subscriptionclient.WithRetryConfiguration(
                    subscriptionclient.CreateRetryConfiguration(
                        subscriptionclient.WithMaxRetryAttempts(3),
                        subscriptionclient.WithBackoffFactor(2),
                    ),
                ),
            ),
        ),
...
```go
rc := subscriptionclient.CreateRetryConfiguration(
    subscriptionclient.WithMaxRetryAttempts(5),
    subscriptionclient.WithRetryInterval(1),
    subscriptionclient.WithBackoffFactor(2),
    subscriptionclient.WithHttpStatusCodesToRetry([]int64{429, 500, 503}),
    subscriptionclient.WithHttpMethodsToRetry([]string{"GET", "PUT"}),
)
```
...
client := subscriptionclient.NewClient(
    subscriptionclient.CreateConfiguration(
        subscriptionclient.WithHttpConfiguration(
            subscriptionclient.CreateHttpConfiguration(
                subscriptionclient.WithTransport(&loggingTransport{inner: http.DefaultTransport}),
            ),
        ),
    ),
)
