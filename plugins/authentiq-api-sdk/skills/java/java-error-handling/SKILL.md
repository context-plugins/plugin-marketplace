...
│   └── com.appspot.m6dotauthentiqio.exceptions.ApiException          ← base for all non-2xx API responses
│       └── com.appspot.m6dotauthentiqio.exceptions.{Name}Exception   ← typed subclass with payload fields
...
`getHttpContext()` returns the SDK's `com.appspot.m6dotauthentiqio.http.client.HttpContext`, which carries:
