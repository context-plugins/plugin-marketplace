...
- **HTTP**: `GET /paymentLinks/{linkId}` (Default (balanceplatform-api-test))
...
- **HTTP**: `PATCH /paymentLinks/{linkId}` (Default (balanceplatform-api-test))
...
### PostPaymentLinks
- **HTTP**: `POST /paymentLinks` (Default (balanceplatform-api-test))
