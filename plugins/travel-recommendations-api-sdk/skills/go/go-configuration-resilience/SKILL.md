    ...
    travelrecommendationsapi.CreateConfiguration(
        travelrecommendationsapi.WithHttpConfiguration(
            travelrecommendationsapi.CreateHttpConfiguration(
                travelrecommendationsapi.WithTimeout(30),
                travelrecommendationsapi.WithRetryConfiguration(
                    travelrecommendationsapi.CreateRetryConfiguration(
                        travelrecommendationsapi.WithMaxRetryAttempts(3),
                        travelrecommendationsapi.WithBackoffFactor(2),
                    ),
                ),
            ),
        ),
...
```go
rc := travelrecommendationsapi.CreateRetryConfiguration(
    travelrecommendationsapi.WithMaxRetryAttempts(5),
    travelrecommendationsapi.WithRetryInterval(1),
    travelrecommendationsapi.WithBackoffFactor(2),
    travelrecommendationsapi.WithHttpStatusCodesToRetry([]int64{429, 500, 503}),
    travelrecommendationsapi.WithHttpMethodsToRetry([]string{"GET", "PUT"}),
)
```
...
client := travelrecommendationsapi.NewClient(
    travelrecommendationsapi.CreateConfiguration(
        travelrecommendationsapi.WithHttpConfiguration(
            travelrecommendationsapi.CreateHttpConfiguration(
                travelrecommendationsapi.WithTransport(&loggingTransport{inner: http.DefaultTransport}),
            ),
        ),
    ),
)
