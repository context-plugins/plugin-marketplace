...
Confirm every name against `lib/mailboxvalidator_free_email_checker/client.rb`, `lib/mailboxvalidator_free_email_checker/configuration.rb`, the
`lib/mailboxvalidator_free_email_checker/http/auth/*.rb` files, and `doc/auth/*.md` in the cloned source.
