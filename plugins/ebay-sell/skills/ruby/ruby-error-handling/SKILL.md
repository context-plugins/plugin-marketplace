...
StandardError
  └── CoreLibrary::ApiException
        └── EbaySell::APIException          ← base for all HTTP errors
              └── EbaySell::{OperationError}  ← typed, if generated (in exceptions/)
...
with `.local_error('400', '...message...', EbaySell::{OperationError})`, and any status without a
