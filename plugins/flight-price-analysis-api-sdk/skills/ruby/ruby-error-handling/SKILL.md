...
StandardError
  └── CoreLibrary::ApiException
        └── FlightPriceAnalysisAPI::APIException          ← base for all HTTP errors
              └── FlightPriceAnalysisAPI::{OperationError}  ← typed, if generated (in exceptions/)
...
with `.local_error('400', '...message...', FlightPriceAnalysisAPI::{OperationError})`, and any status without a
