...
Confirm every name against `lib/adyen_data_protection_api/client.rb`, `lib/adyen_data_protection_api/configuration.rb`, the
`lib/adyen_data_protection_api/http/auth/*.rb` files, and `doc/auth/*.md` in the cloned source.
