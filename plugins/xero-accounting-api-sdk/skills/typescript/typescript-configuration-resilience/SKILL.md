...
All config below is passed at construction time via the `XeroAccountingAPIClientConfig` object.

## Base URL / environment override

```typescript
import { XeroAccountingAPIClient, Environment } from 'xero-accounting-apilib';
