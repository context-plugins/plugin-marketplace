...
```python
from xapiv2.api_helper import APIHelper
...
`UnionTypeLookUp` registry (in `xapiv2/utilities/union_type_lookup.py`) and each candidate model
...
```python
from xapiv2.models.animal import Cat, Dog
...
```python
from xapiv2.models.animal import Animal, Cat, Dog
