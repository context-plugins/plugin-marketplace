...
your SDK source (`flightoffersprice/models/`).
...
```python
from flightoffersprice.api_helper import APIHelper
...
`UnionTypeLookUp` registry (in `flightoffersprice/utilities/union_type_lookup.py`) and each candidate model
...
```python
from flightoffersprice.models.animal import Cat, Dog
...
```python
from flightoffersprice.models.animal import Animal, Cat, Dog
