    ...
    googlemapsplatform.CreateConfiguration(
        googlemapsplatform.WithHttpConfiguration(
            googlemapsplatform.CreateHttpConfiguration(
                googlemapsplatform.WithTimeout(30),
                googlemapsplatform.WithRetryConfiguration(
                    googlemapsplatform.CreateRetryConfiguration(
                        googlemapsplatform.WithMaxRetryAttempts(3),
                        googlemapsplatform.WithBackoffFactor(2),
                    ),
                ),
            ),
        ),
...
```go
rc := googlemapsplatform.CreateRetryConfiguration(
    googlemapsplatform.WithMaxRetryAttempts(5),
    googlemapsplatform.WithRetryInterval(1),
    googlemapsplatform.WithBackoffFactor(2),
    googlemapsplatform.WithHttpStatusCodesToRetry([]int64{429, 500, 503}),
    googlemapsplatform.WithHttpMethodsToRetry([]string{"GET", "PUT"}),
)
```
...
client := googlemapsplatform.NewClient(
    googlemapsplatform.CreateConfiguration(
        googlemapsplatform.WithHttpConfiguration(
            googlemapsplatform.CreateHttpConfiguration(
                googlemapsplatform.WithTransport(&loggingTransport{inner: http.DefaultTransport}),
            ),
        ),
    ),
)
