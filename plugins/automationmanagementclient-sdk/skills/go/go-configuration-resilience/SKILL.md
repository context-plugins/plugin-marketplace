    ...
    automationmanagementclient.CreateConfiguration(
        automationmanagementclient.WithHttpConfiguration(
            automationmanagementclient.CreateHttpConfiguration(
                automationmanagementclient.WithTimeout(30),
                automationmanagementclient.WithRetryConfiguration(
                    automationmanagementclient.CreateRetryConfiguration(
                        automationmanagementclient.WithMaxRetryAttempts(3),
                        automationmanagementclient.WithBackoffFactor(2),
                    ),
                ),
            ),
        ),
...
```go
rc := automationmanagementclient.CreateRetryConfiguration(
    automationmanagementclient.WithMaxRetryAttempts(5),
    automationmanagementclient.WithRetryInterval(1),
    automationmanagementclient.WithBackoffFactor(2),
    automationmanagementclient.WithHttpStatusCodesToRetry([]int64{429, 500, 503}),
    automationmanagementclient.WithHttpMethodsToRetry([]string{"GET", "PUT"}),
)
```
...
client := automationmanagementclient.NewClient(
    automationmanagementclient.CreateConfiguration(
        automationmanagementclient.WithHttpConfiguration(
            automationmanagementclient.CreateHttpConfiguration(
                automationmanagementclient.WithTransport(&loggingTransport{inner: http.DefaultTransport}),
            ),
        ),
    ),
)
