...
StandardError
  └── CoreLibrary::ApiException
        └── Docker::APIException          ← base for all HTTP errors
              └── Docker::{OperationError}  ← typed, if generated (in exceptions/)
...
with `.local_error('400', '...message...', Docker::{OperationError})`, and any status without a
