...
Integrate and consume the **APIMatic-generated slack SDK** (the "APIMATIC v3.0" generic
...
(`dotnet-slack-getting-started/sdk-map.md` + `map/`) indexing every operation signature,
model, enum, union, and error type. The **`dotnet-integrate-slack`** router skill routes all
C#/.NET SDK work to the single **`dotnet-slack-sdk`** agent (.NET-only), which answers
