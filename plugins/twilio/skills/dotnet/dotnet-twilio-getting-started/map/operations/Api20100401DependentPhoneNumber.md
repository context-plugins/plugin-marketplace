...
Accessor: `client.Api20100401DependentPhoneNumber` · Source: `Api/Api20100401DependentPhoneNumber.cs` · 1 operations

**Parameter names are literal.** Signatures are generated code verbatim — in named arguments use the exact parameter names shown (the cancellation-token parameter is named `ct`).

### ListDependentPhoneNumber
- **HTTP**: `GET /2010-04-01/Accounts/{AccountSid}/Addresses/{AddressSid}/DependentPhoneNumbers.json` (Default (api))
