...
git clone --branch main https://github.com/context-plugins/stax-fattmerchant-api-csharp
dotnet add reference stax-fattmerchant-api-csharp/StaxFattMerchantApi.csproj
```
...
```bash
# Linux / macOS:
git clone --depth 1 --branch main https://github.com/context-plugins/stax-fattmerchant-api-csharp /tmp/stax-fattmerchant-api-dotnet-src
```

```powershell
# Windows (PowerShell):
git clone --depth 1 --branch main https://github.com/context-plugins/stax-fattmerchant-api-csharp "$env:TEMP\stax-fattmerchant-api-dotnet-src"
```
