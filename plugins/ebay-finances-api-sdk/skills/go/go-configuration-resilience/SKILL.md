    ...
    ebayfinancesapi.CreateConfiguration(
        ebayfinancesapi.WithHttpConfiguration(
            ebayfinancesapi.CreateHttpConfiguration(
                ebayfinancesapi.WithTimeout(30),
                ebayfinancesapi.WithRetryConfiguration(
                    ebayfinancesapi.CreateRetryConfiguration(
                        ebayfinancesapi.WithMaxRetryAttempts(3),
                        ebayfinancesapi.WithBackoffFactor(2),
                    ),
                ),
            ),
        ),
...
```go
rc := ebayfinancesapi.CreateRetryConfiguration(
    ebayfinancesapi.WithMaxRetryAttempts(5),
    ebayfinancesapi.WithRetryInterval(1),
    ebayfinancesapi.WithBackoffFactor(2),
    ebayfinancesapi.WithHttpStatusCodesToRetry([]int64{429, 500, 503}),
    ebayfinancesapi.WithHttpMethodsToRetry([]string{"GET", "PUT"}),
)
```
...
client := ebayfinancesapi.NewClient(
    ebayfinancesapi.CreateConfiguration(
        ebayfinancesapi.WithHttpConfiguration(
            ebayfinancesapi.CreateHttpConfiguration(
                ebayfinancesapi.WithTransport(&loggingTransport{inner: http.DefaultTransport}),
            ),
        ),
    ),
)
