...
- **Error accessors**: `TryGetErrorListResponse(out ErrorListResponse)` [404, 422] · `TryGetRawError(out RawError)` [fallback]
- **No-throw variant**: absent
- **Pagination**: none
...
- **Error accessors**: `TryGetObject(out object?)` [404] · `TryGetErrorListResponse(out ErrorListResponse)` [422] · `TryGetRawError(out RawError)` [fallback]
- **No-throw variant**: absent
- **Pagination**: none
...
- **Error accessors**: `TryGetErrorListResponse(out ErrorListResponse)` [404] · `TryGetErrorArrayMapResponse(out ErrorArrayMapResponse)` [422] · `TryGetRawError(out RawError)` [fallback]
- **No-throw variant**: absent
- **Pagination**: none
