...
StandardError
  └── CoreLibrary::ApiException
        └── TesserAPIV1::APIException          ← base for all HTTP errors
              └── TesserAPIV1::{OperationError}  ← typed, if generated (in exceptions/)
...
with `.local_error('400', '...message...', TesserAPIV1::{OperationError})`, and any status without a
