...
> Throughout this skill, `{...}` is a placeholder for a name you take from your SDK (e.g. `{operation}`, `{apiGroup}`, `openuv-global-real-time-uv-index-forecast-apilib`) — replace it with the concrete identifier from the source.
