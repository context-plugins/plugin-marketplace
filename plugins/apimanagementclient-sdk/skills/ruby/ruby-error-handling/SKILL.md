...
StandardError
  └── CoreLibrary::ApiException
        └── ApiManagementClient::APIException          ← base for all HTTP errors
              └── ApiManagementClient::{OperationError}  ← typed, if generated (in exceptions/)
...
with `.local_error('400', '...message...', ApiManagementClient::{OperationError})`, and any status without a
