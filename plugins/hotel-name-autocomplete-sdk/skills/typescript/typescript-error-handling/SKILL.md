...
> Throughout this skill, `{...}` is a placeholder for a name you take from your SDK (e.g. `{operation}`, `{apiGroup}`, `hotel-name-autocompletelib`) — replace it with the concrete identifier from the source.
