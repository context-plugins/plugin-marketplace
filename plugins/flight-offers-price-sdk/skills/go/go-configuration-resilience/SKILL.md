    ...
    flightoffersprice.CreateConfiguration(
        flightoffersprice.WithHttpConfiguration(
            flightoffersprice.CreateHttpConfiguration(
                flightoffersprice.WithTimeout(30),
                flightoffersprice.WithRetryConfiguration(
                    flightoffersprice.CreateRetryConfiguration(
                        flightoffersprice.WithMaxRetryAttempts(3),
                        flightoffersprice.WithBackoffFactor(2),
                    ),
                ),
            ),
        ),
...
```go
rc := flightoffersprice.CreateRetryConfiguration(
    flightoffersprice.WithMaxRetryAttempts(5),
    flightoffersprice.WithRetryInterval(1),
    flightoffersprice.WithBackoffFactor(2),
    flightoffersprice.WithHttpStatusCodesToRetry([]int64{429, 500, 503}),
    flightoffersprice.WithHttpMethodsToRetry([]string{"GET", "PUT"}),
)
```
...
client := flightoffersprice.NewClient(
    flightoffersprice.CreateConfiguration(
        flightoffersprice.WithHttpConfiguration(
            flightoffersprice.CreateHttpConfiguration(
                flightoffersprice.WithTransport(&loggingTransport{inner: http.DefaultTransport}),
            ),
        ),
    ),
)
