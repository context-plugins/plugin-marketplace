    ...
    adyenbalancecontrolapi.CreateConfiguration(
        adyenbalancecontrolapi.WithHttpConfiguration(
            adyenbalancecontrolapi.CreateHttpConfiguration(
                adyenbalancecontrolapi.WithTimeout(30),
                adyenbalancecontrolapi.WithRetryConfiguration(
                    adyenbalancecontrolapi.CreateRetryConfiguration(
                        adyenbalancecontrolapi.WithMaxRetryAttempts(3),
                        adyenbalancecontrolapi.WithBackoffFactor(2),
                    ),
                ),
            ),
        ),
...
```go
rc := adyenbalancecontrolapi.CreateRetryConfiguration(
    adyenbalancecontrolapi.WithMaxRetryAttempts(5),
    adyenbalancecontrolapi.WithRetryInterval(1),
    adyenbalancecontrolapi.WithBackoffFactor(2),
    adyenbalancecontrolapi.WithHttpStatusCodesToRetry([]int64{429, 500, 503}),
    adyenbalancecontrolapi.WithHttpMethodsToRetry([]string{"GET", "PUT"}),
)
```
...
client := adyenbalancecontrolapi.NewClient(
    adyenbalancecontrolapi.CreateConfiguration(
        adyenbalancecontrolapi.WithHttpConfiguration(
            adyenbalancecontrolapi.CreateHttpConfiguration(
                adyenbalancecontrolapi.WithTransport(&loggingTransport{inner: http.DefaultTransport}),
            ),
        ),
    ),
)
