...
- **HTTP**: `POST /adjustAuthorisation` (Default1 (pal-test))
...
### PostCancel
- **HTTP**: `POST /cancel` (Default1 (pal-test))
...
### PostCancelOrRefund
- **HTTP**: `POST /cancelOrRefund` (Default1 (pal-test))
...
### PostCancels
- **HTTP**: `POST /cancels` (Default (checkout-test))
...
### PostCapture
- **HTTP**: `POST /capture` (Default1 (pal-test))
...
### PostDonate
- **HTTP**: `POST /donate` (Default1 (pal-test))
...
- **HTTP**: `POST /payments/{paymentPspReference}/amountUpdates` (Default (checkout-test))
...
- **HTTP**: `POST /payments/{paymentPspReference}/cancels` (Default (checkout-test))
...
- **HTTP**: `POST /payments/{paymentPspReference}/captures` (Default (checkout-test))
...
- **HTTP**: `POST /payments/{paymentPspReference}/refunds` (Default (checkout-test))
...
- **HTTP**: `POST /payments/{paymentPspReference}/reversals` (Default (checkout-test))
...
### PostRefund
- **HTTP**: `POST /refund` (Default1 (pal-test))
...
### PostTechnicalCancel
- **HTTP**: `POST /technicalCancel` (Default1 (pal-test))
...
- **HTTP**: `POST /voidPendingRefund` (Default1 (pal-test))
