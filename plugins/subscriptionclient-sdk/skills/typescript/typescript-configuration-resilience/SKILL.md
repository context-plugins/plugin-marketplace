...
All config below is passed at construction time via the `SubscriptionClientClientConfig` object.

## Base URL / environment override

```typescript
import { SubscriptionClientClient, Environment } from 'subscriptionclientlib';
