...
StandardError
  └── CoreLibrary::ApiException
        └── PokeApi::APIException          ← base for all HTTP errors
              └── PokeApi::{OperationError}  ← typed, if generated (in exceptions/)
...
with `.local_error('400', '...message...', PokeApi::{OperationError})`, and any status without a
