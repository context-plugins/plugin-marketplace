...
StandardError
  └── CoreLibrary::ApiException
        └── SplititWebApiV3::APIException          ← base for all HTTP errors
              └── SplititWebApiV3::{OperationError}  ← typed, if generated (in exceptions/)
...
with `.local_error('400', '...message...', SplititWebApiV3::{OperationError})`, and any status without a
