...
Confirm every name against `lib/shell_digitalpayments/client.rb`, `lib/shell_digitalpayments/configuration.rb`, the
`lib/shell_digitalpayments/http/auth/*.rb` files, and `doc/auth/*.md` in the cloned source.
