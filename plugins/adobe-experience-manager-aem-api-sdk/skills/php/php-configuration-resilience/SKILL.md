...
```php
$client = new AdobeExperienceManagerAEMAPIClient([
    'environment' => AdobeExperienceManagerAEMAPIClient::ENVIRONMENT_PRODUCTION,  // picks server template
...
$client = new AdobeExperienceManagerAEMAPIClient(['httpClient' => $httpClient, /* ...auth */]);
