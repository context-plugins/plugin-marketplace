...
| Install | `pip install "git+https://github.com/context-plugins/vimeo-api-python@main"` |
...
- `vimeoapi/controllers/` — one `{Resource}Controller` per API resource group, all inheriting from
...
```bash
pip install "git+https://github.com/context-plugins/vimeo-api-python@main"
```
...
```bash
# Linux / macOS:
git clone --depth 1 --branch main https://github.com/context-plugins/vimeo-api-python /tmp/vimeo-api-python-src
```

```powershell
# Windows (PowerShell):
git clone --depth 1 --branch main https://github.com/context-plugins/vimeo-api-python "$env:TEMP\vimeo-api-python-src"
```
