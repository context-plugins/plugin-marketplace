...
StandardError
  └── CoreLibrary::ApiException
        └── SpotifyWebAPI::APIException          ← base for all HTTP errors
              └── SpotifyWebAPI::{OperationError}  ← typed, if generated (in exceptions/)
...
with `.local_error('400', '...message...', SpotifyWebAPI::{OperationError})`, and any status without a
