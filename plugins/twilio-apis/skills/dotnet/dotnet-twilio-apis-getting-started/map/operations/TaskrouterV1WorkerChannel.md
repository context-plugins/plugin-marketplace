...
### FetchWorkerChannel
- **HTTP**: `GET /v1/Workspaces/{WorkspaceSid}/Workers/{WorkerSid}/Channels/{Sid}` (Default (accounts))
...
### ListWorkerChannel
- **HTTP**: `GET /v1/Workspaces/{WorkspaceSid}/Workers/{WorkerSid}/Channels` (Default (accounts))
...
### UpdateWorkerChannel
- **HTTP**: `POST /v1/Workspaces/{WorkspaceSid}/Workers/{WorkerSid}/Channels/{Sid}` (Default (accounts))
- **Signature**: `UpdateWorkerChannel(string workspaceSid, string workerSid, string sid, ContentType contentType, int? capacity, bool? available, RequestOptions? requestOptions = null, CancellationToken ct = default)`
