...
All config below is passed at construction time via the `SquareConnectAPIClientConfig` object.

## Base URL / environment override

```typescript
import { SquareConnectAPIClient, Environment } from 'square-connect-apilib';
