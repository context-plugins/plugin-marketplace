...
| Install | `pip install "git+https://github.com/context-plugins/the-plaid-api-python@main"` |
...
```bash
pip install "git+https://github.com/context-plugins/the-plaid-api-python@main"
```
...
```bash
# Linux / macOS:
git clone --depth 1 --branch main https://github.com/context-plugins/the-plaid-api-python /tmp/the-plaid-api-python-src
```

```powershell
# Windows (PowerShell):
git clone --depth 1 --branch main https://github.com/context-plugins/the-plaid-api-python "$env:TEMP\the-plaid-api-python-src"
```
