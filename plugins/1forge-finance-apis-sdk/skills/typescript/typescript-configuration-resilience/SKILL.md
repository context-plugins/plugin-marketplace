...
All config below is passed at construction time via the `1ForgeFinanceAPIsClientConfig` object.

## Base URL / environment override

```typescript
import { 1ForgeFinanceAPIsClient, Environment } from 'm1-forge-finance-apislib';
