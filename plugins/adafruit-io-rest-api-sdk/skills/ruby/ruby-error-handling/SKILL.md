...
StandardError
  └── CoreLibrary::ApiException
        └── AdafruitIORESTAPI::APIException          ← base for all HTTP errors
              └── AdafruitIORESTAPI::{OperationError}  ← typed, if generated (in exceptions/)
...
with `.local_error('400', '...message...', AdafruitIORESTAPI::{OperationError})`, and any status without a
