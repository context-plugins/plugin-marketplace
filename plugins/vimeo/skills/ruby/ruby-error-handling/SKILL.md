...
StandardError
  └── CoreLibrary::ApiException
        └── VimeoAPI::APIException          ← base for all HTTP errors
              └── VimeoAPI::{OperationError}  ← typed, if generated (in exceptions/)
...
with `.local_error('400', '...message...', VimeoAPI::{OperationError})`, and any status without a
