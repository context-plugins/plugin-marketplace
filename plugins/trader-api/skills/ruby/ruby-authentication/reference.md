...
Confirm every name against `lib/trader_api/client.rb`, `lib/trader_api/configuration.rb`, the
`lib/trader_api/http/auth/*.rb` files, and `doc/auth/*.md` in the cloned source.
