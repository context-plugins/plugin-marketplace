...
`xeroaccountingapi/models/` and `xeroaccountingapi/api_helper.py`.
...
```python
from xeroaccountingapi.models.o_auth_token import OAuthToken
...
```python
from xeroaccountingapi.models.animal import Cat
