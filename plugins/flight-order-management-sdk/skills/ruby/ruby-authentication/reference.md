...
Confirm every name against `lib/flight_order_management/client.rb`, `lib/flight_order_management/configuration.rb`, the
`lib/flight_order_management/http/auth/*.rb` files, and `doc/auth/*.md` in the cloned source.
