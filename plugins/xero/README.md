...
Integrate and consume the **APIMatic-generated Xero SDK** (the "APIMATIC v3.0" generic
...
(`dotnet-xero-getting-started/sdk-map.md` + `map/`) indexing every operation signature,
model, enum, union, and error type. The **`dotnet-integrate-xero`** router skill routes all
C#/.NET SDK work to the single **`dotnet-xero-sdk`** agent (.NET-only), which answers
