...
your SDK source (`flightpriceanalysisapi/models/`).
...
```python
from flightpriceanalysisapi.api_helper import APIHelper
...
`UnionTypeLookUp` registry (in `flightpriceanalysisapi/utilities/union_type_lookup.py`) and each candidate model
...
```python
from flightpriceanalysisapi.models.animal import Cat, Dog
...
```python
from flightpriceanalysisapi.models.animal import Animal, Cat, Dog
