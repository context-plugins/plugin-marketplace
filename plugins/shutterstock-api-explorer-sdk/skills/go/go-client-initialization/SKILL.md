...
- `github.com/context-plugins/shutterstock-api-explorer-go` — the Go import path for the root package; `github.com/context-plugins/shutterstock-api-explorer-go/models` for request/response types.
...
```go
import "github.com/context-plugins/shutterstock-api-explorer-go"
