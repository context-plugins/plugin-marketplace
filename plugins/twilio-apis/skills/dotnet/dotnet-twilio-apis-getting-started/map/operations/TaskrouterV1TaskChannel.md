...
### CreateTaskChannel
- **HTTP**: `POST /v1/Workspaces/{WorkspaceSid}/TaskChannels` (Default (accounts))
- **Notes**: Types of tasks
- **Signature**: `CreateTaskChannel(string workspaceSid, ContentType contentType, string friendlyName, string uniqueName, bool? channelOptimizedRouting, RequestOptions? requestOptions = null, CancellationToken ct = default)`
...
### DeleteTaskChannel
- **HTTP**: `DELETE /v1/Workspaces/{WorkspaceSid}/TaskChannels/{Sid}` (Default (accounts))
- **Notes**: Types of tasks
...
### FetchTaskChannel
- **HTTP**: `GET /v1/Workspaces/{WorkspaceSid}/TaskChannels/{Sid}` (Default (accounts))
- **Notes**: Types of tasks
...
### ListTaskChannel
- **HTTP**: `GET /v1/Workspaces/{WorkspaceSid}/TaskChannels` (Default (accounts))
- **Notes**: Types of tasks
...
### UpdateTaskChannel
- **HTTP**: `POST /v1/Workspaces/{WorkspaceSid}/TaskChannels/{Sid}` (Default (accounts))
- **Notes**: Types of tasks
- **Signature**: `UpdateTaskChannel(string workspaceSid, string sid, ContentType contentType, string? friendlyName, bool? channelOptimizedRouting, RequestOptions? requestOptions = null, CancellationToken ct = default)`
