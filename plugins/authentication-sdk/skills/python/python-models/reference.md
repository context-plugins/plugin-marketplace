...
`authentication/models/` and `authentication/api_helper.py`.
...
```python
from authentication.models.o_auth_token import OAuthToken
...
```python
from authentication.models.animal import Cat
