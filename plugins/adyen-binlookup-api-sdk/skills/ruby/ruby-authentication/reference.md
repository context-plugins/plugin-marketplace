...
Confirm every name against `lib/adyen_binlookup_api/client.rb`, `lib/adyen_binlookup_api/configuration.rb`, the
`lib/adyen_binlookup_api/http/auth/*.rb` files, and `doc/auth/*.md` in the cloned source.
