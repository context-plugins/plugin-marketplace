...
Confirm every name against `lib/spotify_web_api_with_fixes_and_improvements_from_sonallux/client.rb`, `lib/spotify_web_api_with_fixes_and_improvements_from_sonallux/configuration.rb`, the
`lib/spotify_web_api_with_fixes_and_improvements_from_sonallux/http/auth/*.rb` files, and `doc/auth/*.md` in the cloned source.
