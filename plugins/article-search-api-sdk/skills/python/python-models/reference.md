...
`articlesearchapi/models/` and `articlesearchapi/api_helper.py`.
...
```python
from articlesearchapi.models.o_auth_token import OAuthToken
...
```python
from articlesearchapi.models.animal import Cat
