...
| Install | `pip install "git+https://github.com/context-plugins/nytimes-python-sdk@main"` |
...
```bash
pip install "git+https://github.com/context-plugins/nytimes-python-sdk@main"
```
...
```bash
# Linux / macOS:
git clone --depth 1 --branch main https://github.com/context-plugins/nytimes-python-sdk /tmp/nytimes-python-src
```

```powershell
# Windows (PowerShell):
git clone --depth 1 --branch main https://github.com/context-plugins/nytimes-python-sdk "$env:TEMP\nytimes-python-src"
```
...
```bash
rm -rf /tmp/nytimes-python-src                               # Linux / macOS
```
```powershell
Remove-Item -Recurse -Force "$env:TEMP\nytimes-python-src"   # Windows
```
