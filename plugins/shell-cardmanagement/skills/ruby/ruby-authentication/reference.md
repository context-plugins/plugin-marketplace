...
Confirm every name against `lib/shell_cardmanagement/client.rb`, `lib/shell_cardmanagement/configuration.rb`, the
`lib/shell_cardmanagement/http/auth/*.rb` files, and `doc/auth/*.md` in the cloned source.
