...
StandardError
  └── CoreLibrary::ApiException
        └── SubscriptionClient::APIException          ← base for all HTTP errors
              └── SubscriptionClient::{OperationError}  ← typed, if generated (in exceptions/)
...
with `.local_error('400', '...message...', SubscriptionClient::{OperationError})`, and any status without a
