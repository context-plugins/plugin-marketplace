...
All config below is passed at construction time via the `CoinGeckoDemoAPIClientConfig` object.

## Base URL / environment override

```typescript
import { CoinGeckoDemoAPIClient, Environment } from 'coingecko-demo-apilib';
