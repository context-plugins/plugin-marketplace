...
Confirm every name against `lib/open_meteo_weather_forecast_api/client.rb`, `lib/open_meteo_weather_forecast_api/configuration.rb`, the
`lib/open_meteo_weather_forecast_api/http/auth/*.rb` files, and `doc/auth/*.md` in the cloned source.
