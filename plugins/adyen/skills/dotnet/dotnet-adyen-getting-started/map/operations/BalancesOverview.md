...
- **HTTP**: `GET /balanceOverview/companies/{companyAccountCode}/balances` (Default (balanceplatform-api-test))
...
- **Error accessors**: `TryGetBalanceOverviewCompaniesBalances401Error1(out BalanceOverviewCompaniesBalances401Error1)` [401] · `TryGetBalanceOverviewCompaniesBalances403Error1(out BalanceOverviewCompaniesBalances403Error1)` [403] · `TryGetBalanceOverviewCompaniesBalances422Error1(out BalanceOverviewCompaniesBalances422Error1)` [422] · `TryGetRawError(out RawError)` [fallback]
- **No-throw variant**: absent
- **Pagination**: none

### GetBalanceOverviewMerchantsMerchantAccountCodeBalances
- **HTTP**: `GET /balanceOverview/merchants/{merchantAccountCode}/balances` (Default (balanceplatform-api-test))
...
- **Error accessors**: `TryGetBalanceOverviewMerchantsBalances401Error1(out BalanceOverviewMerchantsBalances401Error1)` [401] · `TryGetBalanceOverviewMerchantsBalances403Error1(out BalanceOverviewMerchantsBalances403Error1)` [403] · `TryGetBalanceOverviewMerchantsBalances422Error1(out BalanceOverviewMerchantsBalances422Error1)` [422] · `TryGetRawError(out RawError)` [fallback]
- **No-throw variant**: absent
- **Pagination**: none
