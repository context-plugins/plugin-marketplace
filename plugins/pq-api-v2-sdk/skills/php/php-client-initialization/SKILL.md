...
- `PQAPIV2Client` — the single public client class (e.g. `FooClient`).
- `PayQuickerSDKLib` — the SDK's root namespace used in `use` directives.
...
```php
use PayQuickerSDKLib\PQAPIV2Client;
