...
`shutterstockapiexplorer/models/` and `shutterstockapiexplorer/api_helper.py`.
...
```python
from shutterstockapiexplorer.models.o_auth_token import OAuthToken
...
```python
from shutterstockapiexplorer.models.animal import Cat
