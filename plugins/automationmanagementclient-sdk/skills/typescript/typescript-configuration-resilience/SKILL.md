...
All config below is passed at construction time via the `AutomationManagementClientClientConfig` object.

## Base URL / environment override

```typescript
import { AutomationManagementClientClient, Environment } from '{RootModule}';
