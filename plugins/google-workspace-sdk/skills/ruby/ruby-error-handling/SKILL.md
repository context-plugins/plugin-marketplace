...
StandardError
  └── CoreLibrary::ApiException
        └── GoogleWorkspace::APIException          ← base for all HTTP errors
              └── GoogleWorkspace::{OperationError}  ← typed, if generated (in exceptions/)
...
with `.local_error('400', '...message...', GoogleWorkspace::{OperationError})`, and any status without a
