...
1. Open `OpenUVGlobalRealTimeUVIndexForecastAPIClientConfig` and list its optional credentials properties — this is the **source of truth** for what the SDK accepts.
