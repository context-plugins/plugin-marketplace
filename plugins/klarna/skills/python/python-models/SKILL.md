...
`UnionTypeLookUp` registry (in `klarna/utilities/union_type_lookup.py`) and each candidate model
...
```python
from klarna.models.animal import Cat, Dog
...
```python
from klarna.models.animal import Animal, Cat, Dog
