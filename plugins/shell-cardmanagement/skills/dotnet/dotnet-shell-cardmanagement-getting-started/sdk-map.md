# SDK map — shell-cardmanagement (.NET)
...
| | |
|---|---|
| SDK display name | shell-cardmanagement |
| Root namespace/module | `ShellCardManagementApis` |
<!-- gen:stamp -->
| Target framework(s) | `netstandard2.0` (C# `LangVersion 14`, `Nullable enable`) |
| Source commit (spec stamp) | `0740872` (`074087218f36e14a0f288d05ffaa7d1f87101649`, tagged `0740872`) |
<!-- /gen:stamp -->
| Generator | APIMatic |
| Repo | https://github.com/context-plugins/shell-cardmanagement-csharp-sdk (branch `main`) |
...
```csharp
using ShellCardManagementApis;
using ShellCardManagementApis.Servers; // ServerEnvironment lives here

var options = new ShellCardManagementApisClientOptions
{
...
var client = new ShellCardManagementApisClient(httpClient, options); // httpClient: System.Net.Http.HttpClient
```

DI alternative (`ServiceCollectionExtensions.cs`):

```csharp
services.AddShellCardManagementApisClient(o =>
{
...
`ShellCardManagementApisClient.cs`.

<!-- crawler:client-options -->
All `ShellCardManagementApisClientOptions` properties (source: `ShellCardManagementApisClientOptions.cs`):
...
- `ShellCardManagementApisClient(HttpClient httpClient, ShellCardManagementApisClientOptions options)`
<!-- /crawler:client-options -->
...
## Operations — by controller (3 groups, 33 operations)
...
|---|---:|---|
| `CardApi` | 15 | [map/operations/CardApi.md](map/operations/CardApi.md) |
| `Customer` | 9 | [map/operations/Customer.md](map/operations/Customer.md) |
| `RestrictionApi` | 9 | [map/operations/RestrictionApi.md](map/operations/RestrictionApi.md) |
<!-- /crawler:ops-table -->
...
| Group | Count | Page |
|---|---:|---|
| Records (plain `record` data models) | 178 | [`AccountAccess` … `LoggedInUserRes`](map/models/records-1-Ac-Lo.md) · [`LoggedInUserResponse` … `Warning`](map/models/records-2-Lo-Wa.md) |
| Unions (`OneOf` / `AnyOf`) — variant factories + `TryGet…` | 0 + 0 | [map/models/unions.md](map/models/unions.md) |
| Enums (`StringEnum<T>` / `IntEnum<T>`) — literal C# member names + wire values | 8 | [map/models/enums.md](map/models/enums.md) |
<!-- /gen:models-table -->
...
|---|---|
| Client & options (root) | `ShellCardManagementApis` |
| Operation controllers (`Api/`) | `ShellCardManagementApis.Api` |
| Records (`Models/`) | `ShellCardManagementApis.Models` |
| Enums (`Models/Enums/`) | `ShellCardManagementApis.Models.Enums` |
| Error classes (`Errors/`) | `ShellCardManagementApis.Errors` |
<!-- /gen:namespaces -->
...
**Auth.** The scheme(s) this API uses surface as credentials properties on `ShellCardManagementApisClientOptions` (source: `ShellCardManagementApisClientOptions.cs`) — set them before constructing the client; load `dotnet-authentication` for the wiring:
