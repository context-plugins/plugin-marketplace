    ...
    adobeexperiencemanageraemapi.CreateConfiguration(
        adobeexperiencemanageraemapi.WithHttpConfiguration(
            adobeexperiencemanageraemapi.CreateHttpConfiguration(
                adobeexperiencemanageraemapi.WithTimeout(30),
                adobeexperiencemanageraemapi.WithRetryConfiguration(
                    adobeexperiencemanageraemapi.CreateRetryConfiguration(
                        adobeexperiencemanageraemapi.WithMaxRetryAttempts(3),
                        adobeexperiencemanageraemapi.WithBackoffFactor(2),
                    ),
                ),
            ),
        ),
...
```go
rc := adobeexperiencemanageraemapi.CreateRetryConfiguration(
    adobeexperiencemanageraemapi.WithMaxRetryAttempts(5),
    adobeexperiencemanageraemapi.WithRetryInterval(1),
    adobeexperiencemanageraemapi.WithBackoffFactor(2),
    adobeexperiencemanageraemapi.WithHttpStatusCodesToRetry([]int64{429, 500, 503}),
    adobeexperiencemanageraemapi.WithHttpMethodsToRetry([]string{"GET", "PUT"}),
)
```
...
client := adobeexperiencemanageraemapi.NewClient(
    adobeexperiencemanageraemapi.CreateConfiguration(
        adobeexperiencemanageraemapi.WithHttpConfiguration(
            adobeexperiencemanageraemapi.CreateHttpConfiguration(
                adobeexperiencemanageraemapi.WithTransport(&loggingTransport{inner: http.DefaultTransport}),
            ),
        ),
    ),
)
