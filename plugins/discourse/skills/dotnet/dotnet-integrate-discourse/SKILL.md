...
- **Do not web-search Discourse for an implementation detail** — the map and the pinned source are the ground truth for THIS SDK version, and `Discourse` is what the generated source declares, not what public docs describe.
