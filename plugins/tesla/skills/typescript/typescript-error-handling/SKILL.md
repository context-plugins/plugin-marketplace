...
> Throughout this skill, `{...}` is a placeholder for a name you take from your SDK (e.g. `{operation}`, `{apiGroup}`, `tesla-fleet-management-apilib`) — replace it with the concrete identifier from the source.
...
```typescript
import { Client } from 'tesla-fleet-management-apilib';
import { ApiError } from 'tesla-fleet-management-apilib';
import { {Operation}Error } from 'tesla-fleet-management-apilib/errors';
