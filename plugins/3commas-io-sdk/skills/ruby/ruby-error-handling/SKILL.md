...
StandardError
  └── CoreLibrary::ApiException
        └── 3commasIo::APIException          ← base for all HTTP errors
              └── 3commasIo::{OperationError}  ← typed, if generated (in exceptions/)
...
with `.local_error('400', '...message...', 3commasIo::{OperationError})`, and any status without a
