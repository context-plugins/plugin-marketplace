...
### CreateChallenge
- **HTTP**: `POST /v2/Services/{ServiceSid}/Entities/{Identity}/Challenges` (Default3 (verify))
...
### FetchChallenge
- **HTTP**: `GET /v2/Services/{ServiceSid}/Entities/{Identity}/Challenges/{Sid}` (Default3 (verify))
...
### ListChallenge
- **HTTP**: `GET /v2/Services/{ServiceSid}/Entities/{Identity}/Challenges` (Default3 (verify))
...
### UpdateChallenge
- **HTTP**: `POST /v2/Services/{ServiceSid}/Entities/{Identity}/Challenges/{Sid}` (Default3 (verify))
