...
your SDK source (`xeroaccountingapi/models/`).
...
```python
from xeroaccountingapi.api_helper import APIHelper
...
`UnionTypeLookUp` registry (in `xeroaccountingapi/utilities/union_type_lookup.py`) and each candidate model
...
```python
from xeroaccountingapi.models.animal import Cat, Dog
...
```python
from xeroaccountingapi.models.animal import Animal, Cat, Dog
