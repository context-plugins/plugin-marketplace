...
- `github.com/context-plugins/xero-go-sdk` — the Go import path for the root package; `github.com/context-plugins/xero-go-sdk/models` for request/response types.
...
```go
import "github.com/context-plugins/xero-go-sdk"
