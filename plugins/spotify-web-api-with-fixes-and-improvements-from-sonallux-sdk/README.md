# Spotify Web API with fixes and improvements from sonallux SDK Plugin

Integrate and consume the **APIMatic-generated Spotify Web API with fixes and improvements from sonallux SDK** (the "APIMATIC v3.0" generic
libraries, built on `apimatic-*-core` / `apimatic/*-core-runtime` runtimes) across TypeScript, Java, PHP, Python, Ruby, Go.
