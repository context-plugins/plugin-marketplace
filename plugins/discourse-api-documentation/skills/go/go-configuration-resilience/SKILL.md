    ...
    discourseapidocumentation.CreateConfiguration(
        discourseapidocumentation.WithHttpConfiguration(
            discourseapidocumentation.CreateHttpConfiguration(
                discourseapidocumentation.WithTimeout(30),
                discourseapidocumentation.WithRetryConfiguration(
                    discourseapidocumentation.CreateRetryConfiguration(
                        discourseapidocumentation.WithMaxRetryAttempts(3),
                        discourseapidocumentation.WithBackoffFactor(2),
                    ),
                ),
            ),
        ),
...
```go
rc := discourseapidocumentation.CreateRetryConfiguration(
    discourseapidocumentation.WithMaxRetryAttempts(5),
    discourseapidocumentation.WithRetryInterval(1),
    discourseapidocumentation.WithBackoffFactor(2),
    discourseapidocumentation.WithHttpStatusCodesToRetry([]int64{429, 500, 503}),
    discourseapidocumentation.WithHttpMethodsToRetry([]string{"GET", "PUT"}),
)
```
...
client := discourseapidocumentation.NewClient(
    discourseapidocumentation.CreateConfiguration(
        discourseapidocumentation.WithHttpConfiguration(
            discourseapidocumentation.CreateHttpConfiguration(
                discourseapidocumentation.WithTransport(&loggingTransport{inner: http.DefaultTransport}),
            ),
        ),
    ),
)
