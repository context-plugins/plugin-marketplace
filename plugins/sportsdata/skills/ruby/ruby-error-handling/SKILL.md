...
StandardError
  └── CoreLibrary::ApiException
        └── Sportsdata::APIException          ← base for all HTTP errors
              └── Sportsdata::{OperationError}  ← typed, if generated (in exceptions/)
...
with `.local_error('400', '...message...', Sportsdata::{OperationError})`, and any status without a
