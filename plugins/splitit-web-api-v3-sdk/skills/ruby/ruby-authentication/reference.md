...
Confirm every name against `lib/splitit_web_api_v3/client.rb`, `lib/splitit_web_api_v3/configuration.rb`, the
`lib/splitit_web_api_v3/http/auth/*.rb` files, and `doc/auth/*.md` in the cloned source.
