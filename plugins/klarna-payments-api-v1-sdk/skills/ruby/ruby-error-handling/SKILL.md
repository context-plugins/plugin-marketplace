...
StandardError
  └── CoreLibrary::ApiException
        └── KlarnaPaymentsAPIV1::APIException          ← base for all HTTP errors
              └── KlarnaPaymentsAPIV1::{OperationError}  ← typed, if generated (in exceptions/)
...
with `.local_error('400', '...message...', KlarnaPaymentsAPIV1::{OperationError})`, and any status without a
