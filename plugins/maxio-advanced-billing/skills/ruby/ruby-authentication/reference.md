...
Confirm every name against `lib/maxio_advanced_billing/client.rb`, `lib/maxio_advanced_billing/configuration.rb`, the
`lib/maxio_advanced_billing/http/auth/*.rb` files, and `doc/auth/*.md` in the cloned source.
