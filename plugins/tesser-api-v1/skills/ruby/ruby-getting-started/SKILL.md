...
| Install | `gem 'tesser_api_v1', git: 'https://github.com/context-plugins/tesser-api-v1-ruby-sdk', branch: 'main'` in a Gemfile |
...
- `lib/tesser_api_v1/controllers/` — one `{Resource}Api` per API resource group, each extending `BaseController`. **This is where operation method signatures and required vs. optional params live.**
...
```ruby
# In your Gemfile:
gem 'tesser_api_v1', git: 'https://github.com/context-plugins/tesser-api-v1-ruby-sdk', branch: 'main'
```
...
```bash
# Linux / macOS:
git clone --depth 1 --branch main https://github.com/context-plugins/tesser-api-v1-ruby-sdk /tmp/tesser-api-v1-ruby-src
```

```powershell
# Windows (PowerShell):
git clone --depth 1 --branch main https://github.com/context-plugins/tesser-api-v1-ruby-sdk "$env:TEMP\tesser-api-v1-ruby-src"
```
