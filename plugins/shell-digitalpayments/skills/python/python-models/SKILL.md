...
your SDK source (`shelldigitalpayments/models/`).
...
`UnionTypeLookUp` registry (in `shelldigitalpayments/utilities/union_type_lookup.py`) and each candidate model
...
```python
from shelldigitalpayments.models.animal import Cat, Dog
...
```python
from shelldigitalpayments.models.animal import Animal, Cat, Dog
