...
your SDK source (`staxfattmerchantapi/models/`).
...
`UnionTypeLookUp` registry (in `staxfattmerchantapi/utilities/union_type_lookup.py`) and each candidate model
...
```python
from staxfattmerchantapi.models.animal import Cat, Dog
...
```python
from staxfattmerchantapi.models.animal import Animal, Cat, Dog
