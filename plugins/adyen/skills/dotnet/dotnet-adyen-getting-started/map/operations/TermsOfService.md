...
- **HTTP**: `GET /legalEntities/{id}/acceptedTermsOfServiceDocument/{termsofserviceacceptancereference}` (Default (balanceplatform-api-test))
...
- **HTTP**: `GET /legalEntities/{id}/termsOfServiceAcceptanceInfos` (Default (balanceplatform-api-test))
...
- **HTTP**: `GET /legalEntities/{id}/termsOfServiceStatus` (Default (balanceplatform-api-test))
...
- **HTTP**: `PATCH /legalEntities/{id}/termsOfService/{termsofservicedocumentid}` (Default (balanceplatform-api-test))
...
- **HTTP**: `POST /legalEntities/{id}/termsOfService` (Default (balanceplatform-api-test))
