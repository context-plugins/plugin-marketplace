...
`discourseapidocumentation/models/` and `discourseapidocumentation/api_helper.py`.
...
```python
from discourseapidocumentation.models.o_auth_token import OAuthToken
...
```python
from discourseapidocumentation.models.animal import Cat
