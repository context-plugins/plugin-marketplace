...
Confirm every name against `lib/shutterstock_api_explorer/client.rb`, `lib/shutterstock_api_explorer/configuration.rb`, the
`lib/shutterstock_api_explorer/http/auth/*.rb` files, and `doc/auth/*.md` in the cloned source.
