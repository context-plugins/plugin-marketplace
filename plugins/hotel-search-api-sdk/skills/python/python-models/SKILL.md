...
your SDK source (`hotelsearchapi/models/`).
...
```python
from hotelsearchapi.api_helper import APIHelper
...
`UnionTypeLookUp` registry (in `hotelsearchapi/utilities/union_type_lookup.py`) and each candidate model
...
```python
from hotelsearchapi.models.animal import Cat, Dog
...
```python
from hotelsearchapi.models.animal import Animal, Cat, Dog
