...
- **HTTP**: `POST /v1/Interactions/{InteractionSid}/Channels/{ChannelSid}/Participants` (Default3 (flex-api))
...
- **HTTP**: `GET /v1/Interactions/{InteractionSid}/Channels/{ChannelSid}/Participants` (Default3 (flex-api))
...
- **HTTP**: `POST /v1/Interactions/{InteractionSid}/Channels/{ChannelSid}/Participants/{Sid}` (Default3 (flex-api))
