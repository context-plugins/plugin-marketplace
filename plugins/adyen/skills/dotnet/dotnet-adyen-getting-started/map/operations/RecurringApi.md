...
- **HTTP**: `DELETE /storedPaymentMethods/{storedPaymentMethodId}` (Default (balanceplatform-api-test))
...
- **HTTP**: `GET /storedPaymentMethods` (Default (balanceplatform-api-test))
...
### PostForward
- **HTTP**: `POST /forward` (Default (balanceplatform-api-test))
...
- **HTTP**: `POST /storedPaymentMethods` (Default (balanceplatform-api-test))
