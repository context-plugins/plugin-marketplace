...
> Throughout, `adyendataprotectionapi` and other `{...}` tokens are placeholders for names you take from your SDK —
...
client := adyendataprotectionapi.NewClient(
    adyendataprotectionapi.CreateConfiguration(
        adyendataprotectionapi.WithBasicAuthCredentials(
            adyendataprotectionapi.NewBasicAuthCredentials(
...
adyendataprotectionapi.WithApiKeyCredentials(adyendataprotectionapi.NewApiKeyCredentials("token", "api-key"))

// custom header scheme (often surfaced as ApiHeaderCredentials):
adyendataprotectionapi.WithApiHeaderCredentials(adyendataprotectionapi.NewApiHeaderCredentials("token", "api-key"))
```
...
```go
adyendataprotectionapi.WithOAuthBearerTokenCredentials(
    adyendataprotectionapi.NewOAuthBearerTokenCredentials(os.Getenv("{ACCESS_TOKEN_ENV}")),
)
```
...
client := adyendataprotectionapi.NewClient(
    adyendataprotectionapi.CreateConfiguration(
        adyendataprotectionapi.WithOAuthCCGCredentials(
            adyendataprotectionapi.NewOAuthCCGCredentials(
