...
All config below is passed at construction time via the `FlightOrderManagementClientConfig` object.

## Base URL / environment override

```typescript
import { FlightOrderManagementClient, Environment } from 'flight-order-managementlib';
