...
| Install | `pip install "git+https://github.com/context-plugins/api-apis-guru-python-fc4461@main"` |
...
```bash
pip install "git+https://github.com/context-plugins/api-apis-guru-python-fc4461@main"
```
...
```bash
# Linux / macOS:
git clone --depth 1 --branch main https://github.com/context-plugins/api-apis-guru-python-fc4461 /tmp/api-apis-guru-python-src
```

```powershell
# Windows (PowerShell):
git clone --depth 1 --branch main https://github.com/context-plugins/api-apis-guru-python-fc4461 "$env:TEMP\api-apis-guru-python-src"
```
