...
Confirm every name against `lib/sportsdata/client.rb`, `lib/sportsdata/configuration.rb`, the
`lib/sportsdata/http/auth/*.rb` files, and `doc/auth/*.md` in the cloned source.
