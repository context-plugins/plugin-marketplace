...
- **HTTP**: `GET /merchants/{merchantId}/terminalLogos` (Default (balanceplatform-api-test))
...
- **HTTP**: `GET /merchants/{merchantId}/terminalSettings` (Default (balanceplatform-api-test))
...
- **HTTP**: `PATCH /merchants/{merchantId}/terminalLogos` (Default (balanceplatform-api-test))
...
- **HTTP**: `PATCH /merchants/{merchantId}/terminalSettings` (Default (balanceplatform-api-test))
