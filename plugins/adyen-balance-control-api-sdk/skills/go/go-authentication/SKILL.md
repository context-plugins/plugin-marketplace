...
> Throughout, `adyenbalancecontrolapi` and other `{...}` tokens are placeholders for names you take from your SDK —
...
client := adyenbalancecontrolapi.NewClient(
    adyenbalancecontrolapi.CreateConfiguration(
        adyenbalancecontrolapi.WithBasicAuthCredentials(
            adyenbalancecontrolapi.NewBasicAuthCredentials(
...
adyenbalancecontrolapi.WithApiKeyCredentials(adyenbalancecontrolapi.NewApiKeyCredentials("token", "api-key"))

// custom header scheme (often surfaced as ApiHeaderCredentials):
adyenbalancecontrolapi.WithApiHeaderCredentials(adyenbalancecontrolapi.NewApiHeaderCredentials("token", "api-key"))
```
...
```go
adyenbalancecontrolapi.WithOAuthBearerTokenCredentials(
    adyenbalancecontrolapi.NewOAuthBearerTokenCredentials(os.Getenv("{ACCESS_TOKEN_ENV}")),
)
```
...
client := adyenbalancecontrolapi.NewClient(
    adyenbalancecontrolapi.CreateConfiguration(
        adyenbalancecontrolapi.WithOAuthCCGCredentials(
            adyenbalancecontrolapi.NewOAuthCCGCredentials(
