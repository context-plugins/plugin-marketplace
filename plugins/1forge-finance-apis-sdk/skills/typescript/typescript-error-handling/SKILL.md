...
> Throughout this skill, `{...}` is a placeholder for a name you take from your SDK (e.g. `{operation}`, `{apiGroup}`, `m1-forge-finance-apislib`) — replace it with the concrete identifier from the source.
