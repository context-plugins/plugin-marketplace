...
### GetLegalEntitiesId
- **HTTP**: `GET /legalEntities/{id}` (Default18 (kyc-test))
...
- **HTTP**: `GET /legalEntities/{id}/businessLines` (Default18 (kyc-test))
...
- **HTTP**: `PATCH /legalEntities/{id}` (Default18 (kyc-test))
...
### PostLegalEntities
- **HTTP**: `POST /legalEntities` (Default18 (kyc-test))
...
- **HTTP**: `POST /legalEntities/{id}/checkVerificationErrors` (Default18 (kyc-test))
...
- **HTTP**: `POST /legalEntities/{id}/confirmDataReview` (Default18 (kyc-test))
...
- **HTTP**: `POST /legalEntities/{id}/requestPeriodicReview` (Default18 (kyc-test))
