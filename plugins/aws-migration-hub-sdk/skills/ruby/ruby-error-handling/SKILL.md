...
StandardError
  └── CoreLibrary::ApiException
        └── AWSMigrationHub::APIException          ← base for all HTTP errors
              └── AWSMigrationHub::{OperationError}  ← typed, if generated (in exceptions/)
...
with `.local_error('400', '...message...', AWSMigrationHub::{OperationError})`, and any status without a
