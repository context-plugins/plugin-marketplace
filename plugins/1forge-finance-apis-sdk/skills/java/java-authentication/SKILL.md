...
To see which schemes a specific SDK accepts, read the credential setter methods on `1ForgeFinanceAPIsClient.Builder`
...
- Set credentials **on the `1ForgeFinanceAPIsClient.Builder`** before calling `.build()` — the client is immutable
