...
- **HTTP**: `POST /v1/CustomerProfiles/{CustomerProfileSid}/Evaluations` (Default12 (trusthub))
...
- **HTTP**: `GET /v1/CustomerProfiles/{CustomerProfileSid}/Evaluations/{Sid}` (Default12 (trusthub))
...
- **HTTP**: `GET /v1/CustomerProfiles/{CustomerProfileSid}/Evaluations` (Default12 (trusthub))
