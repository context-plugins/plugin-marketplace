...
your SDK source (`ebayfinancesapi/models/`).
...
```python
from ebayfinancesapi.api_helper import APIHelper
...
`UnionTypeLookUp` registry (in `ebayfinancesapi/utilities/union_type_lookup.py`) and each candidate model
...
```python
from ebayfinancesapi.models.animal import Cat, Dog
...
```python
from ebayfinancesapi.models.animal import Animal, Cat, Dog
