...
- **HTTP**: `GET /paymentInstruments/{id}` (Default13 (balanceplatform-api-test))
...
- **HTTP**: `GET /paymentInstruments/{id}/networkTokenActivationData` (Default13 (balanceplatform-api-test))
...
- **HTTP**: `GET /paymentInstruments/{id}/networkTokens` (Default13 (balanceplatform-api-test))
...
- **HTTP**: `GET /paymentInstruments/{id}/reveal` (Default13 (balanceplatform-api-test))
...
- **HTTP**: `GET /paymentInstruments/{id}/transactionRules` (Default13 (balanceplatform-api-test))
...
- **HTTP**: `PATCH /paymentInstruments/{id}` (Default13 (balanceplatform-api-test))
...
- **HTTP**: `POST /paymentInstruments` (Default13 (balanceplatform-api-test))
...
- **HTTP**: `POST /paymentInstruments/{id}/networkTokenActivationData` (Default13 (balanceplatform-api-test))
...
- **HTTP**: `POST /paymentInstruments/reveal` (Default13 (balanceplatform-api-test))
