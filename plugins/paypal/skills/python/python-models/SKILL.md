...
`UnionTypeLookUp` registry (in `paypal/utilities/union_type_lookup.py`) and each candidate model
...
```python
from paypal.models.animal import Cat, Dog
...
```python
from paypal.models.animal import Animal, Cat, Dog
