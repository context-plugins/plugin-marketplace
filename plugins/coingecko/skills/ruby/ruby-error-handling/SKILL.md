...
StandardError
  └── CoreLibrary::ApiException
        └── Coingecko::APIException          ← base for all HTTP errors
              └── Coingecko::{OperationError}  ← typed, if generated (in exceptions/)
...
with `.local_error('400', '...message...', Coingecko::{OperationError})`, and any status without a
