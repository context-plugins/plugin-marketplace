...
StandardError
  └── CoreLibrary::ApiException
        └── ConfigurationAPI::APIException          ← base for all HTTP errors
              └── ConfigurationAPI::{OperationError}  ← typed, if generated (in exceptions/)
...
with `.local_error('400', '...message...', ConfigurationAPI::{OperationError})`, and any status without a
