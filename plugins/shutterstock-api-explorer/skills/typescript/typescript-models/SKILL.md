...
```typescript
import { {Union}, {Variant} } from 'shutterstock-api-explorerlib';
...
```typescript
import { is{Variant} } from 'shutterstock-api-explorerlib';
...
```typescript
import { {EnumType} } from 'shutterstock-api-explorerlib';
