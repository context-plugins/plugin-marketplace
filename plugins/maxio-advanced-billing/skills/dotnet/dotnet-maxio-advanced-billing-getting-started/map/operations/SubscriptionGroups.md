...
- **Error accessors**: `TryGetSubscriptionGroupCreateErrorResponse(out SubscriptionGroupCreateErrorResponse)` [422] · `TryGetRawError(out RawError)` [fallback]
- **No-throw variant**: absent
- **Pagination**: none
...
- **Error accessors**: `TryGetSubscriptionGroupSignupErrorResponse(out SubscriptionGroupSignupErrorResponse)` [422] · `TryGetRawError(out RawError)` [fallback]
- **No-throw variant**: absent
- **Pagination**: none
...
- **Error accessors**: `TryGetSubscriptionGroupUpdateErrorResponse(out SubscriptionGroupUpdateErrorResponse)` [422] · `TryGetRawError(out RawError)` [fallback]
- **No-throw variant**: absent
- **Pagination**: none
