...
To see which schemes a specific SDK accepts, read the credential setter methods on `3commasIoClient.Builder`
...
- Set credentials **on the `3commasIoClient.Builder`** before calling `.build()` — the client is immutable
