...
your SDK source (`automationmanagementclient/models/`).
...
```python
from automationmanagementclient.api_helper import APIHelper
...
`UnionTypeLookUp` registry (in `automationmanagementclient/utilities/union_type_lookup.py`) and each candidate model
...
```python
from automationmanagementclient.models.animal import Cat, Dog
...
```python
from automationmanagementclient.models.animal import Animal, Cat, Dog
