# Adobe Experience Manager (AEM) API SDK Plugin

Integrate and consume the **APIMatic-generated Adobe Experience Manager (AEM) API SDK** (the "APIMATIC v3.0" generic
