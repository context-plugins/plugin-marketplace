...
### GetThemes
- **HTTP**: `GET /themes` (Default (balanceplatform-api-test))
...
### GetThemesId
- **HTTP**: `GET /themes/{id}` (Default (balanceplatform-api-test))
...
- **HTTP**: `POST /legalEntities/{id}/onboardingLinks` (Default (balanceplatform-api-test))
