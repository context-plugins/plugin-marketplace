...
Confirm every name against `lib/tesser_api_v1/client.rb`, `lib/tesser_api_v1/configuration.rb`, the
`lib/tesser_api_v1/http/auth/*.rb` files, and `doc/auth/*.md` in the cloned source.
