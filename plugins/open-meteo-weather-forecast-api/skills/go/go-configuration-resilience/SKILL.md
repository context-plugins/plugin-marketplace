    ...
    openmeteoweatherforecastapi.CreateConfiguration(
        openmeteoweatherforecastapi.WithHttpConfiguration(
            openmeteoweatherforecastapi.CreateHttpConfiguration(
                openmeteoweatherforecastapi.WithTimeout(30),
                openmeteoweatherforecastapi.WithRetryConfiguration(
                    openmeteoweatherforecastapi.CreateRetryConfiguration(
                        openmeteoweatherforecastapi.WithMaxRetryAttempts(3),
                        openmeteoweatherforecastapi.WithBackoffFactor(2),
                    ),
                ),
            ),
        ),
...
```go
rc := openmeteoweatherforecastapi.CreateRetryConfiguration(
    openmeteoweatherforecastapi.WithMaxRetryAttempts(5),
    openmeteoweatherforecastapi.WithRetryInterval(1),
    openmeteoweatherforecastapi.WithBackoffFactor(2),
    openmeteoweatherforecastapi.WithHttpStatusCodesToRetry([]int64{429, 500, 503}),
    openmeteoweatherforecastapi.WithHttpMethodsToRetry([]string{"GET", "PUT"}),
)
```
...
client := openmeteoweatherforecastapi.NewClient(
    openmeteoweatherforecastapi.CreateConfiguration(
        openmeteoweatherforecastapi.WithHttpConfiguration(
            openmeteoweatherforecastapi.CreateHttpConfiguration(
                openmeteoweatherforecastapi.WithTransport(&loggingTransport{inner: http.DefaultTransport}),
            ),
        ),
    ),
)
