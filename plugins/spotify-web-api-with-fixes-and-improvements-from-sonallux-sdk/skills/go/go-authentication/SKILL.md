...
> Throughout, `spotifywebapiwithfixesandimprovementsfromsonallux` and other `{...}` tokens are placeholders for names you take from your SDK —
...
client := spotifywebapiwithfixesandimprovementsfromsonallux.NewClient(
    spotifywebapiwithfixesandimprovementsfromsonallux.CreateConfiguration(
        spotifywebapiwithfixesandimprovementsfromsonallux.WithBasicAuthCredentials(
            spotifywebapiwithfixesandimprovementsfromsonallux.NewBasicAuthCredentials(
...
spotifywebapiwithfixesandimprovementsfromsonallux.WithApiKeyCredentials(spotifywebapiwithfixesandimprovementsfromsonallux.NewApiKeyCredentials("token", "api-key"))

// custom header scheme (often surfaced as ApiHeaderCredentials):
spotifywebapiwithfixesandimprovementsfromsonallux.WithApiHeaderCredentials(spotifywebapiwithfixesandimprovementsfromsonallux.NewApiHeaderCredentials("token", "api-key"))
```
...
```go
spotifywebapiwithfixesandimprovementsfromsonallux.WithOAuthBearerTokenCredentials(
    spotifywebapiwithfixesandimprovementsfromsonallux.NewOAuthBearerTokenCredentials(os.Getenv("{ACCESS_TOKEN_ENV}")),
)
```
...
client := spotifywebapiwithfixesandimprovementsfromsonallux.NewClient(
    spotifywebapiwithfixesandimprovementsfromsonallux.CreateConfiguration(
        spotifywebapiwithfixesandimprovementsfromsonallux.WithOAuthCCGCredentials(
            spotifywebapiwithfixesandimprovementsfromsonallux.NewOAuthCCGCredentials(
