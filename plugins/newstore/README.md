...
Integrate and consume the **APIMatic-generated newstore SDK** (the "APIMATIC v3.0" generic
libraries, built on `apimatic-*-core` / `apimatic/*-core-runtime` runtimes) across TypeScript, Java, Python, Ruby, Go.
