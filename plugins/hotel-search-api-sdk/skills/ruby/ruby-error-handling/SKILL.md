...
StandardError
  └── CoreLibrary::ApiException
        └── HotelSearchAPI::APIException          ← base for all HTTP errors
              └── HotelSearchAPI::{OperationError}  ← typed, if generated (in exceptions/)
...
with `.local_error('400', '...message...', HotelSearchAPI::{OperationError})`, and any status without a
