...
Confirm every name against `lib/automationmanagementclient/client.rb`, `lib/automationmanagementclient/configuration.rb`, the
`lib/automationmanagementclient/http/auth/*.rb` files, and `doc/auth/*.md` in the cloned source.
