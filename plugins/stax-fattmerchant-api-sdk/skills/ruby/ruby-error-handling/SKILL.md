...
StandardError
  └── CoreLibrary::ApiException
        └── StaxFattMerchantAPI::APIException          ← base for all HTTP errors
              └── StaxFattMerchantAPI::{OperationError}  ← typed, if generated (in exceptions/)
...
with `.local_error('400', '...message...', StaxFattMerchantAPI::{OperationError})`, and any status without a
