...
`shellcardmanagement/models/` and `shellcardmanagement/api_helper.py`.
...
```python
from shellcardmanagement.models.o_auth_token import OAuthToken
...
```python
from shellcardmanagement.models.animal import Cat
