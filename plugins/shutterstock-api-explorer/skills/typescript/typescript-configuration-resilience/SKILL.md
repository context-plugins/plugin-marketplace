...
All config below is passed at construction time via the `ShutterstockAPIExplorerClientConfig` object.

## Base URL / environment override

```typescript
import { ShutterstockAPIExplorerClient, Environment } from 'shutterstock-api-explorerlib';
