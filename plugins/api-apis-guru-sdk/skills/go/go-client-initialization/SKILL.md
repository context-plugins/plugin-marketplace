...
- `github.com/context-plugins/api-apis-guru-go-617b70` — the Go import path for the root package; `github.com/context-plugins/api-apis-guru-go-617b70/models` for request/response types.
...
```go
import "github.com/context-plugins/api-apis-guru-go-617b70"
