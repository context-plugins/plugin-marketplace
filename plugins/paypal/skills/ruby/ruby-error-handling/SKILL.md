...
StandardError
  └── CoreLibrary::ApiException
        └── Paypal::APIException          ← base for all HTTP errors
              └── Paypal::{OperationError}  ← typed, if generated (in exceptions/)
...
with `.local_error('400', '...message...', Paypal::{OperationError})`, and any status without a
