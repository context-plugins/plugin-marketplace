...
StandardError
  └── CoreLibrary::ApiException
        └── ThirdwebEngine::APIException          ← base for all HTTP errors
              └── ThirdwebEngine::{OperationError}  ← typed, if generated (in exceptions/)
...
with `.local_error('400', '...message...', ThirdwebEngine::{OperationError})`, and any status without a
