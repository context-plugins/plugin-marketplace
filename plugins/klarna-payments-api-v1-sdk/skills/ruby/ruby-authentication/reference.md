...
Confirm every name against `lib/klarna_payments_api_v1/client.rb`, `lib/klarna_payments_api_v1/configuration.rb`, the
`lib/klarna_payments_api_v1/http/auth/*.rb` files, and `doc/auth/*.md` in the cloned source.
