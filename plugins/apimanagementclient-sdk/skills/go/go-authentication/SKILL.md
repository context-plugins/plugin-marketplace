...
> Throughout, `apimanagementclient` and other `{...}` tokens are placeholders for names you take from your SDK —
...
client := apimanagementclient.NewClient(
    apimanagementclient.CreateConfiguration(
        apimanagementclient.WithBasicAuthCredentials(
            apimanagementclient.NewBasicAuthCredentials(
...
apimanagementclient.WithApiKeyCredentials(apimanagementclient.NewApiKeyCredentials("token", "api-key"))

// custom header scheme (often surfaced as ApiHeaderCredentials):
apimanagementclient.WithApiHeaderCredentials(apimanagementclient.NewApiHeaderCredentials("token", "api-key"))
```
...
```go
apimanagementclient.WithOAuthBearerTokenCredentials(
    apimanagementclient.NewOAuthBearerTokenCredentials(os.Getenv("{ACCESS_TOKEN_ENV}")),
)
```
...
client := apimanagementclient.NewClient(
    apimanagementclient.CreateConfiguration(
        apimanagementclient.WithOAuthCCGCredentials(
            apimanagementclient.NewOAuthCCGCredentials(
