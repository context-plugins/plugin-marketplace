...
StandardError
  └── CoreLibrary::ApiException
        └── AdyenBalanceControlAPI::APIException          ← base for all HTTP errors
              └── AdyenBalanceControlAPI::{OperationError}  ← typed, if generated (in exceptions/)
...
with `.local_error('400', '...message...', AdyenBalanceControlAPI::{OperationError})`, and any status without a
