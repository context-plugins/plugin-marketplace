...
All config below is passed at construction time via the `HotelNameAutocompleteClientConfig` object.

## Base URL / environment override

```typescript
import { HotelNameAutocompleteClient, Environment } from 'hotel-name-autocompletelib';
