...
```php
$client = new NetworkAdminManagementClientClient([
    'environment' => NetworkAdminManagementClientClient::ENVIRONMENT_PRODUCTION,  // picks server template
...
$client = new NetworkAdminManagementClientClient(['httpClient' => $httpClient, /* ...auth */]);
