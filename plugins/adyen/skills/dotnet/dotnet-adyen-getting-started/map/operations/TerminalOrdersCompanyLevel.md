...
- **HTTP**: `GET /companies/{companyId}/billingEntities` (Default9 (management-test))
...
- **HTTP**: `GET /companies/{companyId}/shippingLocations` (Default9 (management-test))
...
- **HTTP**: `GET /companies/{companyId}/terminalModels` (Default9 (management-test))
...
- **HTTP**: `GET /companies/{companyId}/terminalOrders` (Default9 (management-test))
...
- **HTTP**: `GET /companies/{companyId}/terminalOrders/{orderId}` (Default9 (management-test))
...
- **HTTP**: `GET /companies/{companyId}/terminalProducts` (Default9 (management-test))
...
- **HTTP**: `PATCH /companies/{companyId}/terminalOrders/{orderId}` (Default9 (management-test))
...
- **HTTP**: `POST /companies/{companyId}/shippingLocations` (Default9 (management-test))
...
- **HTTP**: `POST /companies/{companyId}/terminalOrders` (Default9 (management-test))
...
- **HTTP**: `POST /companies/{companyId}/terminalOrders/{orderId}/cancel` (Default9 (management-test))
