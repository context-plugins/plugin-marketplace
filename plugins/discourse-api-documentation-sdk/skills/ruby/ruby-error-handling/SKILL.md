...
StandardError
  └── CoreLibrary::ApiException
        └── DiscourseAPIDocumentation::APIException          ← base for all HTTP errors
              └── DiscourseAPIDocumentation::{OperationError}  ← typed, if generated (in exceptions/)
...
with `.local_error('400', '...message...', DiscourseAPIDocumentation::{OperationError})`, and any status without a
