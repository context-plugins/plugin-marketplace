...
Confirm every name against `lib/1password_connect/client.rb`, `lib/1password_connect/configuration.rb`, the
`lib/1password_connect/http/auth/*.rb` files, and `doc/auth/*.md` in the cloned source.
