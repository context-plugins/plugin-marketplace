...
```php
$client = new AdyenBalanceControlAPIClient([
    'environment' => AdyenBalanceControlAPIClient::ENVIRONMENT_PRODUCTION,  // picks server template
...
$client = new AdyenBalanceControlAPIClient(['httpClient' => $httpClient, /* ...auth */]);
