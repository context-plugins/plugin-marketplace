...
All config below is passed at construction time via the `FlightPriceAnalysisAPIClientConfig` object.

## Base URL / environment override

```typescript
import { FlightPriceAnalysisAPIClient, Environment } from 'flight-price-analysis-apilib';
