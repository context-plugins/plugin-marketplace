...
- **Signature**: `EditLiveEventAutoCc(double liveEventId, double userId, RequestOptions? requestOptions = null, CancellationToken ct = default)`
...
- **Notes**: This method edits the automated closed captions preference for the specified event.
- **Signature**: `EditLiveEventAutoCcAlt1(double liveEventId, RequestOptions? requestOptions = null, CancellationToken ct = default)`
  - defaults: `requestOptions` = null
- **Returns**: `void` (Task)
...
- **Notes**: This method edits the automated closed captions preference for the specified event.
- **Signature**: `EditLiveEventAutoCcAlt2(double liveEventId, RequestOptions? requestOptions = null, CancellationToken ct = default)`
  - defaults: `requestOptions` = null
- **Returns**: `void` (Task)
