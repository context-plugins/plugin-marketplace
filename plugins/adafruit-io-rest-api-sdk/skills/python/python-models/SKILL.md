...
your SDK source (`adafruitiorestapi/models/`).
...
```python
from adafruitiorestapi.api_helper import APIHelper
...
`UnionTypeLookUp` registry (in `adafruitiorestapi/utilities/union_type_lookup.py`) and each candidate model
...
```python
from adafruitiorestapi.models.animal import Cat, Dog
...
```python
from adafruitiorestapi.models.animal import Animal, Cat, Dog
