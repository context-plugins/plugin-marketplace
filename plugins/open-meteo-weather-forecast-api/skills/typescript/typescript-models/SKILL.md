...
```typescript
import { {Union}, {Variant} } from 'open-meteo-weather-forecast-apilib';
...
```typescript
import { is{Variant} } from 'open-meteo-weather-forecast-apilib';
...
```typescript
import { {EnumType} } from 'open-meteo-weather-forecast-apilib';
