...
Integrate and consume the **APIMatic-generated vimeo SDK** (the "APIMATIC v3.0" generic
...
(`dotnet-vimeo-getting-started/sdk-map.md` + `map/`) indexing every operation signature,
model, enum, union, and error type. The **`dotnet-integrate-vimeo`** router skill routes all
C#/.NET SDK work to the single **`dotnet-vimeo-sdk`** agent (.NET-only), which answers
