...
StandardError
  └── CoreLibrary::ApiException
        └── ShellEv::APIException          ← base for all HTTP errors
              └── ShellEv::{OperationError}  ← typed, if generated (in exceptions/)
...
with `.local_error('400', '...message...', ShellEv::{OperationError})`, and any status without a
