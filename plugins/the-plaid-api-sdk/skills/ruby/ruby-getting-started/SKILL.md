...
| Install | `gem 'the_plaid_api', git: 'https://github.com/context-plugins/the-plaid-api-ruby', branch: 'main'` in a Gemfile |
...
```ruby
# In your Gemfile:
gem 'the_plaid_api', git: 'https://github.com/context-plugins/the-plaid-api-ruby', branch: 'main'
```
...
```bash
# Linux / macOS:
git clone --depth 1 --branch main https://github.com/context-plugins/the-plaid-api-ruby /tmp/the-plaid-api-ruby-src
```

```powershell
# Windows (PowerShell):
git clone --depth 1 --branch main https://github.com/context-plugins/the-plaid-api-ruby "$env:TEMP\the-plaid-api-ruby-src"
```
