...
All config below is passed at construction time via the `KlarnaPaymentsAPIV1ClientConfig` object.

## Base URL / environment override

```typescript
import { KlarnaPaymentsAPIV1Client, Environment } from 'klarna-payments-api-v-1-lib';
