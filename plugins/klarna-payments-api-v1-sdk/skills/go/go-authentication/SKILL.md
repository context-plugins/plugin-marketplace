...
> Throughout, `klarnapaymentsapiv1` and other `{...}` tokens are placeholders for names you take from your SDK —
...
client := klarnapaymentsapiv1.NewClient(
    klarnapaymentsapiv1.CreateConfiguration(
        klarnapaymentsapiv1.WithBasicAuthCredentials(
            klarnapaymentsapiv1.NewBasicAuthCredentials(
...
klarnapaymentsapiv1.WithApiKeyCredentials(klarnapaymentsapiv1.NewApiKeyCredentials("token", "api-key"))

// custom header scheme (often surfaced as ApiHeaderCredentials):
klarnapaymentsapiv1.WithApiHeaderCredentials(klarnapaymentsapiv1.NewApiHeaderCredentials("token", "api-key"))
```
...
```go
klarnapaymentsapiv1.WithOAuthBearerTokenCredentials(
    klarnapaymentsapiv1.NewOAuthBearerTokenCredentials(os.Getenv("{ACCESS_TOKEN_ENV}")),
)
```
...
client := klarnapaymentsapiv1.NewClient(
    klarnapaymentsapiv1.CreateConfiguration(
        klarnapaymentsapiv1.WithOAuthCCGCredentials(
            klarnapaymentsapiv1.NewOAuthCCGCredentials(
