...
```typescript
import { {Union}, {Variant} } from 'flight-most-traveled-destinationslib';
...
```typescript
import { is{Variant} } from 'flight-most-traveled-destinationslib';
...
```typescript
import { {EnumType} } from 'flight-most-traveled-destinationslib';
