...
your SDK source (`hostedonboardingapi/models/`).
...
```python
from hostedonboardingapi.api_helper import APIHelper
...
`UnionTypeLookUp` registry (in `hostedonboardingapi/utilities/union_type_lookup.py`) and each candidate model
...
```python
from hostedonboardingapi.models.animal import Cat, Dog
...
```python
from hostedonboardingapi.models.animal import Animal, Cat, Dog
