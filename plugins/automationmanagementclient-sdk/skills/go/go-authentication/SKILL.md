...
> Throughout, `automationmanagementclient` and other `{...}` tokens are placeholders for names you take from your SDK —
...
client := automationmanagementclient.NewClient(
    automationmanagementclient.CreateConfiguration(
        automationmanagementclient.WithBasicAuthCredentials(
            automationmanagementclient.NewBasicAuthCredentials(
...
automationmanagementclient.WithApiKeyCredentials(automationmanagementclient.NewApiKeyCredentials("token", "api-key"))

// custom header scheme (often surfaced as ApiHeaderCredentials):
automationmanagementclient.WithApiHeaderCredentials(automationmanagementclient.NewApiHeaderCredentials("token", "api-key"))
```
...
```go
automationmanagementclient.WithOAuthBearerTokenCredentials(
    automationmanagementclient.NewOAuthBearerTokenCredentials(os.Getenv("{ACCESS_TOKEN_ENV}")),
)
```
...
client := automationmanagementclient.NewClient(
    automationmanagementclient.CreateConfiguration(
        automationmanagementclient.WithOAuthCCGCredentials(
            automationmanagementclient.NewOAuthCCGCredentials(
