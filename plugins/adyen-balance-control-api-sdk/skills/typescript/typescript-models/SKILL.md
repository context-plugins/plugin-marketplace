...
```typescript
import { {Union}, {Variant} } from 'adyen-balance-control-apilib';
...
```typescript
import { is{Variant} } from 'adyen-balance-control-apilib';
...
```typescript
import { {EnumType} } from 'adyen-balance-control-apilib';
