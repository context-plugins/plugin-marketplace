...
StandardError
  └── CoreLibrary::ApiException
        └── PQAPIV2::APIException          ← base for all HTTP errors
              └── PQAPIV2::{OperationError}  ← typed, if generated (in exceptions/)
...
with `.local_error('400', '...message...', PQAPIV2::{OperationError})`, and any status without a
