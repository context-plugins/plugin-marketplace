...
`pazecheckoutapi/models/` and `pazecheckoutapi/api_helper.py`.
...
```python
from pazecheckoutapi.models.o_auth_token import OAuthToken
...
```python
from pazecheckoutapi.models.animal import Cat
