    ...
    flightcreateorders.CreateConfiguration(
        flightcreateorders.WithHttpConfiguration(
            flightcreateorders.CreateHttpConfiguration(
                flightcreateorders.WithTimeout(30),
                flightcreateorders.WithRetryConfiguration(
                    flightcreateorders.CreateRetryConfiguration(
                        flightcreateorders.WithMaxRetryAttempts(3),
                        flightcreateorders.WithBackoffFactor(2),
                    ),
                ),
            ),
        ),
...
```go
rc := flightcreateorders.CreateRetryConfiguration(
    flightcreateorders.WithMaxRetryAttempts(5),
    flightcreateorders.WithRetryInterval(1),
    flightcreateorders.WithBackoffFactor(2),
    flightcreateorders.WithHttpStatusCodesToRetry([]int64{429, 500, 503}),
    flightcreateorders.WithHttpMethodsToRetry([]string{"GET", "PUT"}),
)
```
...
client := flightcreateorders.NewClient(
    flightcreateorders.CreateConfiguration(
        flightcreateorders.WithHttpConfiguration(
            flightcreateorders.CreateHttpConfiguration(
                flightcreateorders.WithTransport(&loggingTransport{inner: http.DefaultTransport}),
            ),
        ),
    ),
)
