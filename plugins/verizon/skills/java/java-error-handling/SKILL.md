...
│   └── com.verizon.m5gedge.exceptions.ApiException          ← base for all non-2xx API responses
│       └── com.verizon.m5gedge.exceptions.{Name}Exception   ← typed subclass with payload fields
...
`getHttpContext()` returns the SDK's `com.verizon.m5gedge.http.client.HttpContext`, which carries:
