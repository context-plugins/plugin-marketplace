...
your SDK source (`adyenbalancecontrolapi/models/`).
...
```python
from adyenbalancecontrolapi.api_helper import APIHelper
...
`UnionTypeLookUp` registry (in `adyenbalancecontrolapi/utilities/union_type_lookup.py`) and each candidate model
...
```python
from adyenbalancecontrolapi.models.animal import Cat, Dog
...
```python
from adyenbalancecontrolapi.models.animal import Animal, Cat, Dog
