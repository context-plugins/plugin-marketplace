...
StandardError
  └── CoreLibrary::ApiException
        └── FinnhubAPI::APIException          ← base for all HTTP errors
              └── FinnhubAPI::{OperationError}  ← typed, if generated (in exceptions/)
...
with `.local_error('400', '...message...', FinnhubAPI::{OperationError})`, and any status without a
