...
git clone --branch main https://github.com/context-plugins/alpaca-csharp-sdk
dotnet add reference alpaca-csharp-sdk/TraderApi.csproj
```
...
```bash
# Linux / macOS:
git clone --depth 1 --branch main https://github.com/context-plugins/alpaca-csharp-sdk /tmp/alpaca-dotnet-src
```

```powershell
# Windows (PowerShell):
git clone --depth 1 --branch main https://github.com/context-plugins/alpaca-csharp-sdk "$env:TEMP\alpaca-dotnet-src"
```
...
```bash
rm -rf /tmp/alpaca-dotnet-src                               # Linux / macOS
```
```powershell
Remove-Item -Recurse -Force "$env:TEMP\alpaca-dotnet-src"   # Windows
```
