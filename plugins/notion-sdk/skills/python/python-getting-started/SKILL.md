...
| Install | `pip install "git+https://github.com/context-plugins/notion-python@main"` |
...
```bash
pip install "git+https://github.com/context-plugins/notion-python@main"
```
...
```bash
# Linux / macOS:
git clone --depth 1 --branch main https://github.com/context-plugins/notion-python /tmp/notion-python-src
```

```powershell
# Windows (PowerShell):
git clone --depth 1 --branch main https://github.com/context-plugins/notion-python "$env:TEMP\notion-python-src"
```
