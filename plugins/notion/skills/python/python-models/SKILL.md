...
`UnionTypeLookUp` registry (in `notion/utilities/union_type_lookup.py`) and each candidate model
...
```python
from notion.models.animal import Cat, Dog
...
```python
from notion.models.animal import Animal, Cat, Dog
