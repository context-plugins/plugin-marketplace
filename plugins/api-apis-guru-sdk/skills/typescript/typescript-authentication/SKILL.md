...
> Throughout this skill, `{...}` is a placeholder for a name you take from your SDK (e.g. `tours-and-activitieslib`, `ApiApisGuruClientConfig`, `{basicAuthProperty}`) — replace it with the concrete identifier from the source.
