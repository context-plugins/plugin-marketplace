...
### CreateTask
- **HTTP**: `POST /v1/Workspaces/{WorkspaceSid}/Tasks` (Default (accounts))
- **Signature**: `CreateTask(string workspaceSid, ContentType contentType, int? timeout, int? priority, string? taskChannel, string? workflowSid, string? attributes, DateTimeOffset? virtualStartTime, string? routingTarget, string? ignoreCapacity, string? taskQueueSid, RequestOptions? requestOptions = null, CancellationToken ct = default)`
...
### DeleteTask
- **HTTP**: `DELETE /v1/Workspaces/{WorkspaceSid}/Tasks/{Sid}` (Default (accounts))
...
### FetchTask
- **HTTP**: `GET /v1/Workspaces/{WorkspaceSid}/Tasks/{Sid}` (Default (accounts))
...
### ListTask
- **HTTP**: `GET /v1/Workspaces/{WorkspaceSid}/Tasks` (Default (accounts))
...
### UpdateTask
- **HTTP**: `POST /v1/Workspaces/{WorkspaceSid}/Tasks/{Sid}` (Default (accounts))
- **Signature**: `UpdateTask(string workspaceSid, string sid, ContentType contentType, string? ifMatch, string? attributes, TaskStatusModel? assignmentStatus, string? reason, int? priority, string? taskChannel, DateTimeOffset? virtualStartTime, RequestOptions? requestOptions = null, CancellationToken ct = default)`
