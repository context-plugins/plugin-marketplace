...
Confirm every name against `lib/mindbody/client.rb`, `lib/mindbody/configuration.rb`, the
`lib/mindbody/http/auth/*.rb` files, and `doc/auth/*.md` in the cloned source.
