...
```typescript
import { {Union}, {Variant} } from 'travel-recommendations-apilib';
...
```typescript
import { is{Variant} } from 'travel-recommendations-apilib';
...
```typescript
import { {EnumType} } from 'travel-recommendations-apilib';
