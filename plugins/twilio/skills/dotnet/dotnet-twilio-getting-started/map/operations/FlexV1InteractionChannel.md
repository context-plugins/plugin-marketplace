...
- **HTTP**: `GET /v1/Interactions/{InteractionSid}/Channels/{Sid}` (Default13 (flex-api))
...
- **HTTP**: `GET /v1/Interactions/{InteractionSid}/Channels` (Default13 (flex-api))
...
- **HTTP**: `POST /v1/Interactions/{InteractionSid}/Channels/{Sid}` (Default13 (flex-api))
