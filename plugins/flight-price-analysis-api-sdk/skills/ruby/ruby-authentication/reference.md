...
Confirm every name against `lib/flight_price_analysis_api/client.rb`, `lib/flight_price_analysis_api/configuration.rb`, the
`lib/flight_price_analysis_api/http/auth/*.rb` files, and `doc/auth/*.md` in the cloned source.
