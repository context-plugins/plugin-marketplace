...
StandardError
  └── CoreLibrary::ApiException
        └── HostedOnboardingAPI::APIException          ← base for all HTTP errors
              └── HostedOnboardingAPI::{OperationError}  ← typed, if generated (in exceptions/)
...
with `.local_error('400', '...message...', HostedOnboardingAPI::{OperationError})`, and any status without a
