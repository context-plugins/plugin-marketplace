...
- **HTTP**: `GET /companies/{companyId}/terminalLogos` (Default (balanceplatform-api-test))
...
- **HTTP**: `GET /companies/{companyId}/terminalSettings` (Default (balanceplatform-api-test))
...
- **HTTP**: `PATCH /companies/{companyId}/terminalLogos` (Default (balanceplatform-api-test))
...
- **HTTP**: `PATCH /companies/{companyId}/terminalSettings` (Default (balanceplatform-api-test))
