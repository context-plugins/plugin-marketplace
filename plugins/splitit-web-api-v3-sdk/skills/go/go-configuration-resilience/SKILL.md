    ...
    splititwebapiv3.CreateConfiguration(
        splititwebapiv3.WithHttpConfiguration(
            splititwebapiv3.CreateHttpConfiguration(
                splititwebapiv3.WithTimeout(30),
                splititwebapiv3.WithRetryConfiguration(
                    splititwebapiv3.CreateRetryConfiguration(
                        splititwebapiv3.WithMaxRetryAttempts(3),
...
```go
rc := splititwebapiv3.CreateRetryConfiguration(
    splititwebapiv3.WithMaxRetryAttempts(5),
    splititwebapiv3.WithRetryInterval(1),
    splititwebapiv3.WithBackoffFactor(2),
    splititwebapiv3.WithHttpStatusCodesToRetry([]int64{429, 500, 503}),
...
client := splititwebapiv3.NewClient(
    splititwebapiv3.CreateConfiguration(
        splititwebapiv3.WithHttpConfiguration(
            splititwebapiv3.CreateHttpConfiguration(
                splititwebapiv3.WithTransport(&loggingTransport{inner: http.DefaultTransport}),
            ),
        ),
    ),
)
