...
| Union | Variants | Factories | TryGet accessors | Implicit from | Source |
|---|---|---|---|---|---|
| `Location1` | object?, PricedTransactionItemsLocationItems | `Location1.AnonymousObject(object?)`, `Location1.PricedTransactionItemsLocationItems(PricedTransactionItemsLocationItems)` | `TryGetAnonymousObject(out …)`, `TryGetPricedTransactionItemsLocationItems(out …)` | `PricedTransactionItemsLocationItems` | `Models/AnyOf/Location1.cs` |
