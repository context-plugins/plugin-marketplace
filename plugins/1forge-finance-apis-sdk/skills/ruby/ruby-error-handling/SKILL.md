...
StandardError
  └── CoreLibrary::ApiException
        └── 1ForgeFinanceAPIs::APIException          ← base for all HTTP errors
              └── 1ForgeFinanceAPIs::{OperationError}  ← typed, if generated (in exceptions/)
...
with `.local_error('400', '...message...', 1ForgeFinanceAPIs::{OperationError})`, and any status without a
